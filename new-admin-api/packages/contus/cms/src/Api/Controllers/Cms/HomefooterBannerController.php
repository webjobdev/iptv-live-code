...
use Contus\Cms\Repositories\HomeFooterBannerRepository;
use Contus\Base\Repositories\UploadRepository;
use Contus\Base\Helpers\StringLiterals;

class HomefooterBannerController extends ApiController {
    /**
     * class property to hold the instance of BannerRepository
     *
     * @var \Contus\Base\Repositories\BannerRepository Construct method
     */
    public function __construct(HomeFooterBannerRepository $bannerRepository, UploadRepository $uploadRepository) {
        parent::__construct ();
    ...
    public function postBannerImage() { 
        $tempImageInfo = $this->uploadRepository->setModelIdentifier ( 'footer_image' )->tempPrepare ()->tempUpload ('footer_image' );
