...
use Contus\Organizations\Repositories\VodContetntSetRepository;
use Illuminate\Support\Facades\Auth;
use Contus\Organizations\Repositories\ContetntSetRepository;

class VodContentSetController extends ApiController
{
    protected $_vodContentUpload;
    public function __construct(VodContetntSetRepository $vodContetntSetRepository, UploadRepository $uploadRepository)
    {
        parent::__construct();
        $this->repository = $vodContetntSetRepository;
        $this->_vodContentUpload = $uploadRepository;
    ...
    public function postPosters()
    {
        ...
        $tempImageInfo = $this->_vodContentUpload
