...
use Contus\Video\Repositories\RadioRepository;
...
class RadioController extends ApiController {
     ...
     */
    public function __construct(RadioRepository $videosRepository, CollectionRepository $collectionsRepository, CategoryRepository $categoryRepository, UploadRepository $uploadRepository, CountriesRepository $countriesRepository, VideoCountriesRepository $videoCountriesRepository) {
        parent::__construct ();
