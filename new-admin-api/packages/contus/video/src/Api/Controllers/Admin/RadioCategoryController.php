...
use Contus\Video\Repositories\RadioCategoryRepository;
...
class RadioCategoryController extends ApiController {
    /**
     ...
     * Construct method
     */
    public function __construct(RadioCategoryRepository $categoryRepository, UploadRepository $uploadRepository) {
        parent::__construct();
