...
class CategoryController extends ApiController {
  ...
  public function postMobileCategoryImage() {
    $tempImageInfo = $this->uploadRepository->setModelIdentifier ( UploadRepository::MODEL_IDENTIFIER_MOBILE_CATEGORY_IMAGE )->tempPrepare ()->tempUpload ();
    ...
    public function postBannerImage() { 
        $tempImageInfo = $this->uploadRepository->setModelIdentifier ( 'banner_image' )->tempPrepare ()->tempUpload ('banner_image' );
  ...
  public function getCategoriesUnique($id = null) {
    ...
    public function addLanguage($id) 
    {
        try {
            ...
            return $this->getSuccessJsonResponse ( [ ],trans ( 'video::categories.success.updated' ));
        } catch (Exception $e) {
            return $this->getErrorJsonResponse ( [ ],trans ( 'video::categories.error.updated' )  );
        }
    }
