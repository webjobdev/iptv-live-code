...
use Contus\Video\Repositories\VodCategoryRepository;

class VodCategoryController extends ApiController
{

    public function __construct(VodCategoryRepository $vodCategoryRepository)
    {
        parent::__construct();
        $this->repository = $vodCategoryRepository;
    ...
    {
        $isCreated = false;
        if ($this->repository->CreateVodCategory()) {
            $isCreated = true;
