...
use Contus\Video\Repositories\LiveeventsRepository;
...
class LiveeventsController extends ApiController {
     ...
     */
    public function __construct(LiveeventsRepository $videosRepository, CollectionRepository $collectionsRepository, CategoryRepository $categoryRepository, UploadRepository $uploadRepository, CountriesRepository $countriesRepository, VideoCountriesRepository $videoCountriesRepository) {
        parent::__construct ();
