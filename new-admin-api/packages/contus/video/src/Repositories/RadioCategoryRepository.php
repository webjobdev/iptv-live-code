...
use Contus\Base\RadioCategoryRepository as BaseRepository;
...
class RadioCategoryRepository extends BaseRepository implements ICategoryRepository
{
    ...
    protected function updateGridQuery($builder)
    {
        ...
        $builder->selectRaw('categories.*, categories.id as formatted_created_date')->where('is_deletable', 1)->where('is_radio', 1);
        return $builder;
    }
