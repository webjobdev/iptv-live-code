...
class CollectionRepository extends BaseRepository implements ICollectionRepository {
     ...
     */
    public function __construct(Collection $collection, video $friendvideo) {
        parent::__construct ();
    ...
    public function getAllCollection() {
        $lists = Group::where('is_active', 1)->pluck ('id', 'name')->toArray();
