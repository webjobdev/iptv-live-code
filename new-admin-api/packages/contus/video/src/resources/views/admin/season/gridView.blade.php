...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="groupForm" id="seasonForm" method="POST" data-base-validator data-ng-submit="seasongridCtrl.save($event, seasongridCtrl.season.id)" enctype="multipart/form-data">
            {!! csrf_field() !!}
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                    ...
                    <div class="form-input">
                        <input type="text" name="title" class="form-control" data-validation-name="Season name" data-ng-model="seasongridCtrl.season.title" placeholder="{{trans('video::season.enter_season_name')}}" value="{{old('title')}}" />
                    </div>
                        ...
                        <div class="form-input">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <a href="#" class="fileupload-exists category-image-remove"
                                        data-dismiss="fileupload" data-ng-click="seasongridCtrl.removeThumbnailProperty($event, seasongridCtrl.season.id)">{{trans('video::videos.remove')}}</a>
                        ...
                        <div class="form-group">
                            <div class="clsFileUpload preview-image">
                                <span id="category-image-delete" data-ng-click="seasongridCtrl.deleteCategoryImage()"
                                    data-ng-show="seasongridCtrl.season.image" data-boot-tooltip="true" title="Click to delete the image of the season.">
