...
<div data-ng-controller="DashboardController as dashCtrl" >
            ...
            <div class="menu_container clearfix">
                <div class="page_menu pull-left">
                    <ul class="nav">
                        <li><a href="javascript::void(0)" title="" class="active">{{__('base::adminsidebar.dashboard')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        	<tr data-ng-if="dashCtrl.latestVideos.length == 0">
                				<td colspan="7" class="no-data center">{{__('base::general.not_found')}}</td>
            				</tr>
                    	...
                    	<table class="table">
                            ...
                            <tbody>
                            	<tr data-ng-if="dashCtrl.topCategories.length == 0">
                					<td colspan="5" class="no-data center">{{__('base::general.not_found')}}</td>
            					</tr>
...
@section('scripts')
    ...
    <script src="{{asset('storage/assets/js/raphael-min.js')}}"></script>
    <script src="{{asset('storage/assets/js/morris-0.4.1.min.js')}}"></script>
