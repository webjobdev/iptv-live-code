    ...
    [
        ...
        <div data-ng-if="!checkAccess('playlists_all_write')">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                    <h4>{{trans('audio::playlists.manage_playlists')}}</h4>
                    <div class="right-side flexbox align-items-center">
                        <a href="javascript:void(0)" class="show-tooltip button button-blue sidepanel-open disabled">
                           ...
                           <!-- <p class="playlists-tooltip">Cant able to add more than 5 dynamic rows</p> -->
                           Add Video
                        </a>
                    </div>
                </div>        
...
@section('scripts')
    ...
    <script src="{{$getVideoAssetsUrl('js/playlist/playlistGrid.js')}}"></script>
