<div class="card main-container">
        ...
        <ul>
            <li class="active" ng-if="livePage && !editPage">
                <div class="status-upload not-saved live-video flexbox align-items-center" id="@{{ video.id }}">
                    ...
                    <h3>{{ __('video::videos.live_radio_inprogress') }}</h3>
                </div>
            </li>
    ...
    <div class="card-right">
                                ...
                                <div class="fileuploadbox">
                                    <div class="input-append">
                                        <div class="overlay-content"
                                            ...
                                            <p>( Only jpeg, png files allowed with a minimum dimension of 190x190 )</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="division flexbox">
                    <div class="one-set width-50">
                        ...
                        <div class="form-group" data-ng-class="{'has-error': errors.hls.has}"
                            ...
                            <label>( We accept audio url in format: m3u8,mp3,aac,ogg. )</label>
                            <div class="form-input">
                                <!-- <input ng-if="editPage" readonly type="text" name="hls"
                                    data-ng-model="selectedVideo.hls" class="form-control form-readonly"
                                ...
                                <input ng-if="!editPage" type="text" name="hls" data-ng-model="selectedVideo.hls"
                                    ...
                                    placeholder="Enter Radio url" value="{{old('hls')}}" />

                            </div>
                            <!-- <p class="error-msg" data-ng-show="errors.hls.has">Url required.</p> -->
                            <p class="error-msg" data-ng-show="errors.hls.has">@{{errors.hls.message}}
                            </p>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="switch-concept flexbox align-items-center">
                                <div class="swich-content flexbox align-items-center flex-wrap">
                                    <span>Disable for Website</span>
                                    <div class="right-side flexbox align-items-center">
                                        <span class="text">Show</span>
                                        <label class="switch">
                                            <input type="checkbox" name="hide_web" ng-model="selectedVideo.hide_web">
                    ...
                    <div class="one-set width-50">
                        ...
                        <div class="form-group" data-ng-class="{'has-error': errors.category.has}">
                            ...
                            <div class="form-input">
                                <select multiple data-jquery="select2_custom_ddl" myValue="selectedVideo.category"
                                    ...
                                    ng-options="item.id as item.title group by item.parent for item in vgridCtrl.radioCategories"
                        ...
                        <!-- <div class="form-group" data-ng-class="{'has-error': errors.episode_order.has}" ng-if="!livePage && selectedVideo.is_webseries">
                            <label>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="form-input">
                                <select allowClear="1" data-jquery="select2_custom_ddl" myValue="selectedVideo.group"
                        ...
                        <div class="form-group">
                        <div ng-if="selectedVideo.is_parental == 1">
                            <label>                             
                            Age limit  
                            <span class="required">*</span>                       
                            </label>
        ...
        <div class="bottom-button text-right ">
            ...
            <a class="save" ng-if="livePage || selectedVideo.is_live" href="{{ url('admin/radio') }}">
            ...
            <button ng-if="livePage && editPage" id="videoEditFormSubmit"
            data-ng-click="vgridCtrl.saveRadioEdit($event, selectedVideo.id)" class="publish-now">
            {{ __('video::videos.publish_now') }}
           </button>
            <button  ng-if="livePage && !editPage" id="videoEditFormSubmit"
                data-ng-click="vgridCtrl.saveradio($event, selectedVideo.id)" class="publish-now">
                {{ __('video::videos.publish_now') }}
            </button>
