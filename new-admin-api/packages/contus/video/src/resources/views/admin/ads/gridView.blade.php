                ...
                <tr>
                    <th class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist" >
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" id="selectall" value="1" data-ng-click="adsCtrl.selectAllRecords()" />
                            <label for="selectall" class="nopadding"></label>
                        </div>
                        <div class="dropdown bulkaction" style="float: left; right: 20px;" data-ng-show="adsCtrl.selectedRecords != 0 && checkAccess('ads_all_write')"
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a data-toggle="modal" data-target="#videoBulkDeleteModal" ng-click="adsCtrl.deleteBulkRecord()"
                                        href="#">{{__('video::videos.delete')}}</a>
                                </li>
                                <li>
                                    <a data-toggle="modal" data-target="#videoBulkDeleteModal" ng-click="adsCtrl.activateOrDeactivateBulkRecord('activate')"
                                        href="#">{{__('video::videos.activate')}}</a>
                                </li>
                                <li>
                                    <a data-toggle="modal" data-target="#videoBulkDeleteModal" ng-click="adsCtrl.activateOrDeactivateBulkRecord('deactivate')"
            ...
            <tbody>
                ...
                <td></td>
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.title" data-boot-tooltip="true" title="{{trans('video::ads.enter_ads_name')}}">
                    </td>
                    <td></td>
                    <td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                    <td >
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" class="checkbox" id="roles_@{{record.id}}" ng-click="adsCtrl.selectRecord($event, record.id)"
                    ...
                    <td>
                        <div class="product_img flexbox align-items-center">
                            <a ng-if="record.videocategory.length" href="{{url('admin/categories/videos')}}/@{{record.id}}" class="table-image-text flexbox align-items-center">
                            ...
                            <p ng-if="!record.videocategory.length" style="cursor: no-drop;" href="javascript:void(0);" class="disabled table-image-text flexbox align-items-center">
                                <div class="image" data-ng-if="record.image_url.length == 0" style="background-image: url({{url('contus/base/images/no-preview.png')}})" >
                                </div>
                                <div class="image" data-ng-if="record.image_url.length > 0" style="background-image: url(@{{record.image_url}})" >
                                </div>
                    ...
                    <td>
                        <div class="align-items-center img_description ads_url">
                        @{{record.ads_url}}
                        </div>
                    </td>
                    <td>
                        <div data-ng-if="checkAccess('ads_all_write')" class="tooltip-parent">
                            <span class="status-active" ng-if="record.is_active == 1" style="cursor: pointer;"  data-toggle="modal" data-target="#videoBulkDeleteModal" data-ng-click="adsCtrl.statusChangeSingleRecord(record)" data-boot-tooltip="true">{{trans('video::categories.message.active')}}</span>
                            <span class="tooltip_title">{{trans('video::categories.deactivate_ad')}}</span>
                        </div>
                        <div data-ng-if="checkAccess('ads_all_write')" class="tooltip-parent">
                            <span class="status-inactive" ng-if="record.is_active != 1" style="cursor: pointer;"  data-toggle="modal"  data-target="#videoBulkDeleteModal" data-ng-click="adsCtrl.statusChangeSingleRecord(record)" data-ng-click="adsCtrl.updateStatus(record)"  data-boot-tooltip="true">{{trans('video::categories.message.inactive')}}</span>
                            <span class="tooltip_title">{{trans('video::categories.activate_ad')}}</span>
                        </div>
                        
                        <div class="tooltip-parent"  data-ng-if="!checkAccess('ads_all_write')">
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('ads_all_write')" id="st-trigger-effects " class="column edit_table_icon tooltip-parent">
                                        <button class="table_action sidepanel-open" data-ng-click="adsCtrl.editAd(record)" >
                            ...
                            <div class="tooltip-parent" data-ng-if="checkAccess('ads_all_write')">
                            <span ng-mouseover="getTooltip($event)" class="delete_table_icon"  data-toggle="modal" data-target="#deleteModal" data-ng-click="deleteSingleRecord(record.id)" data-boot-tooltip="true">
                            ...
                            <div class="tooltip-parent" data-ng-if="checkAccess('ads_all_write')">
                            <span data-ng-if="record.is_deletable == 1 && (record.videocategory.length > 0 || record.child_category.length > 0)" ng-mouseover="getTooltip($event)" class="delete_table_icon delete_disabled"  data-boot-tooltip="true">
                                <svg viewBox="0 0 11 12" x="0px" y="0px" width="11px" height="12px">
                                    <g>
                                        <path d="M 10.4998 3.513 L 9.6099 3.513 L 8.9153 11.6068 C 8.8962 11.8292 8.7144 11.9998 8.4966 11.9998 L 2.4885 11.9998 C 2.2708 11.9998 2.0889 11.8293 2.0701 11.6069 L 1.3752 3.513 L 0.4995 3.513 L 0.4995 2.6513 L 3.4268 2.6513 L 3.4268 1.7179 C 3.4268 1.322 3.741 0.9999 4.1272 0.9999 L 6.8721 0.9999 C 7.2583 0.9999 7.5725 1.322 7.5725 1.7179 L 7.5725 2.6513 L 10.4998 2.6513 L 10.4998 3.513 ZM 6.7322 1.8615 L 4.2668 1.8615 L 4.2668 2.6513 L 6.7322 2.6513 L 6.7322 1.8615 ZM 2.2188 3.513 L 2.873 11.1383 L 8.1121 11.1383 L 8.7661 3.513 L 2.2188 3.513 ZM 6.5222 9.8588 L 6.7043 4.7609 L 7.5442 4.7924 L 7.3621 9.8902 L 6.5222 9.8588 ZM 5.0796 4.7767 L 5.9199 4.7767 L 5.9199 9.8746 L 5.0796 9.8746 L 5.0796 4.7767 ZM 3.4551 4.7923 L 4.2949 4.7608 L 4.4771 9.8586 L 3.6372 9.8902 L 3.4551 4.7923 Z" fill="#454545"></path>
                                    </g>
                            ...
                            <div class="column edit_table_icon tooltip-parent"  data-ng-if="!checkAccess('ads_all_write')">
                                <button disabled class="table_action">
                            ...
                            <div class="tooltip-parent" data-ng-if="!checkAccess('ads_all_write')">
                            <button disabled >
                                <svg data-boot-tooltip="true" aria-hidden="true" viewBox="0 0 11 12" x="0px" y="0px" width="11px" height="12px">
                                    <g>
                                        <path d="M 10.4998 3.513 L 9.6099 3.513 L 8.9153 11.6068 C 8.8962 11.8292 8.7144 11.9998 8.4966 11.9998 L 2.4885 11.9998 C 2.2708 11.9998 2.0889 11.8293 2.0701 11.6069 L 1.3752 3.513 L 0.4995 3.513 L 0.4995 2.6513 L 3.4268 2.6513 L 3.4268 1.7179 C 3.4268 1.322 3.741 0.9999 4.1272 0.9999 L 6.8721 0.9999 C 7.2583 0.9999 7.5725 1.322 7.5725 1.7179 L 7.5725 2.6513 L 10.4998 2.6513 L 10.4998 3.513 ZM 6.7322 1.8615 L 4.2668 1.8615 L 4.2668 2.6513 L 6.7322 2.6513 L 6.7322 1.8615 ZM 2.2188 3.513 L 2.873 11.1383 L 8.1121 11.1383 L 8.7661 3.513 L 2.2188 3.513 ZM 6.5222 9.8588 L 6.7043 4.7609 L 7.5442 4.7924 L 7.3621 9.8902 L 6.5222 9.8588 ZM 5.0796 4.7767 L 5.9199 4.7767 L 5.9199 9.8746 L 5.0796 9.8746 L 5.0796 4.7767 ZM 3.4551 4.7923 L 4.2949 4.7608 L 4.4771 9.8586 L 3.6372 9.8902 L 3.4551 4.7923 Z" fill="#454545"></path>
                                    </g>
                                </svg>
