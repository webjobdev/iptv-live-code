        ...
        <table class="table" id="fixTable" data-ng-class="{'no-records': noRecords}">
            <thead>
                <tr>
                    ...
                    <th data-ng-if="checkAccess('playlists_all_write')" class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">
            ...
            <tbody>
                <tr class="search_text">
                    <td data-ng-if="checkAccess('playlists_all_write')"></td>
                    
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.name" data-boot-tooltip="true" title="{{trans('video::playlist.enter_playlist_name')}}">
                    </td>
                    <td></td>
                    <td></td>
                    <td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                    <td data-ng-if="checkAccess('playlists_all_write')">
                        <div class="ckbox ckbox-default">
                    ...
                    <td>
                        <div class="product_img flexbox align-items-center table-image-text"> 
                            <a ng-if="record.audio.length" href="{{url('admin/playlists/videos')}}/@{{record.id}}" class="table-image-text flexbox align-items-center">
                                            -->
                                <div class="product_description tooltip-parent">
                                    <p class="img_description">@{{record.name}}
                                        <span class="tooltip_title">@{{record.name}}</span>
                                    </p>
                                </div>
                            </a>
                            <a ng-if="!record.audio.length" href="{{url('admin/playlists/videos')}}/@{{record.id}}" class="table-image-text flexbox align-items-center">
                     ...
                     <td class="center"><span>@{{record.playlist_order}}</span></td>
                    <td class="center"><span>@{{record.playlist_videos.length}}</span></td>
                    <td>
                            <div class="tooltip-parent" data-ng-if="checkAccess('playlists_all_write')">
                                ...
                                <span class="tooltip_title">Click to deactivate</span>
                            </div>
                            <div class="tooltip-parent" data-ng-if="checkAccess('playlists_all_write')">
                                ...
                                <span class="tooltip_title">Click to activate</span>
                            </div>
                            <div class="tooltip-parent" data-ng-if="!checkAccess('playlists_all_write')">
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <div class="column edit_table_icon tooltip-parent ">
                                <a data-boot-tooltip="true" class="table_action" href="{{url('admin/playlists/videos')}}/@{{record.id}}">
                                ...
                                <span class="tooltip_title">click to view videos</span>
                            </div>
                                <div class="column edit_table_icon tooltip-parent" data-ng-if="checkAccess('playlists_all_write')">
                                    <button class="table_action sidepanel-open" data-ng-click="playlistCtrl.editPlaylist(record)" title="{{trans('base::general.view_or_edit')}}">
                                    ...
                                    <span class="tooltip_title">Edit</span>
                                </div>
                                <div class="tooltip-parent" data-ng-if="checkAccess('playlists_all_write')">
                                ...
                                <div id="st-trigger-effects" class="column edit_table_icon tooltip-parent" data-ng-if="!checkAccess('playlists_all_write')">
