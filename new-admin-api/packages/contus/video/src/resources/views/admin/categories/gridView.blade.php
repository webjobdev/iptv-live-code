        ...
        <table class="table" id="fixTable">
            <thead>
                <tr>
                    <th class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">
                        ...
                        <div class="dropdown bulkaction" style="float: left; right: 20px;" data-ng-show="selectedRecords != 0 && checkAccess('category_all_write')"
            ...
            <tbody>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                    ...
                    <td>
                        <div class="tooltip-parent" data-ng-if="checkAccess('category_all_write')">
                            <span class="status-active" ng-if="record.is_active == 1" style="cursor: pointer;" data-toggle="modal" data-target="#videoBulkDeleteModal" data-ng-click="catgridCtrl.statusChangeSingleRecord(record)"  data-boot-tooltip="true">{{trans('video::categories.message.active')}}</span>
                            <span class="tooltip_title">{{trans('video::categories.deactivate_category')}}</span>
                        </div>
                        <div class="tooltip-parent" data-ng-if="checkAccess('category_all_write')">
                            <span class="status-inactive" ng-if="record.is_active != 1" style="cursor: pointer;" data-toggle="modal" data-target="#videoBulkDeleteModal" data-ng-click="catgridCtrl.statusChangeSingleRecord(record)"   data-boot-tooltip="true">{{trans('video::categories.message.inactive')}}</span>
                            <span class="tooltip_title">{{trans('video::categories.activate_category')}}</span>
                        </div>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div  class="column edit_table_icon tooltip-parent">
                                <a data-boot-tooltip="true" class="table_action" href="{{url('admin/categories/videos')}}/@{{record.id}}">
                            ...
                            <div data-ng-if="checkAccess('category_all_write')" class="column edit_table_icon tooltip-parent" data-ng-show="record.is_deletable == 1">
                            ...
                            <div class="tooltip-parent category-delete-disable" data-ng-if="checkAccess('category_all_write')">
                            ...
                            <div class="column edit_table_icon tooltip-parent" data-ng-if="!checkAccess('category_all_write')">
