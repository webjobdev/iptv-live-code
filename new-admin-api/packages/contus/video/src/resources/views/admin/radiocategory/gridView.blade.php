            ...
            <thead>
                <tr>
                    <th class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">
                        ...
                        <div class="dropdown bulkaction" style="float: left; right: 20px;" data-ng-show="selectedRecords != 0 && checkAccess('radiocategory_all_write')"
            ...
            <tbody>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                    ...
                    <!-- <td>
                     ...
                     <td>
                        <div class="tooltip-parent" data-ng-if="checkAccess('radiocategory_all_write')">
                        ...
                        <div class="tooltip-parent"  data-ng-if="!checkAccess('radiocategory_all_write')">
                            <button  disabled class="status-active" ng-if="record.is_active == 1" style="cursor: pointer;"><span  data-boot-tooltip="false">{{trans('video::playlist.message.active')}}</span></button>
                        </div>
                        <div class="tooltip-parent"  data-ng-if="!checkAccess('radiocategory_all_write')">
                            <button  disabled class="status-inactive" ng-if="record.is_active != 1" style="cursor: pointer;"><span   data-boot-tooltip="false">{{trans('video::playlist.message.inactive')}}</span></button>
                        </div>
                    </td> 
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('radiocategory_all_write')" class="column edit_table_icon tooltip-parent" data-ng-show="record.is_deletable == 1">
                            ...
                            <div class="tooltip-parent category-delete-disable" data-ng-if="checkAccess('radiocategory_all_write')">
                            ...
                            <div class="column edit_table_icon tooltip-parent" data-ng-if="!checkAccess('radiocategory_all_write')">
