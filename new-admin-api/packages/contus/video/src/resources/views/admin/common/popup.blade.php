<div class="alert-popup modal fade" id="videoDeleteModal" ng-show="videoConfirmationDeleteBox">             
    <div class="alert-popup-content">
        ...
        <div class="popup_content"> 
            ...
            <span class="delete_detail">@{{ selectedVideo.title }}</span>
    ...
    <div class="alert-popup-content">
        ...
        <div class="popup_content"> 
            ...
            <div class="popup_btns text-center">
                ...
                <a data-ng-click="{{ $control }}.confirmReplaceVideos(selectedVideo)" href="javascript:void(0)" class="pop_confirm_btn" >{{__('base::gridlist.yes')}}</a>
            </div>
        </div>
    </div>
</div>
...
<div class="alert-popup modal fade" id="livestreamStopModal" data-role="dialog">
    ...
    <div class="alert-popup-content">
        ...
        {{-- <div class="clearfix modal-footer video_delete_footer">
            <span data-ng-click="{{ $control }}.cancelLiveStreamRecording()" class="btn btn-danger pull-right"
                    data-dismiss="modal">{{__('base::gridlist.cancel')}}</span>
            <span data-ng-click="{{ $control }}.confirmLiveStreamRecording()"
...
<div class="custom-modal modal fade" id="video_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="custom-modal-dialog img-cropper" role="document">
        <div class="custom-modal-content">
            <div class="custom-modal-header">
                {{ __('video::videos.video_upload_header') }}
            </div>
            <div class="custom-modal-body">
                <div class="loader-container">
                    <img src="{{url('contus/base/images/loader.gif')}}">
                </div>
                <p class="error_msg">{{__('video::videos.skipped_video_note') }}</p>
            </div>
            <div class="custom-modal-footer text-right">
                <button type="button" class="popup-button grey-color" data-dismiss="modal">{{ __('video::videos.cancel') }}</button>
            </div>
...
<!-- Mobile Poster Modal -->
<div class="custom-modal modal fade" id="mobile_poster_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="custom-modal-dialog img-cropper" role="document">
        <div class="custom-modal-content">
            <div class="custom-modal-header">
                {{ __('video::videos.crop_image') }}
            ...
            <div class="custom-modal-body">
                ...
                <p class="mobile_poster_error_msg"></p>
                <div class="crop-body">
                    <div class="img-container">
                        <img id="mobile_poster_image" src="" alt="Picture 123123">
                    </div>
                    <div class="mobile_poster_img-preview"></div>
                </div>
            </div>
            <div class="custom-modal-footer text-right">
                <button type="button" class="popup-button grey-color" data-dismiss="modal">{{ __('video::videos.cancel') }}</button>
                <button type="button" class="popup-button blue-color" id="submit_mobile_poster_image">{{ __('video::videos.submit') }}</button>
            </div>
        </div>
    </div>
</div>
