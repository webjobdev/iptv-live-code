...
<link rel="stylesheet" href="{{asset('storage/assets/css/angularjs-datetime-picker.css')}}" />
<link rel="stylesheet" href="{{asset('storage/assets/css/cropper.css')}}" />
<link rel="stylesheet" href="{{asset('storage/assets/css/ng-tags-input.min.css')}}" />
...
@endsection @section('header') @include('base::layouts.headers.dashboard') @endsection @section('content')
    ...
    <div data-ng-controller="VideoGridController as vgridCtrl" >
        @include('video::admin.common.subMenu', ['template' => 'liveeventslist'])
        <div class="contentpanel clearfix video_grid">
            @include('base::partials.errors')
            <div class="response-msg"></div>
            <div data-grid-view data-rows-per-page="10" data-route-name="liveevents" data-template-route="admin/liveevents"
                 data-request-grid="liveevents" data-count="false"></div>
        </div>
    ...
    <div class="alert-popup modal fade" id="videoBulkDeleteModal" data-role="dialog">
        <div class="alert-popup-content">
            ...
            <div class="popup_content" data-ng-show="vgridCtrl.isEditBulkRecord">
                    ...
                    <div class="popup_btns text-center">
                        <a class="pop_cancel_btn" data-ng-click="vgridCtrl.cancelDeleteVideos()" data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                        <a data-ng-click="vgridCtrl.confirmEditEvents()" class="pop_confirm_btn" data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                    </div>
            </div>
        </div>      
    </div>
...
<script src="{{asset('storage/assets/js/ng-tags-input.min.js')}}"></script>
<script src="{{asset('storage/assets/js/angularjs-datetime-picker.js')}}"></script>
<script src="{{asset('storage/assets/js/fine-uploader.min.js')}}"></script>
<script src="//vjs.zencdn.net/ie8/1.1.0/videojs-ie8.min.js"></script>
<script src="//vjs.zencdn.net/5.0.2/video.min.js"></script>
<script src="{{asset('storage/assets/js/bootstrap-fileupload.min.js')}}"></script>
<script src="{{asset('storage/assets/js/Uploader.js')}}"></script>
<script src="{{asset('storage/assets/js/classieSidebarEffects.js')}}"></script>
<script src="{{asset('storage/assets/js/classieSidebarEffectsDirective.js')}}"></script>
<script src="{{asset('storage/assets/js/angularjs-datetime-picker.js')}}"></script>
<script src="{{asset('storage/assets/js/Validate.js')}}"></script>

<script src="{{asset('storage/assets/js/angular/angular-ui.js')}}"></script>

<script src="{{asset('storage/assets/js/ng-flow-standalone.js')}}"></script>
...
<script src="{{asset('storage/assets/js/videos/videoGrid.js')}}"></script>
