...
<div data-ng-controller="WebseriesGridController as webseriesgridCtrl">
        @include('video::admin.common.popup', ['template' => 'weseries_video', 'control' => 'webseriesgridCtrl'])
    <div class="page-heading flexbox align-items-center flex-wrap">
        <h4>{{trans('base::general.manage_webseries')}}</h4>
        <div class="right-side flexbox align-items-center">
            <a data-ng-if="checkAccess('webseries_all_write')" title="{{trans('video::webseries.add_webseries')}}" href="{{url('admin/webseries/add')}}" class="button button-blue">
                ...
                <span>{{trans('video::webseries.add_webseries')}}</span>
            </a>    

            <a data-ng-if="!checkAccess('webseries_all_write')" class="button button-blue sidepanel-open disabled" href="javascript:void(0)">
    ...
    <div class="contentpanel clearfix category_grid">
        ...
        <div data-grid-view data-rows-per-page="10" data-route-name="webseries" data-template-route="admin/webseries"
            data-request-grid="webseries" data-count="false"></div>
    </div>
</div>
@endsection
...
<script src="{{$getVideoAssetsUrl('js/webseries/webseriesGrid.js')}}"></script>
