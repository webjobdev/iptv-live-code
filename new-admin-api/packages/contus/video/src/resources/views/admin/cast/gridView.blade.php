                ...
                <tr>
                    <th class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist" >
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" id="selectall" value="1" data-ng-click="castCtrl.selectAllRecords()" />
                            <label for="selectall" class="nopadding"></label>
                        </div>
                        <div class="dropdown bulkaction" style="float: left; right: 20px;" data-ng-show="castCtrl.selectedRecords != 0 && checkAccess('cast_all_write')"
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a data-toggle="modal" data-target="#videoBulkDeleteModal" ng-click="castCtrl.deleteBulkRecord()"
                                        href="#">{{__('video::videos.delete')}}</a>
                                </li>
                                <li>
                                    <a data-toggle="modal" data-target="#videoBulkDeleteModal" ng-click="castCtrl.activateOrDeactivateBulkRecord('activate')"
                                        href="#">{{__('video::videos.activate')}}</a>
                                </li>
                                <li>
                                    <a data-toggle="modal" data-target="#videoBulkDeleteModal" ng-click="castCtrl.activateOrDeactivateBulkRecord('deactivate')"
            ...
            <tbody>
                ...
                <td></td>
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.name" data-boot-tooltip="true" title="{{trans('video::cast.enter_cast_name')}}">
                    </td>
                    <td></td>
                    <td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                    <td >
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" class="checkbox" id="roles_@{{record.id}}" ng-click="castCtrl.selectRecord($event, record.id)"
                    ...
                    <div class="product_img flexbox align-items-center">
                            <span href="javascript:void(0);" class="table-image-text flexbox align-items-center">
                                <div class="image" bg-image="@{{record.banner_image}}" on-error-src="{{url('contus/base/images/no-preview.png')}}">
                                </div>
                    ...
                    <td>
                        <div class="tooltip-parent" data-ng-if="checkAccess('cast_all_write')">
                            <span class="status-active" ng-if="record.is_active == 1" style="cursor: pointer;"  data-toggle="modal" data-target="#videoBulkDeleteModal" data-ng-click="castCtrl.statusChangeSingleRecord(record)" data-boot-tooltip="true">{{trans('video::categories.message.active')}}</span>
                            <span class="tooltip_title">{{trans('video::categories.deactivate_cast')}}</span>
                        </div>
                        <div class="tooltip-parent" data-ng-if="checkAccess('cast_all_write')">
                            <span class="status-inactive" ng-if="record.is_active != 1" style="cursor: pointer;"  data-toggle="modal"  data-target="#videoBulkDeleteModal" data-ng-click="castCtrl.statusChangeSingleRecord(record)" data-ng-click="castCtrl.updateStatus(record)"  data-boot-tooltip="true">{{trans('video::categories.message.inactive')}}</span>
                            <span class="tooltip_title">{{trans('video::categories.activate_cast')}}</span>
                        </div>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('genre_all_write')" id="st-trigger-effects " class="column edit_table_icon tooltip-parent">
                                        <button class="table_action sidepanel-open" data-ng-click="castCtrl.editAd(record)" >
                            ...
                            <div class="column edit_table_icon tooltip-parent"  data-ng-if="!checkAccess('genre_all_write')">
