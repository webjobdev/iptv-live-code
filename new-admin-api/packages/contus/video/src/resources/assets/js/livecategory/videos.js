...
videoCategories.controller('ViewVideoCategoriesController',['$window','$scope','$rootScope','requestFactory','$timeout',function(win,scope,$rootScope,requestFactory,$timeout){
  ...
  this.fetchData = function(id) { 
    requestFactory.get(requestFactory.getUrl('livecategory/video-categories/'+id,{page : scope.currentPage}),function(response){
  ...
  this.parentCategory = function(id) {
    requestFactory.post(requestFactory.getUrl('livecategory/parent-category/'+id),id,function(response){
  ...
  this.getChildCategories = function(id) {
    ...
    requestFactory.post(requestFactory.getUrl('livecategory/child-category/'+id),id,function(response){
