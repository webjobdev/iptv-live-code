...
class FfmpegHandler
{
    ...
    private $hlsQualities = ['480x360', '640x480', /*'842x480',*/ '1280x720', '1920x1080'];
    private $oldName;
    private $newName;
    private $uuid;
    ...
    public function clearFolders($destinationFolder = null, $folderPath = null)
    {
        ...
        if (is_dir($this->folderPath)) {
            shell_exec("rm -rf " . $this->folderPath. DIRECTORY_SEPARATOR . $this->newName);
        }
    }
    ...
    public function prepareTranscode()
    {
        ...
        $this->destinationFolder = base_path('public' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'videos' . DIRECTORY_SEPARATOR . 'convert' . DIRECTORY_SEPARATOR . $this->uuid . DIRECTORY_SEPARATOR . time() . DIRECTORY_SEPARATOR);
