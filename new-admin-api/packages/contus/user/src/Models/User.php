...
class User extends Model implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract, AttachableModel, JWTSubject
{
    ...
    protected $fillable = [
        ...
        'location',
        'is_super_admin',
        'can_change_password_for_next_login',
        'is_log_in_at',
        'is_log_out_at',
        'max_failed_logins',
        'fcm_token'
    ...
    {
        parent::__construct();
        $this->setHiddenCustomer(['id', 'password', 'remember_token', 'parent_id', 'access_token', 'is_active', 'creator_id', 'updator_id', 'created_at', 'updated_at', 'profile_image_path', 'user_group_id', 'ip_address']);
    }
    ...
    {
        // return $this->belongsToMany(RulePermissions::class, 'user_group_id', 'id', 'user_group_id');
        // return $this->belongsTo(Rule::class, 'permission_rule_id');
