...
@endsection
@section('stylesheet')
<link href="{{ asset('storage/assets/css/bootstrap-fileupload.min.css')}}" rel="stylesheet">
<link href="{{asset('storage/assets/css/uploader.css')}}" rel="stylesheet">
<link rel="stylesheet" href="{{asset('storage/assets/css/cropper.css')}}" />
@endsection
@section('content')
<style type="text/css">
.custom-color {
                ...
                <div class="division flexbox">
                    ...
                    <div class="one-set width-50">
                        <div class="form-group" data-ng-class="{'has-error': errors.email.has}">
                            ...
                            <div class="form-input">
                                <input type="text" readonly name="email" data-unique="{{url('api/admin/users/unique')}}@{{'/'+prfCtrl.user.id}}" data-ng-model="prfCtrl.user.email" class="form-control" placeholder="{{trans('user::adminuser.email_placeholder')}}" value="{{old('email')}}"/>
                            </div>
                ...
                <div class="division flexbox">
                    <div class="one-set width-50">
                        <div class="form-group" data-ng-class="{'has-error': errors.phone.has}">
                            ...
                            <div class="form-input">
                                <input type="text" name="phone"  maxlength="15" class="form-control" data-validation-name="Phone Number" data-ng-model="prfCtrl.user.phone" placeholder="{{trans('user::adminuser.phone_placeholder')}}" value="{{old('phone')}}"/>
                            </div>
                    ...
                    <div class="one-set width-50">
                        <div class="form-group">
                            ...
                            <div class="form-input">
                                ...
                                <select allowClear="1" name="gender" data-jquery="select2_custom_ddl" myValue="prfCtrl.user.gender" myPlaceholder="{{trans('user::adminuser.select_gender')}}"   class="form-control" data-ng-model="prfCtrl.user.gender"  >
                ...
                <div class="division flexbox">
                    <div class="one-set width-50">
                        ...
                        <div class="upload-cover-thumbnail">
                            <div class="thumbnail-image ml-zero" data-ng-class="{'has-error': errors.profile_image.has}">
                                    <h4>{{ trans('user::adminuser.profile_image') }}</h4>
                                <div class="image-content">
                                        <img ng-class="{'active': prfCtrl.user.profile_image}"
                                        class="uploaded_img uploaded_img_@{{ prfCtrl.user.id }}" alt="" ng-src="@{{ prfCtrl.user.profile_image }}">
                                    {{-- <img ng-class="{'active': prfCtrl.profile_image}" class="uploaded_img" alt=""> --}}
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileuploadbox">
                                            <div class="input-append">
                                                <div class="overlay-content" data-ng-class="{'change-image':  prfCtrl.user.profile_image.length > 0}">
                                                    ...
                                                    <div class="input">
                                                        ...
                                                        <div ng-hide="!prfCtrl.user.profile_image.length" class="ng-hide flexbox align-items-center">
                                                            <svg class="change_img_ic" x="0px" y="0px" width="13" height="13" viewBox="0 0 528.899 528.899" "="">
                                                                <g>
                                                                    <path d="M328.883,89.125l107.59,107.589l-272.34,272.34L56.604,361.465L328.883,89.125z M518.113,63.177l-47.981-47.981   c-18.543-18.543-48.653-18.543-67.259,0l-45.961,45.961l107.59,107.59l53.611-53.611   C532.495,100.753,532.495,77.559,518.113,63.177z M0.3,512.69c-1.958,8.812,5.998,16.708,14.811,14.565l119.891-29.069   L27.473,390.597L0.3,512.69z" fill="#ffffff"></path>
                                                                </g>
                                                            </svg>
                                                            <span>Change Image</span>
                                                        </div>
                                                        <input type="file"   accept="image/*" class="uploadImg" name="image" >
                                                        <input type="hidden" class="module" id="module" name="module" value="album">
                                ...
                                <p class="error-msg" data-ng-show="errors.profile_image.has">@{{ errors.profile_image.message }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="custom-modal-content">
                    ...
                    <div class="custom-modal-body">
                        <div class="loader-container">
                            <img src="{{asset('storage/assets/images/loader.gif')}}">
                        </div>
                        <p class="error_msg"></p>
                ...
                <div class="geofence">
                    <div class="form-group">
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" id="parent1" name="permissions[0][]" class="parentCheckBox disabled" value="dashboard_all">
                    ...
                    <div class="form-group">
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" id="parent1" name="permissions[0][]" class="parentCheckBox" value="dashboard_all" checked="">
                            <label>Enable Geofencing option for each video</label>
                        </div>
...
@endsection
@section('scripts')
<script src="{{asset('storage/assets/js/cropper.js')}}"></script>
...
<script src="{{asset('storage/assets/js/adminusers/profile.js')}}"></script>
