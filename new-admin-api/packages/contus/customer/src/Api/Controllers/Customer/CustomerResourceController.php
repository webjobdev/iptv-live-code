...
class CustomerResourceController extends ApiController {
    ...
    public function update(Request $request, $customerId) { 
     $update = $this->repository->addOrUpdateCustomers($customerId); 
        return (isset($update['data']['id'])) ? $this->getSuccessJsonResponse ( [ 'message' => trans ( 'customer::customer.updated' ) ] ) : $this->getErrorJsonResponse ( [ ], trans ( 'customer::customer.updatedError' ) );
    }
