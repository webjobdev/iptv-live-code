...
class UploadRepository extends BaseUploadRepository implements IUploadRepository
{
     ...
     * @var array
     */
    protected $allowedModelIdentifier = [ self::MODEL_IDENTIFIER_THUMBNAIL,self::MODEL_IDENTIFIER_PROFILE,self::MODEL_IDENTIFIER_CATEGORY_IMAGE,self::MODEL_IDENTIFIER_SUBTITLE,self::MODEL_IDENTIFIER_POSTER,self::MODEL_IDENTIFIER_CAST_IMAGE ];
