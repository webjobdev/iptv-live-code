...
use Contus\Cms\Models\SettingCategory;
use Contus\Cms\Models\Setting;
use Contus\Cms\Contracts\ISettingsRepository;
...
class SettingsRepository extends BaseRepository implements ISettingsRepository {
    ...
    public function __construct(Setting $setting, SettingCategory $settingCategory) {
        ...
        $this->optionalFields = [
            '_token', 
            'activeTab',
           'site-external-link-settings__fb_link', 
           'site-external-link-settings__twitter_link', 
           'site-external-link-settings__google_link', 
           'site-external-link-settings__instagram_link', 
           'site-external-link-settings__android_app_link', 
           'site-external-link-settings__ios_app_link',
           'site-external-link-settings__aod_ios_app_link',
           'site-external-link-settings__aod_android_app_link',
        ];
    }
