...
class User extends Model implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract, AttachableModel, JWTSubject
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'email', 'password', 'phone', 'is_active', 'gender', 'user_group_id'];
    ...
    {
        parent::__construct();
        $this->setHiddenCustomer(['id', 'password', 'remember_token', 'parent_id', 'access_token', 'is_active', 'creator_id', 'updator_id', 'created_at', 'updated_at', 'profile_image_path', 'user_group_id']);
    }
