...
class CreateVodContentSetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vod_content_set', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('organization_id')->nullable();
            $table->string('name')->nullable();
            $table->json('assigned_vod')->nullable();
    ...
    {
        Schema::dropIfExists('vod_content_set');
    }
}
