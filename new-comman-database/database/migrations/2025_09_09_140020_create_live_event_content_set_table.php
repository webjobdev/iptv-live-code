...
class CreateLiveEventContentSetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('live_event_content_set', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('live_event_content_set');
    }
}
