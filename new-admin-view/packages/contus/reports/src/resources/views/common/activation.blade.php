<nav class="nav nav-pills" style="margin: 1rem 0rem 1rem 0rem;">
    <li class="{{ Request::routeIs('activation.report') ? 'active' : '' }}" style="margin-right: 0.5rem;">
        <a href="{{ url('admin/activation-reports') }}"
            style="{{ Request::routeIs('activation.report') ? 'background-color: #00ACCD;' : '' }}"
    ...
    <li class="{{ Request::routeIs('activation.save.template') ? 'active' : '' }}" style="margin-right: 0.5rem;">
        <a href="{{ url('admin/activation/save-templates') }}"
            style="{{ Request::routeIs('activation.save.template') ? 'background-color: #00ACCD;' : '' }}"
            class="btn btn-default">
    ...
    <li class="{{ Request::routeIs('activation.generate.report') ? 'active' : '' }}" style="margin-right: 0.5rem;">
        <a href="{{ url('admin/actvation/generate-report') }}"
            style="{{ Request::routeIs('activation.generate.report') ? 'background-color: #00ACCD;' : '' }}"
            class="btn btn-default">
