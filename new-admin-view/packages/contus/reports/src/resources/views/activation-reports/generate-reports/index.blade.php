    ...
    <div data-ng-controller="ActivationReportController as actCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="activation-generate-reports"
                    data-template-route="admin/generate-report/activation" data-count="false">
                </div>
            </div>
