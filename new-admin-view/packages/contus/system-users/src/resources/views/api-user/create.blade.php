        ...
        <div class=" " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('api-access.index') }}">{{ __('api-access::index.api_access') }}</a></li>
                    <li class="active">Add Api User</li>
                </ol>
            </div>
            <br>
                ...
                <div class="row">
                    <div class="mx-auto" style="width:70%; margin-left: 10rem;">
                        <form method="POST" enctype="multipart/form-data" data-base-validator
                            data-ng-submit="apiAccessCtrl.saveApiUser($event)">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group row table-responsive" style="margin-bottom: 15px;"
                                ng-if="apiAccessCtrl.apiAccessData.organization">
                                ...
                                <div class="form-group row" style="margin-bottom: 15px; width: 40%;">
                                    <div class="col-sm-10">
                                        <select name="subscription" id="subscription"
                                            ng-model="apiAccessCtrl.apiAccessData.subscription" class="form-control"
                                            style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;"
                                            ng-options="subs.name for subs in apiAccessCtrl.subscriptionList">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <label class="switch" style="margin: 10.5px 10px 0px 10px;">
                                    <input type="checkbox" ng-model="apiAccessCtrl.accdrm.status"
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-success" id="apiaccessadd">
                                    <strong>Add</strong>
                                </button>&nbsp;&nbsp;
                                {{-- <button type="button" class="btn btn-danger" onclick="cancelApiAccess({{ request()->id }})">
                                    <strong>Remove</strong>
                                </button>&nbsp;&nbsp; --}}
                                <button type="button" class="btn btn-default" ng-click="apiAccessCtrl.cancelApiAccess($event)">
