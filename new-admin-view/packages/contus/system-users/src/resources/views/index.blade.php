...
@section('content')
    <div data-ng-controller="SystemUserController as sysUserCtrl">
        <div class=" " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>System User</h4>

                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('system_users.create')" data-ng-click="sysUserCtrl.addSysUser($event)" href="javascript:void(0)"
            ...
            {{-- <br>
            <form class="form-inline serch-btn" id="searchForm" method="GET" ng-submit="sysUserCtrl.searchUser($event)">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" ng-model="searchRecords.name" placeholder="Search here..."
                    aria-label="Search" id="searchInput" ng-change="sysUserCtrl.searchUser()">&nbsp;
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="system-user"
                    data-template-route="admin/system-user" data-count="false"></div>
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/system-user/index.js') }}"></script>
