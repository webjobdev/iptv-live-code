    ...
    <div data-ng-controller="SettingController as settCtrl">
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>Subscriber Setting Service</h4>

                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('general_settings.create')" data-ng-click="settCtrl.addSett($event)"
                        ...
                        <span>{{ trans('settings::index.add_setting')}}</span>
                    </a>
                </div>
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="general/settings"
                    data-template-route="admin/general/settings" data-count="false"></div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/index.js')}}"></script>
