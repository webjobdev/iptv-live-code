                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index"
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('currencies.edit')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="CurrCtrl.editcurrencydata(record)">
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('currencies.delete')">
        ...
        <form name="CurrencyForm" id="CurrencyForm" method="POST" data-base-validator
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <select class="form-control" data-jquery="select2_custom_ddl" name="currency_code"
                            ...
                            data-ng-options="currency for currency in CurrCtrl.currencyList"
                    ...
                    <p class="error-msg" data-ng-show="errors.currency_code.has">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <select class="form-control" data-jquery="select2_custom_ddl" name="currency_symbol"
                            ...
                            data-ng-options="currency.symbol as (currency.name + ' (' + currency.symbol + ')') for currency in CurrCtrl.currencySymbolList"
                ...
                <div class="form-group">
                    ...
                    <p class="error-msg" data-ng-show="errors.sample.has">
