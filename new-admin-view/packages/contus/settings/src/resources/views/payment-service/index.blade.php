        ...
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('payment_services.create')" data-ng-click="pytsveCtrl.openPage()"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="payment-service"
                    data-template-route="admin/payment-services" data-count="false"></div>
            </div>
        </div>
    </div>
