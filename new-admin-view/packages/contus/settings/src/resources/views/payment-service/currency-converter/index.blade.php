...
@section('content')
    ...
    <div data-ng-controller="ConverterController as ConvCtrl">
        <div class="" id="dashboard-page">

            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>Payment Service Currency Converters</h4>
            </div>

            @include('settings::payment-service.common.menu')

            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('settings')" data-ng-click="ConvCtrl.addCurr($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="payment-service/currency-converter"
                    data-template-route="admin/payment-services/currency-converter" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/currenc-converter.js')}}"></script>
