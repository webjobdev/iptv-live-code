            ...
            <div class="form-page">
                ...
                <form method="post" id="paymentserviceForm" data-base-validator enctype="multipart/form-data"
                    ...
                    <div class="row" ng-show="pytsveCtrl.services.payment_provider == 'Authorize.net'">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="authorize_mode" value="live"
                                            ng-model="pytsveCtrl.services.mode">
                                        Live
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="authorize_mode" value="sandbox"
                                            ng-model="pytsveCtrl.services.mode">
                                        SandBox
                                    </label>
                                </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="authorize_auto_pay" value="yes"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        Yes
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="authorize_auto_pay" value="no"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        No
                                    </label>
                                </div>
                    ...
                    <div class="row" ng-show="pytsveCtrl.services.payment_provider == 'Gr4vy'">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="gr4vy_mode" value="live"
                                            ng-model="pytsveCtrl.services.mode">
                                        Live
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="gr4vy_mode" value="sandbox"
                                            ng-model="pytsveCtrl.services.mode">
                                        SandBox
                                    </label>
                                </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="gr4vy_auto_pay" value="yes"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        Yes
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="gr4vy_auto_pay" value="no"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        No
                                    </label>
                                </div>
                    ...
                    <div class="row" ng-show="pytsveCtrl.services.payment_provider == '2C2P'">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="c2p_mode" value="live"
                                            ng-model="pytsveCtrl.services.mode">
                                        Live
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="c2p_mode" value="sandbox"
                                            ng-model="pytsveCtrl.services.mode">
                                        SandBox
                                    </label>
                                </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="c2p_auto_pay" value="yes"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        Yes
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="c2p_auto_pay" value="no"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        No
                                    </label>
                                </div>
                    ...
                    <div class="row" ng-show="pytsveCtrl.services.payment_provider == 'TrueMoney'">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="truemoney_mode" value="live"
                                            ng-model="pytsveCtrl.services.mode">
                                        Live
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="truemoney_mode" value="sandbox"
                                            ng-model="pytsveCtrl.services.mode">
                                        SandBox
                                    </label>
                                </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="truemoney_auto_pay" value="yes"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        Yes
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="truemoney_auto_pay" value="no"
                                            ng-model="pytsveCtrl.services.auto_pay">
                                        No
                                    </label>
                                </div>
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button type="submit" value="Save" class="button button-blue"
                            data-ng-if="checkAccess('payment_services.edit')"
                            ng-click="pytsveCtrl.updatedata($event, pytsveCtrl.services.id)">
