...
@section('content')
    ...
    <div data-ng-controller="CurrencyController as CurrCtrl">
        <div class="" id="dashboard-page">

            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>Payment Service Currency</h4>
            </div>
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('currencies.create')" data-ng-click="CurrCtrl.addCurr($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="payment-service/currency"
                    data-template-route="admin/payment-services/currency" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/currency.js')}}"></script>
