                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index"
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <div data-ng-if="checkAccess('payment_services')" class="form-group row"
                            ...
                            <a data-ng-if="checkAccess('payment_services')" data-ng-click="default(record, record.id)"
                                href="javascript:void(0)" class="button button-blue">
                                <span>
                                    @{{ record.default == 1 ? 'Default' : 'Not Set Default' }}
                                </span>
                            </a>
