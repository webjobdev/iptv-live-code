...
@section('content')
    ...
    <div data-ng-controller="M3UTvshowController as m3uCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="m3u-tv-show"
                    data-template-route="admin/m3u-tvshow" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/m3u-tvshow.js')}}"></script>
