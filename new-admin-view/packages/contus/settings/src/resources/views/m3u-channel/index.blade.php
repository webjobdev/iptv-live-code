...
@section('content')
    ...
    <div data-ng-controller="M3UChannelController as m3uCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="m3u-channel"
                    data-template-route="admin/m3u-channel" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/m3u-channel.js')}}"></script>
