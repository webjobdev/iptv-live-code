        ...
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            ...
            <tbody>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index"
                    ...
                    <td class="">@{{ record.setting_name }}</td>
                    <td class="">@{{ record.setting_value }}</td>
                    <td class="">@{{ record.is_hidden == '0' ? 'True' : 'False' }}</td>
...
{{-- <div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="settingForm" id="settingForm" method="POST" data-base-validator
            data-ng-submit="settCtrl.save($event, settCtrl.setting.id)" enctype="multipart/form-data">
            ...
            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!settCtrl.setting.id">
                    ...
                    Create Email Server Setting
                </h5>
                <h5 data-ng-if="settCtrl.setting.id">
                    <!-- {{ trans('customer::subscription.edit_new_subscription') }} -->
                    Edit Email Server Setting
                </h5>
            </div>
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="email_address" data-ng-model="settCtrl.setting.email_address"
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="password" data-ng-model="settCtrl.setting.password"
                            class="form-control" placeholder="Enter Dyas" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="smtp_host" data-ng-model="settCtrl.setting.smtp_host"
                            class="form-control" placeholder="Enter Dyas" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="smtp_port" data-ng-model="settCtrl.setting.smtp_port"
                            class="form-control" placeholder="Enter Dyas" />
                    </div>
                </div>
                ...
                <!-- Verify Button -->
                <div class="form-group">
                    <label>Verify Email Server Settings <span class="required">*</span></label>
                    <div class="form-input">
                        <button type="text" name="smtp_port" data-ng-model="settCtrl.setting.smtp_port"
                            class="button button-blue" placeholder="Enter Dyas">Verify </button>
                    </div>
                </div>
            </div>
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                <input type="button" value="{{ trans('base::general.cancel') }}"
                    data-ng-click="settCtrl.closesettingEdit()" name="cancel" class="save" />
