...
@section('content')
    ...
    <div data-ng-controller="M3UVodController as m3uVodCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="m3u-vod" data-template-route="admin/m3u-vod"
                    data-count="false">
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/m3u-vod.js')}}"></script>
