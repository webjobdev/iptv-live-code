...
@section('content')
    ...
    <div data-ng-controller="DeviceredirectController as drCtrl">
        <div class="" id="dashboard-page">
            ...
            @include('settings::extension.common.menu')

            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('extensions.create')" data-ng-click="drCtrl.adddere($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="setting/device-redirect"
                    data-template-route="admin/device-redirect/setting" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/device-redierct.js')}}"></script>
