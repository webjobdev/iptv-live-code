...
@section('content')
    ...
    <div data-ng-controller="PlayBackController as pbtCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('extensions.create')" data-ng-click="pbtCtrl.addPBT($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="setting/play-back-token"
                    data-template-route="admin/play-back-token/setting" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/settings/play-back.js')}}"></script>
