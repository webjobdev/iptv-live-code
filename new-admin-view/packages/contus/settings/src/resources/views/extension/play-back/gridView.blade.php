        ...
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.name"
                            placeholder="Enter Name" data-boot-tooltip="true" title="Name">
                    </td>
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.type"
                            placeholder="Enter Type" data-boot-tooltip="true" title="Type">
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index"
                    ...
                    <td>@{{ record.name }}</td>
                    <td>@{{ record.type }}</td>
                    <td>@{{ (record.token_time / 60) | number:0 }} Min</td>
                    <td>@{{ '0' }}</td>

                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">

                            <div data-ng-if="checkAccess('extensions.edit')" class="form-group row"
                            ...
                            <div data-ng-if="checkAccess('extensions.edit')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="pbtCtrl.editdata(record)">
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('extensions.delete')">
...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="PBTForm" id="PBTForm" method="POST" data-base-validator
            data-ng-submit="pbtCtrl.save($event, pbtCtrl.pbt.id)" enctype="multipart/form-data">
            {!! csrf_field() !!}

            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!pbtCtrl.pbt.id">
                    Create Play Back Token
                </h5>
                <h5 data-ng-if="pbtCtrl.pbt.id">
                    Edit Play Back Token
                </h5>
            </div>
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="name" data-unique="@{{pbtCtrl.uniqueRoute}}"
                            data-ng-model="pbtCtrl.pbt.name" class="form-control" placeholder="Enter Name">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <select class="form-control" data-jquery="select2_custom_ddl" name="type"
                            myPlaceholder="Select Type" data-ng-model="pbtCtrl.pbt.type" myValue="pbtCtrl.pbt.type">
                            <option disabled value="">Choose Type</option>
                            <option value="Akamai">Akamai</option>
                            <option value="Level3">Level3</option>
                            <option value="Wowza">Wowza</option>
                            <option value="CDN77">CDN77</option>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="secret_key" data-unique="@{{pbtCtrl.uniqueRoute}}"
                            data-ng-model="pbtCtrl.pbt.secret_key" class="form-control" placeholder="Enter Secret Key">
                    </div>
                    <p class="error-msg" data-ng-show="errors.secret_key.has">
                ...
                <div class="form-group row">
                    <label class="col-sm-3">Token Time<span class="required">*</span>:</label>
                    <div class="col-sm-6">
                        <input type="text" name="token_time" data-unique="@{{pbtCtrl.uniqueRoute}}"
                            data-ng-model="pbtCtrl.pbt.token_time" class="form-control" placeholder="Enter Token Time">
                    </div>
                    <label class="col-sm-3" style="margin-top: 10px;">Seconds</label>
                    <p class="error-msg" data-ng-show="errors.token_time.has">
                        @{{ errors.token_time.message }}
                    </p>
                </div>

                <!-- Secret Generation Number -->
                <div class="form-group" data-ng-show="pbtCtrl.pbt.type == 'Level3'">
                    <label>Secret Generation Number
                        <!-- <span class="required">*</span>: -->
                    </label>
                    <div class="form-input">
                        <input type="text" name="secret_generation_number" data-unique="@{{pbtCtrl.uniqueRoute}}"
                            data-ng-model="pbtCtrl.pbt.secret_generation_number" class="form-control"
                            placeholder="Enter Secret Generation Number">
                    </div>
                </div>

                <!-- Ignore device IP verification -->
                <div class="form-group" data-ng-show="pbtCtrl.pbt.type == 'Flussonic' || pbtCtrl.pbt.type == 'OnApp'">
                    <label>Ignore Device Ip Verification<span class="required">*</span>:</label>
                    <div class="form-input">
                        <input type="text" name="ignore_device_ip_verification" data-unique="@{{pbtCtrl.uniqueRoute}}"
                            data-ng-model="pbtCtrl.pbt.ignore_device_ip_verification" class="form-control"
                            placeholder="Enter Ignore Device Ip Verification">
                    </div>
                </div>

                <!-- RSA Private Key -->
                <div class="form-group" data-ng-show="pbtCtrl.pbt.type == 'AWS Cloudfront'">
                    <label>RSA Private Key<span class="required">*</span>:</label>
                    <div class="form-input">
                        <input type="text" name="rsa_private_key" data-unique="@{{pbtCtrl.uniqueRoute}}"
                            data-ng-model="pbtCtrl.pbt.rsa_private_key" class="form-control"
                            placeholder="Enter RSA Private Key">
                    </div>
                </div>

                <!-- Url format -->
                <div class="form-group" data-ng-show="pbtCtrl.pbt.type == 'OnApp'">
                    <label>Url Format<span class="required">*</span>:</label>
                    <div class="form-input">
                        <input type="text" name="url_format" data-unique="@{{pbtCtrl.uniqueRoute}}"
                            data-ng-model="pbtCtrl.pbt.url_format" class="form-control" placeholder="Enter Url Format">
                    </div>
                </div>
                ...
                <div class="form-group row" style="margin-bottom: 15px;">
                    ...
                    <div class="col-sm-9" style="display:flex; align-items:center;">
                        <label class="switch">
                            <input type="checkbox" ng-model="pbtCtrl.pbt.is_active" name="is_active"
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                <input type="button" value="{{ trans('base::general.cancel') }}" data-ng-click="pbtCtrl.closepbtEdit()"
                    name="cancel" class="save" />
