        ...
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.url"
                            placeholder="Enter Url" data-boot-tooltip="true" title="Url">
                    </td>
                    <td></td>
                </tr>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('extensions.edit')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="drCtrl.editdata(record)">
...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="adddrForm" id="adddrForm" method="POST" data-base-validator
            data-ng-submit="drCtrl.save($event, drCtrl.adddr.id)" enctype="multipart/form-data">

            {!! csrf_field() !!}

            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!drCtrl.adddr.id">
                    Create Device Redirect
                </h5>
                <h5 data-ng-if="drCtrl.adddr.id">
                    Edit Device Redirect
                </h5>
            </div>
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="name" data-unique="@{{drCtrl.uniqueRoute}}" value=""
                            data-ng-model="drCtrl.adddr.name" class="form-control" placeholder="Enter Name" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="url" data-unique="@{{drCtrl.uniqueRoute}}" value=""
                            data-ng-model="drCtrl.adddr.url" class="form-control" placeholder="Enter Url" />
                    </div>
                </div>
                ...
                <div class="form-group row" style="margin-bottom: 15px;">
                    ...
                    <div class="col-sm-9" style="display:flex; align-items:center;">
                        <label class="switch">
                            <input type="checkbox" ng-model="drCtrl.adddr.is_active"
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                <input type="button" value="{{ trans('base::general.cancel') }}" data-ng-click="drCtrl.closeadddrEdit()"
