        ...
        <div class=" " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                ...
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('drm_profiles.create')" data-ng-click="drmCtrl.addDrm($event)"
                        ...
                        <span>{{trans('drm::index.create_drm')}}</span>
                    </a>
            ...
            <form class="form-inline serch-btn" id="searchForm" method="GET">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" data-ng-model="searchRecords.drm_name"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="drm" data-template-route="admin/drm"
