    ...
    <div class="alert-popup-content">
        ...
        <div class="popup_content">
            ...
            <div class="popup_btns text-center">
                <a data-ng-click="{{ $control }}.cancelDeleteVideos()" href="javascript:void(0)" class="pop_cancel_btn"
                    id="pop_cancel_btn">{{__('base::gridlist.no')}}</a>
                <a data-ng-click="{{ $control }}.confirmDeleteVideos('single-video')" href="javascript:void(0)"
                    class="pop_confirm_btn">{{__('base::gridlist.yes')}}</a>
            </div>
        </div>
    </div>
</div>
...
<div class="alert-popup modal fade" id="removeTrailerModel" ng-show="removeTrailerConfirmation">
    <div class="alert-popup-content">
        ...
        <div class="popup_content">
            ...
            {{-- <span class="delete_detail">@{{ vodSelectedVideo.title }}</span> --}}
            <div class="popup_btns text-center">
                <a data-ng-click="{{ $control }}.cancelRemoveTrailer()" href="javascript:void(0)" class="pop_cancel_btn"
                    id="pop_cancel_btn">{{__('base::gridlist.no')}}</a>
                <a data-ng-click="{{ $control }}.confirmRemoveTrailer('remove-trailer')" href="javascript:void(0)"
                    class="pop_confirm_btn">{{__('base::gridlist.yes')}}</a>
            </div>
        </div>
    </div>
    ...
    <div class="alert-popup-content">
        ...
        <div class="popup_content">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 442.035 442.035" style="enable-background:new 0 0 442.035 442.035;"
                xml:space="preserve" width="28px" height="28px">
                <g>
                    <path fill="#7f7f7f"
                        d="M248.227,399.201c-9.616,0-17.483,7.867-17.483,17.483s7.867,17.483,17.483,17.483H408.49
            ...
            <span class="delete_detail">@{{ vodSelectedVideo.title }}</span>
            <div class="popup_btns text-center">
                <a data-ng-click="{{ $control }}.cancelReplaceVideos()" href="javascript:void(0)" class="pop_cancel_btn"
                    id="pop_cancel_btn">{{__('base::gridlist.no')}}</a>
                <a data-ng-click="{{ $control }}.confirmReplaceVideos(vodSelectedVideo)" href="javascript:void(0)"
                    class="pop_confirm_btn">{{__('base::gridlist.yes')}}</a>
            </div>
        </div>
    </div>
...
<div class="alert-popup modal fade" id="livestreamStopModal" data-role="dialog">
    <div class="alert-popup-content">
        ...
        <div class="popup_content">
            ...
            <div class="popup_btns text-center">
                <a data-ng-click="{{ $control }}.cancelLiveStreamRecording()" href="javascript:void(0)"
                    class="pop_cancel_btn" id="pop_cancel_btn" data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                <a data-ng-click="{{ $control }}.confirmLiveStreamRecording()" href="javascript:void(0)"
                    class="pop_confirm_btn" data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
            </div>
        </div>
    </div>
</div>
...
<div class="alert-popup modal fade" id="videoBulkDeleteModal" data-role="dialog">
    <div class="alert-popup-content">
        ...
        <div class="popup_content" data-ng-show="{{ $control }}.isDeleteBulkRecord">
            ...
            <div class="popup_btns text-center">
                <a class="pop_cancel_btn" data-ng-click="{{ $control }}.cancelDeleteVideos()"
                    data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                <a data-ng-click="{{ $control }}.confirmDeleteVideos('bulk-video')" class="pop_confirm_btn"
        ...
        <div class="popup_content" data-ng-show="{{ $control }}.isActivateBulkRecord">
            ...
            <div class="popup_btns text-center">
                <a class="pop_cancel_btn" data-ng-click="{{ $control }}.cancelDeleteVideos()"
                    data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                <a data-ng-click="{{ $control }}.confirmActivateOrDeactivateVideos(1)" class="pop_confirm_btn"
                    data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
            </div>
        </div>
        ...
        <div class="popup_content" data-ng-show="{{ $control }}.isDeactivateBulkRecord">
            ...
            <div class="popup_btns text-center">
                <a class="pop_cancel_btn" data-ng-click="{{ $control }}.cancelDeleteVideos()"
                    data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                <a data-ng-click="{{ $control }}.confirmActivateOrDeactivateVideos(0)" class="pop_confirm_btn"
                    data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
            </div>
        </div>
        <div class="popup_content" data-ng-show="ConfirmationStatusBox">
            ...
            <div class="popup_btns text-center">
                <a class="pop_cancel_btn" data-ng-click="{{ $control }}.cancelDeleteVideos()"
                    data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                <a data-ng-click="{{ $control }}.confirmStatus()" class="pop_confirm_btn"
                    data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
            </div>
        </div>
        <div class="popup_content" data-ng-show="{{ $control }}.isEditBulkRecord">
            ...
            <div class="popup_btns text-center">
                <a class="pop_cancel_btn" data-ng-click="{{ $control }}.cancelDeleteVideos()"
                    data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                <a data-ng-click="{{ $control }}.confirmEditVideos()" class="pop_confirm_btn"
                    data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
            </div>
        </div>
    </div>
