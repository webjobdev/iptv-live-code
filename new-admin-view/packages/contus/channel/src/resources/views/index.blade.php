...
@section('content')
    ...
    <div data-ng-controller="ChannelGridController as channelCtrl">

        @include('channel::common.subMenu', ['template' => 'channel'])

        <div class="contentpanel clearfix video_grid">
            @include('base::partials.errors')
            <div class="response-msg"></div>
            <div data-grid-view data-rows-per-page="10" data-template-route="admin/channel" data-route-name="channel"
                data-request-grid="channel" data-count="false">
            </div>
        </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="clearfix modal-footer video_delete_footer radio-popup">
                        <span data-ng-click="channelCtrl.cancelDeleteVideos()" class="btn btn-danger pull-right"
                            data-dismiss="modal">{{__('base::gridlist.cancel')}}</span>
                        <span data-ng-click="channelCtrl.confirmDeleteVideos('single-video')"
        ...
        <div class="alert-popup modal fade" id="videoBulkDeleteModal" data-role="dialog">
            <div class="alert-popup-content">
                ...
                <div class="popup_content" data-ng-show="channelCtrl.isDeleteBulkRecord">
                    <span class="conformation_txt">
                        {{__('base::gridlist.bulk_delete_confirm')}}
                    </span>

                    <div class="popup_btns text-center">
                        <a class="pop_cancel_btn" data-ng-click="channelCtrl.cancelDeleteVideos()"
                            data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                        <a data-ng-click="channelCtrl.confirmDeleteVideos('bulk-video')" class="pop_confirm_btn"
                            data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                    </div>
                </div>

                <div class="popup_content" data-ng-show="channelCtrl.isActivateBulkRecord">
                    <span class="conformation_txt">
                    ...
                    <div class="popup_btns text-center">
                        <a class="pop_cancel_btn" data-ng-click="channelCtrl.cancelDeleteVideos()"
                            data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                        <a data-ng-click="channelCtrl.confirmActivateOrDeactivateVideos(1)" class="pop_confirm_btn"
                            data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                    </div>
                </div>

                <div class="popup_content" data-ng-show="channelCtrl.isDeactivateBulkRecord">
                    <span class="conformation_txt">
                    ...
                    <div class="popup_btns text-center">
                        <a class="pop_cancel_btn" data-ng-click="channelCtrl.cancelDeleteVideos()"
                            data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                        <a data-ng-click="channelCtrl.confirmActivateOrDeactivateVideos(0)" class="pop_confirm_btn"
                            data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                    </div>
                </div>
                <div class="popup_content" data-ng-show="ConfirmationStatusBox">
                    ...
                    <div class="popup_btns text-center">
                        <a class="pop_cancel_btn" data-ng-click="channelCtrl.cancelDeleteVideos()"
                            data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                        <a data-ng-click="channelCtrl.confirmStatus()" class="pop_confirm_btn"
                            data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                    </div>
                </div>
                <div class="popup_content" data-ng-show="channelCtrl.isEditBulkRecord">
                    <span class="conformation_txt">
                    ...
                    <div class="popup_btns text-center">
                        <a class="pop_cancel_btn" data-ng-click="channelCtrl.cancelDeleteVideos()"
                            data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                        <a data-ng-click="channelCtrl.confirmEditEvents()" class="pop_confirm_btn"
                            data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default"
                            data-dismiss="modal">{{ __('base::general.close') }}</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Poster Modal -->
        <div class="modal fade" id="poster_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
            aria-hidden="true">
            <div class="modal-dialog img-cropper" role="document">
                <div class="modal-content">
                    <div class="modal-header">
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/channel/index.js')}}"></script>
