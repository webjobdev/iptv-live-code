                ...
                <tbody>
                    <tr class="search_text">
                        ...
                        <td class="search_product">
                            <input type="text" class="form-control" data-ng-model="searchRecords.channel_name"
                                placeholder="Enter Channel Name" data-boot-tooltip="true" title="Name of the Channel">
                        </td>
                        <td class="search_product">
                            <input type="text" class="form-control" data-ng-model="searchRecords.policy"
                                placeholder="Enter Policy Name" data-boot-tooltip="true" title="Streaming URL Policy">
                        </td>
                        <td>
                            <input type="text" class="form-control" data-ng-model="searchRecords.language"
                                placeholder="Enter Language" data-boot-tooltip="true" title="Language">
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index"
                        ...
                        <td>
                            <div class="product_img flexbox align-items-center">
                                <a class="table-image-text flexbox align-items-center">
                                    <div class="image" bg-image="@{{record.poster_image.replaceAll('\\','/')}}"
                                    ...
                                    <div class="product_description tooltip-parent "
                                        ...
                                        <p class="img_description">@{{ record.channel_name}}</p>
                                    </div>
                                </a>
                        ...
                        <td>
                            <div data-ng-if="record.pin_locked != 1">
                        ...
                        <td class="table-actions">
                            <div class="flexbox align-items-center justify-center">
                                ...
                                <div data-ng-if="checkAccess('channel.edit')" class="form-group row"
                                ...
                                <div class="column edit_table_icon tooltip-parent" ng-if="checkAccess('channel.edit')">
                                ...
                                <!-- delete button -->
                                <div class="tooltip-parent" data-ng-if="checkAccess('channel.delete')">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="collectionForm" method="POST" data-base-validator=""
                    data-ng-submit="channelCtrl.save($event)" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="collection_model">
                        <div class="collection_listing">
                            <div class="rdio rdio-primary collection_listing_input"
                                data-ng-repeat="(key, value) in channelCtrl.allCollections">
                                <input type="radio" name="radio" data-ng-value="@{{key}}"
                                    data-ng-model="channelCtrl.collection.id"
                                    data-ng-change="channelCtrl.createCollection(key)" id="radioPrimary_@{{key}}">
...
<div id="videoPresetsModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="preset_wrap" data-ng-repeat="preset in channelCtrl.commonVideoPresets track by $index">@{{
                    $index+1 }}. @{{ preset }}</div>
            </div>
            <div class="modal-footer">
