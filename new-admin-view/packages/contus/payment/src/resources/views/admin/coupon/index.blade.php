...
@endsection
@section('content')
<div data-ng-controller="couponController as couponCtrl">	
	<div class="page-heading flexbox align-items-center flex-wrap">
		<div class="left-side">
			<h4>{{trans('payment::coupons.coupons') }}</h4>
		</div>
		<div class="right-side flexbox align-items-center">
			<a data-ng-if="checkAccess('coupons_all_write')" data-ng-click="couponCtrl.addCoupon($event)"  href="javascript:void(0)" class="button button-blue sidepanel-open">
				...
				<span>{{trans('payment::coupons.create_coupon')}}</span>
			</a>
	...
	<div class="contentpanel product order_list">
		...
		<div data-grid-view data-rows-per-page="10"
			data-route-name="coupon"
			data-template-route="admin/coupon" data-count="false"></div>
	</div>
</div>
...
<script src="{{asset('adminview/assets/js/coupon/index.js')}}"></script>
