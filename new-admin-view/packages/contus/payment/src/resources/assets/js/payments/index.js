...
var paymentController = ['$scope','$rootScope','requestFactory','$window','$sce','$timeout',function ( scope, rootScope, requestFactory, $window, $sce, $timeout ) {
    var self = this;
    this.payment = {};
    scope.rules = {};
    ...
    this.fetchInfo = function () {
        requestFactory.get( requestFactory.getUrl( 'payments/info' ), this.defineProperties, function (response) {
