...
@section('content')
    <div data-ng-controller="LiveRewindController as LiveCtrl">
        ...
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                ...
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('live_rewind.create')" ng-click="LiveCtrl.addData($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view 
                    ...
                    data-template-route="admin/channel-services/live-rewind" 
                    data-route-name="live-rewind"
                    data-count="false">
                </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/chnnel-service/live-rewind.js')}}"></script>
