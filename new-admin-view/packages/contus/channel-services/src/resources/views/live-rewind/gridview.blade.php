        ...
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product center td-custom-width">
                        <input type="text" class="form-control search-amount-subscription"
                            placeholder="Enter Streaming Provider" data-ng-model="searchRecords.streaming_provider"
                            data-boot-tooltip="true" data-toggle="tooltip" data-original-title="Streaming Provider">
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" class="list-repeat"
                    ...
                    <td>
                        @{{ record.streaming_provider }}
                    </td>

                    <td>
                        @{{ record.live_rewind_node || '-' }}
                    </td>

                    <td ng-style="{'color': record.live_rewind_node ? '#5cb85c' : '#d9534f'}">
                        @{{ record.live_rewind_node ? 'Enable' : 'Disable' }}
                    </td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div ng-if="checkAccess('live_rewind.edit')"
                                class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="LiveCtrl.editdata(record)">
                            ...
                            <div class="tooltip-parent" data-ng-if="checkAccess('live_rewind.delete')">
...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="organizationForm" id="organizationForm" method="POST" data-base-validator
            data-ng-submit="LiveCtrl.save($event, LiveCtrl.livewind.id)" enctype="multipart/form-data">

            {!! csrf_field() !!}

            <!-- Header -->
            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!LiveCtrl.livewind.id">
                    Create Live Rewind
                </h5>
                <h5 data-ng-if="LiveCtrl.livewind.id">
                    Edit Live Rewind
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control mb10 select2_custom_ddl" ng-model="LiveCtrl.livewind.channel_id"
                        data-jquery="select2_custom_ddl" myPlaceholder="Select Tv Channel" name="channel_id"
                        data-ng-options="chnl.id as chnl.channel_name for chnl in LiveCtrl.channelList">
                        <option value="" disabled>-- Select Tv Channel --</option>
                    </select>
                    <p class="error-msg" data-ng-show="errors.channel_id.has">
                        Select Channel
                    </p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control mb10 select2_custom_ddl" ng-model="LiveCtrl.livewind.streaming_provider"
                        data-jquery="select2_custom_ddl" myPlaceholder="Select Streaming Provider"
                        name="streaming_provider">
                        <option value="" disabled>-- Select Streaming Provider --</option>
                ...
                <!-- Live Rewind Node (Only shows if provider is Akamai) -->
                <div ng-if="LiveCtrl.livewind.streaming_provider == 'akamai'" class="form-group">
                    <label>Live Rewind Node</label><br>
                    <select ng-model="LiveCtrl.livewind.live_rewind_node" class="form-control mb10 select2_custom_ddl"
                        data-jquery="select2_custom_ddl" myPlaceholder="Select Live Rewind Node"
                        name="live_rewind_nodes">
                        <option value="" disabled>-- Select Node --</option>
                        <option value="Akamai-LR-01">Akamai-LR-01 (US-East)</option>
                        <option value="Akamai-LR-02">Akamai-LR-02 (US-West)</option>
                        <option value="Akamai-LR-03">Akamai-LR-03 (Europe)</option>
                        <option value="Akamai-LR-04">Akamai-LR-04 (Asia)</option>
                    </select>
                </div>
                    ...
                    <div class="switch-concept flexbox align-items-center">
                        <div class="swich-content flexbox align-items-center flex-wrap">
                            ...
                            <div class="right-side flexbox align-items-center">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="custome_streaming_url"
                                        ng-model="LiveCtrl.livewind.custome_streaming_url">
                                    <span class="slider round"></span>
                                </label>
                ...
                <div ng-if="LiveCtrl.livewind.custome_streaming_url" class="form-group">
                    <!-- url -->
                    <div class="form-group">
                        <label>
                            Url
                        ...
                        <div class="form-input">
                            <input type="text" name="url" data-unique="@{{livewindCtrl.uniqueRoute}}"
                                data-ng-model="LiveCtrl.livewind.url" class="form-control" placeholder="Enter Url">
                        </div>
                        <p class="error-msg" data-ng-show="errors.url.has">
                            @{{ errors.url.message }}
                        </p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input">
                            <select data-jquery="select2_custom_ddl" name="drm_type"
                                class="admin_category_sub form-control select2_custom_ddl"
                                myValue="LiveCtrl.livewind.drm_type" myPlaceholder="Select DRM Type"
                                data-ng-model="LiveCtrl.livewind.drm_type"
                                data-ng-options="provider for provider in LiveCtrl.drmProviders">
                                <option value="" disabled>--- Select DRM Type ---</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group"
                        data-ng-if="LiveCtrl.livewind.drm_type === 'Pallycon' || LiveCtrl.livewind.drm_type === 'EZDRM'">
                        <label>
                            Select DRM Profile
                            <!-- <span class="required">*</span> -->
                        </label>
                        <div class="form-input">
                            <select data-jquery="select2_custom_ddl" name="drm_profile"
                                class="admin_category_sub form-control select2_custom_ddl"
                                myValue="LiveCtrl.livewind.drm_profile" myPlaceholder="Select DRM Profile"
                                data-ng-model="LiveCtrl.livewind.drm_profile" data-ng-options="drm.drmprofile.id as drm.drmprofile.drm_name for drm in LiveCtrl.drmProfiles 
                                | filter:{drm_provider: LiveCtrl.livewind.drm_type, drmprofile: {drm_name: ''}}"
                                myPlaceholder="Select DRM Profile">
                                <option value="" disabled>--- Select DRM Profile ---</option>
                            </select>
                        </div>
                        <p class="error-msg" data-ng-show="errors.age_limit.has">
                            @{{ errors.age_limit.has }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input">
                            <select allowClear="1" data-jquery="select2_custom_ddl" name="playback_token"
                                class="admin_category_sub form-control select2_custom_ddl"
                                myValue="LiveCtrl.livewind.playback_token"
                                myPlaceholder="Select Playback Token Generator"
                                data-ng-options="pbt.id as pbt.name for pbt in LiveCtrl.playbackTokenList"
                                data-ng-model="LiveCtrl.livewind.playback_token">
                    ...
                    <div class="form-group">
                        ...
                        <select allowClear="1" data-jquery="select2_custom_ddl" name="token_generator"
                            class="admin_category_sub form-control select2_custom_ddl"
                            myValue="LiveCtrl.livewind.token_generator" myPlaceholder="Select Token Generator"
                            data-ng-model="LiveCtrl.livewind.token_generator">
                            <option value="" disabled>--- Select ---</option>
                    ...
                    <div class="switch-concept flexbox align-items-center">
                        <div class="swich-content flexbox align-items-center flex-wrap">
                            ...
                            <div class="right-side flexbox align-items-center">
                                <span class="text">{{ __('video::videos.inactive') }}</span>
                                <label class="switch">
                                    <input type="checkbox" name="is_active" ng-model="LiveCtrl.livewind.is_active">
                                    <span class="slider round"></span>
                                </label>
                                <span class="text">{{ __('video::videos.active') }}</span>
                            </div>
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                <input type="button" value="{{ trans('base::general.cancel') }}"
                    data-ng-click="LiveCtrl.closeSubscriptionEdit()" name="cancel" class="save">
