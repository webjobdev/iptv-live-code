...
@section('content')
<div data-ng-controller="CatchUpController as catchUpCtrl">
    ...
    <div class="contentpanel" id="dashboard-page">
        ...
        <div class="page-heading flexbox align-items-center flex-wrap">
            <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('catch_up_tv.create')" href="javascript:void(0)"
                    class="button button-blue sidepanel-open" ng-click="catchUpCtrl.addData($event)">
        ...
        <div class="contentpanel product order_list">
            ...
            <div data-grid-view data-rows-per-page="10" data-template-route="admin/channel-services"
                data-route-name="catch-up" data-count="false">
            </div>
...
<script src="{{asset('adminview/assets/js/chnnel-service/catch-up.js')}}"></script>
