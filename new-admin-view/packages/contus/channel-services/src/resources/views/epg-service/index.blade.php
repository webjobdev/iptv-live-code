...
@section('content')
    <div data-ng-controller="EpgServiceController as epgCtrl">
        ...
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                ...
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('epg_service.create')" href="javascript:void(0)"
                        class="button button-blue sidepanel-open" ng-click="epgCtrl.addData($event)">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/channel-services/epg-service"
                    data-route-name="epg-service" data-count="false">
                </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/chnnel-service/epg-service.js')}}"></script>
