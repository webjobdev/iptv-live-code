...
@section('content')
    @include('tvshow::common.subMenu', ['template' => 'edit_tvshow_season'])
    <div class="form-page" data-base-validator data-ng-controller="SeasonEpisodeUploadController as tvsneGridCtrl"
        id="video-detail-start" data-ng-init="tvsneGridCtrl.fetchData('{{$id}}')">
        ...
        <div id="video_accordion_wrapper">
            <div class="form-page">
                @include('tvshow::episode.EpisodeForm')

                @include('tvshow::common.popup', ['control' => 'tvsneGridCtrl'])
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/tvshow/Season-Episode-Upload.js')}}"></script>
