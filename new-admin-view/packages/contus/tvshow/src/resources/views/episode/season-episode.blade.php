...
@section('content')
    ...
    <div ng-controller="SeasonEpisodeUploadController as tvsneGridCtrl" data-ng-init="tvsneGridCtrl.init()">
        @include('tvshow::common.subMenu', ['template' => 'add_tvshow'])
        {!! csrf_field() !!}
        <div class="contentpanel">
            @include('base::partials.errors')
            <div class="form-page">
                @include('tvshow::episode.EpisodeForm')
                @include('vod::common.popup', ['control' => 'tvsneGridCtrl'])
            </div>
        </div>
    </div>
