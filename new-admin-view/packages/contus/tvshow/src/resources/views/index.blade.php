...
@section('content')
    ...
    <div data-ng-controller="TvShowController as tvsCtrl">

        @include('tvshow::common.subMenu', ['template' => 'tvshow'])

        <div class="contentpanel clearfix video_grid">
            @include('base::partials.errors')
            <div class="response-msg"></div>
            <div data-grid-view data-rows-per-page="10" data-template-route="admin/tvshow" data-route-name="tv-show/fetch"
                data-request-grid="tv-show/fetch" data-count="false">
            </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/tvshow/index.js')}}"></script>
