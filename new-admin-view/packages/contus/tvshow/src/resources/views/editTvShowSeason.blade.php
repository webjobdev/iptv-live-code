...
@section('content')
    ...
    <div class="form-page" data-base-validator data-ng-controller="TvShowSeasonUploadController as tvsnGridCtrl"
        id="video-detail-start" data-ng-init="tvsnGridCtrl.fetchData('{{$id}}')">
        ...
        <div id="video_accordion_wrapper">
            <div class="form-page">
                ...
                @include('tvshow::common.popup', ['control' => 'tvsnGridCtrl'])
            </div>
        </div>
    </div>
@endsection
