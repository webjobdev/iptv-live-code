        ...
        <div class=" " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Partner Program</li>
                </ol>
            </div>
            <br>

            <div id="edit-form-div" class="tab-pane fade in active contentpanel form-page"><br>
                <div class="row">
                    <div class="mx-auto" style="width:70%; margin-left: 10rem;">
                        <form method="POST" enctype="multipart/form-data" data-base-validator
                            ...
                            {!! csrf_field() !!}
                            <input type="hidden" id="edit-program-id" name="id" value="{{ request()->id }}">
                            ...
                            <div class="upload-cover-thumbnail flexbox"
                                ...
                                <div class="form-group row">
                                    <label for="partner_code" class="col-sm-2 control-label"
                                        style="font-size: 14px; color: #000; margin-top: 10px; font-weight: bold;"><strong>Partner
                                            App
                                            Logo:</strong>
                                    </label>
                                </div>
                                <div class="thumbnail-image">
                                    ...
                                    <p class="error-msg" data-ng-show="errors.product_image.has">
                                        @{{ errors.partner_app_logo.message }}</p>
                                </div>
                            </div>
