    ...
    <div data-ng-controller="PartnerProgramController as programCtrl">
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>{{ __('partner-programs::index.partner_program') }}</h4>

                <div class="right-side flexbox align-items-center">
                    <a data-ng-click="programCtrl.addPartnerProgram($event)"
                        ...
                        <span>{{ trans('partner-programs::index.create_partner_program') }}</span>
                    </a>
                </div>
            </div>
            ...
            <form class="form-inline serch-btn" id="searchForm" method="GET"
                ng-submit="programCtrl.searchPartnerPrograms($event)">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" ng-model="searchRecords.name" placeholder="Search here..."
                    aria-label="Search" id="searchInput" ng-change="programCtrl.searchPartnerPrograms()">&nbsp;
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="partner-programs"
                    data-template-route="admin/partner-programs" data-count="false"></div>
            </div>
        </div>
    </div>
@endsection
