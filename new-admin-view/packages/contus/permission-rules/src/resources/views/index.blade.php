    ...
    <div data-ng-controller="PermissionRuleController as permsnRuleCtrl">
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>{{ __('permission-rules::index.permission_rules') }}</h4>

                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('permission_rules.create')" data-ng-click="permsnRuleCtrl.addPermissionRule($event)"
                        ...
                        <span>{{ trans('permission-rules::index.create_permission_rules') }}</span>
                    </a>
            ...
            <form class="form-inline serch-btn" id="searchForm" method="GET"
                ng-submit="permsnRuleCtrl.searchPartnerPrograms($event)">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" ng-model="searchRecords.rule_name"
                    placeholder="Search here..." aria-label="Search" id="searchInput"
                    ng-change="permsnRuleCtrl.searchPartnerPrograms()">&nbsp;
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="permission-rules"
                    data-template-route="admin/permission-rules" data-count="false"></div>
            </div>
        </div>
    </div>
@endsection
