        ...
        <div class=" " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Permission Rule</li>
                </ol>
            </div>
                ...
                <div class="row">
                    <div class="permission-form-container mx-auto">
                        <form method="POST" enctype="multipart/form-data" data-base-validator
                            data-ng-submit="permsnRuleCtrl.updatePermissionRule($event)">
                            {!! csrf_field() !!}
                                                ...
                                                <a role="button" data-toggle="collapse" class="collapsed"
                                                    ...
                                                    <div class="label-div">
                                                        ...
                                                        <input type="hidden" name="module_name"
                                                            ...
                                                            ng-init="permsnRuleCtrl.initModule('channel-services', 'channel_service')">
                                                        Channel Service
                                                    </div>
                                                </a>
                                            </h5>
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="button button-blue" id="permissionruleedit">
