...
<div id="announcment">
    ...
    <div class="table_responsive">
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            <thead>
                <tr>
                    @include('audio::admin.common.bulkActionLayout', ['access_type' => 'permission_rules'])
            ...
            <tbody>
                ...
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.rule_name"
                            data-boot-tooltip="true" id="" data-toggle="tooltip" data-original-title="Enter Rule Name" placeholder="Enter Rule Name">
                    </td>
                    <td></td>
                    <td></td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat-start="record in records track by $index"
                    ...
                    <td class="">@{{ record.rule_name }}</td>

                    <td>
                        <span title="@{{ getFormattedOrgNames(record.organization) }}" style="cursor: pointer;">
                            <span data-ng-repeat="org in record.organization | limitTo: 3">
                                @{{ org.organization_name }}<span data-ng-if="!$last">, </span>
                            </span>
                            <span data-ng-if="record.organization.length > 3">...</span>
                        </span>
                    </td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <!-- edit button -->
                            <div data-ng-if="checkAccess('permission_rules.edit')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="permsnRuleCtrl.editPermissionRule(record.id)">
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('permission_rules.delete')">
