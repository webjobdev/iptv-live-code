    ...
    <div data-ng-controller="StreamingUrlPolicyController as strmUrlCtrl">
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>{{ __('stream-services::index.stream_url_policy') }}</h4>

                <div class="right-side flexbox align-items-center">
                    <a data-ng-click="strmUrlCtrl.addStreamingUrlPolicy($event)" href="javascript:void(0)"
                        class="button button-blue sidepanel-open" data-ng-if="checkAccess('stream_service.create')">
                        ...
                        <span>{{ trans('stream-services::index.create_stream_url_policy') }}</span>
                    </a>
            ...
            <form class="form-inline serch-btn" id="searchForm" method="GET" ng-submit="strmUrlCtrl.searchRecord($event)">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" ng-model="searchRecords.policy_name" placeholder="Search here..."
                    aria-label="Search" id="searchInput" ng-change="strmUrlCtrl.searchRecord()">&nbsp;
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="stream-services/streaming-url-policy"
                    data-template-route="admin/stream-services/streaming-url-policy" data-count="false"></div>
            </div>
        </div>
    </div>
@endsection
