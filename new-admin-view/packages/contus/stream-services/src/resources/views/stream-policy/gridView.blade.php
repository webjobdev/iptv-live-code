            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" id="searchInput" data-ng-model="searchRecords.policy_name"
                            data-boot-tooltip="true" data-toggle="tooltip" data-original-title="Enter Name" placeholder="Enter The Name">
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat-start="record in records track by $index"
                    ...
                    <td class="">
                        {{-- <a data-toggle="collapse" data-parent="#stremurlAccordion"
                            href="#stremurl_@{{ record.id }}" aria-expanded="false"> --}}
                        @{{ record.policy_name }}
                        {{-- </a> --}}
                    </td>
                    ...
                    <td class="">@{{ record.user[0].name }}</td>
                    <td class="">@{{ record.content }}
                        <div class="" id="input-btns">
                            <button>2</button>
                        </div>
                    </td>
                    <td class="">
                        <div data-ng-if="checkAccess('stream_service.edit')" class="form-group row"
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <!-- view button -->
                            <div data-ng-if="checkAccess('stream_service.view')"
                                class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="strmUrlCtrl.viewStreamingUrlPolicy(record.id)">
                            ...
                            <!-- edit button -->
                            <div data-ng-if="checkAccess('stream_service.edit')"
                                class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="strmUrlCtrl.editStreamingUrlPolicy(record.id)">
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('stream_service.delete')">
