        ...
        <div class="dashboard-page " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Streaming Url Policy</li>
                </ol>
            </div>
            <br>

            <div id="edit-form-div" class="tab-pane fade in active"><br>
                <div class="row">
                    <div class="mx-auto form-main-div" style="width:70%; margin-left: 10rem;">
                        <form method="POST" enctype="multipart/form-data" data-base-validator
                            data-ng-submit="strmUrlCtrl.updateStreamingUrlPolicy($event, id)">
                            {!! csrf_field() !!}
                            <input type="hidden" id="stream-url-id" name="id" value="{{ request()->id }}">

                            <!-- stream policy name -->
                            <div class="form-group name-div" style="margin-bottom: 15px;">
                                <div class="col-lg-7 name-label-div"
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control"
                                            ...
                                            placeholder="{{ trans('stream-services::index.policy_name_plachldr') }}"
                                            id="name"
                                ...
                                <div class="media" style="margin-bottom: 20px; border-radius: 30px;">
                                    <button type="button" class="button button-blue add-rule-btn" id="" ng-if="!isViewMode"
                            ...
                            <div class="accordion accordian-div" id="accordionExample"
                                ...
                                <div class="card">
                                    <div class="card-header accordian-header" id="headingOne">
                                        ...
                                        <div data-ng-if="checkAccess('stream_services') && !isViewMode"
                                            class="form-group row toggle" style="margin-bottom: 0px">
                                            <label class="switch">
                                                <input type="checkbox" name="status" ng-checked="record.status == 1"
                                                    ng-disabled="isViewMode" ng-click="strmUrlCtrl.toggleStatus(record)">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-lg-5 col-md-6 col-sm-6 m-3" style="margin: 10px;">
                                                        <select name="where" id="where" ng-model="rule.where"
                                                            class="form-control" ng-disabled="isViewMode"
                                            ...
                                            <div class="media" style="margin-left: 40px; margin-bottom: 20px;">
                                                <input ng-model="rule.logical_operator" type="button" value="+ OR"
                                                    ng-disabled="isViewMode" class="btn condn-btn">
                                    ...
                                    <button type="button" style="margin-left: 20px; background-color: #fafafa;"
                                        ng-if="!isViewMode" ng-click="strmUrlCtrl.addSubRuleSec(rule)">+ Add Sub
                                        Rule</button>
                                            ...
                                            <div class="card-header accordian-header" id="headingTwo">
                                                ...
                                                <div class="icon-div">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        ng-if="!isViewMode" class="glyphicon glyphicon-minus-sign"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="media" style="margin-left: 40px; margin-bottom: 20px;">
                                                        <input ng-model="subRule.sub_logical_operator" type="button"
                                                            ng-disabled="isViewMode" value="+ OR" class="btn condn-btn">
                                                        <input ng-model="subRule.sub_logical_operator" type="button"
                                                            ng-disabled="isViewMode" value="+ AND" class="btn condn-btn">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- button group -->
                            <div class="form-group text-center media" ng-if="!isViewMode">
                                <button type="submit" class="button button-blue" id="streamurlupdate">
                                    <strong>Update</strong>
                                </button>&nbsp;&nbsp;
                                <button type="button" class="button button-red"
                                    ng-click="deleteUrlPolicy({{ request()->id }})">
                            ...
                            <!-- button group -->
                            <div class="form-group text-center media" ng-if="isViewMode">
                                <button type="submit" class="button button-blue" id="streamurledit"
                                    ng-click="strmUrlCtrl.editStreamingUrlPolicy({{ request()->id }})">
                                    <strong>Edit</strong>
                                </button>&nbsp;&nbsp;
                                <button type="button" class="button button-red"
                                    ng-click="deleteUrlPolicy({{ request()->id }})">
