    ...
    <div data-ng-controller="StreamingUrlPolicyController as strmUrlCtrl">
        <div class="dashboard-page " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <ol class="breadcrumb">
                    <li><a
                            href="{{ route('stream-url-policy.index') }}">{{ __('stream-services::index.stream_url_policy') }}</a>
                    </li>
                    ...
                    <div class="mx-auto" style="width:70%; margin-left: 10rem;">
                        <form method="POST" enctype="multipart/form-data" data-base-validator
                            ...
                            <div class="form-group row name-div" style="margin-bottom: 15px;">
                                ...
                                {{-- <div class="media" style="margin-left: 230px; margin-bottom: 20px; border-radius: 30px;">
                            ...
                            <div class="accordion accordian-div" id="accordionExample"
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show border-2 row" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row card-body"
                                                ...
                                                <div class=" select-buttons col-sm-10">
                                                    <!-- choose Where -->
                                            ...
                                            <div class="media" style="margin-left: 40px; margin-bottom: 20px;">
                                                <input ng-model="rule.logical_operator" type="button" value="+ OR" disabled
                                                    class="btn condn-btn">
                                                <input ng-model="rule.logical_operator" type="button" value="+ AND" disabled
                                                    class="btn condn-btn">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion accordian-div"
                                        ng-repeat="subRule in rule.subRules track by $index"
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseTwo" class="collapse show border-2 row"
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group row card-body"
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select name="criteria" id="criteria"
                                                                ng-model="subRule.criteria" class="form-control" disabled
                                                                style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px;">
                                                    ...
                                                    <div class="media" style="margin-left: 40px; margin-bottom: 20px;">
                                                        <input ng-model="subRule.sub_logical_operator" type="button" disabled
                            ...
                            <div class="form-group text-center media">
                                <button type="submit" class="btn btn-success" id="streamurledit"
                                    ng-click="strmUrlCtrl.editStreamingUrlPolicy({{ request()->id }})">
                                    <strong>Edit</strong>
                                </button>&nbsp;&nbsp;
                                {{-- <button type="button" class="btn btn-danger"
                                    onclick="deleteSingleRecord({{ request()->id }})">
                                    <strong>Delete</strong>
                                </button>&nbsp;&nbsp; --}}
                                <button type="button" class="btn btn-default"
                                    ng-click="cancelStreamUrlPolicy()">
                                    <strong>Back</strong>
                                </button>
                            </div>
                        </form>
