...
<div data-ng-controller="UserController as usrCtrl" >
    <div class="page-heading flexbox align-items-center flex-wrap">
        <h4>{{trans('customer::customer.customer')}}</h4>
        <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('customer_all_write')" data-ng-click="usrCtrl.addUser($event)"  href="javascript:void(0)" class="button button-blue sidepanel-open upload_video">
                    ...
                    <span>{{trans('user::user.create_user')}}</span>
                </a>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/customer/customer/index.js')}}"></script>
