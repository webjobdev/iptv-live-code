...
<div data-ng-controller="subscriptionPlanController as subscriptionCtrl">
    <div class="page-heading flexbox align-items-center flex-wrap">
        <h4>{{__('customer::subscription.subscription')}}</h4>
        <div class="right-side flexbox align-items-center">
            <a data-ng-if="checkAccess('subscription_all_write')" data-ng-click="subscriptionCtrl.addSubscriptionsPlans($event)" href="javascript:void(0)" class="button button-blue sidepanel-open">
                ...
                <span>{{trans('customer::subscription.create_subscription')}}</span>
            </a>
...
<script src="{{asset('adminview/assets/js/subscription/index.js')}}"></script>
