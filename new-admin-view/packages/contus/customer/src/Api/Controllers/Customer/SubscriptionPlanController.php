...
class SubscriptionPlanController extends ApiController {
    ...
    public function getInfo() {
        return $this->getSuccessJsonResponse ( [ 'info' => [ 'rules' => $this->repository->getRules (),
            'allSubscriptions' => $this->repository->getAllsubscriptions (), 
    ...
    public function addLanguage($id) {
        try {
            $this->repository->updateSubscribeTranslation($id);
            return $this->getSuccessJsonResponse ( [ ],trans ( 'customer::subscription.update.success' ));
        } catch (Exception $e) {
            return $this->getErrorJsonResponse ( [ ],trans ( 'customer::subscription.update.error' )  );
        }
    }
}
