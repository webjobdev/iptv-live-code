...
class KidsBannerController extends BaseController { 
    /**
     * Construct method
     */
    public function __construct(KidsBannerRepository $BannerRepository) {
        parent::__construct ();
    ...
    public function getIndex() {
        return view ( 'cms::admin.kidsbanner.index');
    }
    ...
    public function getGrid() {
        return view ( 'cms::admin.kidsbanner.grid' );
    }
    /**
     * get Grid List
     *
    ...
    public function getGridlist() {
        return view ( 'cms::admin.kidsbanner.gridView' );
    }
