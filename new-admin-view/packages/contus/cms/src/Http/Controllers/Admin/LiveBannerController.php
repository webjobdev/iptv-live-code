...
class LiveBannerController extends BaseController { 
    /**
     * Construct method
     */
    public function __construct(LiveBannerRepository $BannerRepository) {
        parent::__construct ();
    ...
    public function getIndex() {
        return view ( 'cms::admin.livebanner.index');
    }
    ...
    public function getGrid() {
        return view ( 'cms::admin.livebanner.grid' );
    }
    /**
     * get Grid List
     *
    ...
    public function getGridlist() {
        return view ( 'cms::admin.livebanner.gridView' );
    }
