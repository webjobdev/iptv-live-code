'use strict';
var testimonialController = ['$scope','$rootScope','flowFactory','requestFactory','$window','$sce','$timeout',function(scope,rootScope,flowFactory,requestFactory,$window,$sce,$timeout){
  var self = this;
  this.testimonial = {};
...
scope.existingFlowObject.on('fileAdded', function (file){
  ...
  this.fetchInfo = function() {
      requestFactory.get(requestFactory.getUrl('testimonial/info'),this.defineProperties,function(response){
