'use strict';
var latestNewsController = ['$scope','$rootScope','flowFactory','requestFactory','$window','$sce','$timeout',function ( scope, rootScope, flowFactory, requestFactory, $window, $sce, $timeout ) {
    var self = this;
    this.latestnews = {};
    ...
    this.fetchInfo = function () {
        requestFactory.get( requestFactory.getUrl( 'latest/info' ), this.defineProperties, function (response) {
