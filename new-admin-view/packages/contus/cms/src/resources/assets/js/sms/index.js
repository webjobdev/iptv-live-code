...
var smsController = ['$scope','$rootScope','requestFactory','$window','$sce','$timeout',function ( scope, rootScope, requestFactory, $window, $sce, $timeout ) {
    var self = this;
    this.sms = {};
    ...
    this.fetchInfo = function () {
        requestFactory.get( requestFactory.getUrl( 'smsTemplate/info' ), this.defineProperties, function (response) {
