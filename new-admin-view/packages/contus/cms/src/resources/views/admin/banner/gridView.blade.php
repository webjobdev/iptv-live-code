            ...
            <thead>
                <tr>
                        <th class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">
                                ...
                                <div class="dropdown bulkaction" style="float: left; right: 20px;" data-ng-show="selectedRecords != 0 && checkAccess('banner_all_write')"
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords"
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('banner_all_write')" class="tooltips edit_table_icon tooltip-parent" data-boot-tooltip="true">
                            ...
                            <div class="tooltip-parent" data-ng-if="checkAccess('banner_all_write')">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        ...
                        <div class="input-append">
                            <button class="subtitle_btn">
                                ...
                                <input type="file" id="banner-image" name="image" data-action="api/admin/banner/banner-image"  />
                            </button>
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        ...
                        <div class="input-append">
                            <button class="subtitle_btn">
                                ...
                                <span class="fileupload-new">{{trans('video::videos.select_image')}}</span>
                                <span class="fileupload-exists">{{trans('video::videos.change')}}</span>
                                <input type="file" id="mobile-image" name="image" data-action="api/admin/banner/mobile-banner-image"  />
                            </button>
                            <span class="fileupload-preview"></span>
                        </div>
