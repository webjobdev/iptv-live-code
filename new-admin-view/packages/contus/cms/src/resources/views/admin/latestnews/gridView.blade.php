                    ...
                    <tbody>
                        ...
                        <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                            ...
                            <td class="table-action">
                                <div id="st-trigger-effects" class="tooltips edit_table_icon" data-boot-tooltip="true" title="{{trans('base::general.edit')}}">
                                    <a data-boot-tooltip="true" title="" class="table_action" href="{{url()}}/admin/latest/edit-latest-content/@{{record.id}}" data-original-title="{{trans('base::general.edit')}}">
        ...
        <form name="latestNewsForm" method="POST" data-base-validator data-ng-submit="latestNewsCtrl.save($event,latestNewsCtrl.latestnews.id)" enctype="multipart/form-data">
            ...
            <div class="video_form add_form">
                ...
                <div class="panel-footer clearfix">
                    <span class="btn btn-danger pull-right" data-ng-click="latestNewsCtrl.closeLatestNewsEdit()">{{trans('base::general.cancel')}}</span>
