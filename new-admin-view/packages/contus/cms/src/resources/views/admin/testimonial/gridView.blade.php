					...
					<tr data-ng-if="showRecords"
						...
						<td class="table-action">
							<div id="st-trigger-effects" class="tooltips edit_table_icon" data-boot-tooltip="true" title="{{trans('base::general.edit')}}">
								<button data-effect="st-effect-17" class="table_action" title="{{trans('base::general.edit')}}"
 ...
 <img src ="{{ url('contus/base/images/admin/loader.gif') }}" alt="ImageLoader" height="100" width="100">
       ...
       <input type="hidden" name="image" id="image" data-ng-model="testCtrl.testimonial.image" value="{{old('image')}}"/>
			...
			<div class="panel-footer clearfix">
				<span class="btn btn-danger pull-right" data-ng-click="testCtrl.closeStaticContentEdit()">{{trans('base::general.cancel')}}</span>
