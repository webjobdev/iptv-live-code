...
<div data-ng-controller="staticContentController as staticCtrl">
	<div class="page-heading flexbox align-items-center flex-wrap">
        <h4>{{ trans('cms::staticcontent.static_content') }}</h4>
        <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('static_page_all_write')" href="{{url('admin/static-content/add-static-content')}}" class="button button-blue sidepanel-open">
                    ...
                    <span>{{ trans('cms::staticcontent.add_contents') }}</span>
                </a>
	...
	<div class="contentpanel product order_list">
		...
		<div data-grid-view data-rows-per-page="10"
			data-route-name="static-content"
			data-template-route="admin/static-content" data-count="false"></div>
	</div>
</div>
...
<script src="{{asset('adminview/assets/js/static/index.js')}}"></script>
