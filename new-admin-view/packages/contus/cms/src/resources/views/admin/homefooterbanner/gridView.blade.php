            ...
            <thead>
                <tr>
                        <!-- <th class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">
                                ...
                                <div class="dropdown bulkaction" style="float: left; right: 20px;" data-ng-show="selectedRecords != 0 && checkAccess('homefooterbanner_all_write')"
            ...
            <tbody>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords"
                    ...
                    <td>
                        ...
                        <a  href="#" class="table-image-text flexbox align-items-center tooltip-parent">
                                <div class="image" bg-image="@{{record.mobile_url}}" on-error-src="{{url('contus/base/images/no-preview.png')}}">
                                </div>
                            </a>
                    </td>   
                    <!-- <td>@{{record.title}}</td> -->
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('homefooterbanner_all_write')" class="tooltips edit_table_icon tooltip-parent" data-boot-tooltip="true">
    ...
    <div class="pop_over_continer form-page">
        <form name="bannerForm" method="POST" data-base-validator data-ng-submit="bannerCtrl.save($event,bannerCtrl.banner.id)"
            ...
            <div class="sidepanel-header flexbox align-items-center">
                    <h5>Home and Kids footer banner</h5>
            </div>
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.banner_image.has}">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <p class="intimation">Allowed file extensions are jpeg, jpg, png and image resolution should be minimum 1300*300</p>
                        <div class="input-append">
                            <button class="subtitle_btn">
                                ...
                                <input type="file" id="banner-image" name="image" data-action="api/admin/home-footer-banner/banner-image" />
                            </button>
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        ...
                        <div class="input-append">
                            <button class="subtitle_btn">
                                ...
                                <span class="fileupload-new">{{trans('video::videos.select_image')}}</span>
                                <span class="fileupload-exists">{{trans('video::videos.change')}}</span>
                                <input type="file" id="mobile-image" name="image" data-action="api/admin/home-footer-banner/mobile-banner-image" />
                            </button>
                            <span class="fileupload-preview"></span>
                        </div>
