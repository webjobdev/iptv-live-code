            ...
            <thead>
                <tr>
                        <th class="bulkth" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">
                                ...
                                <div class="dropdown bulkaction" style="float: left; right: 20px;" data-ng-show="selectedRecords != 0 && checkAccess('landingbanner_all_write')"
            ...
            <tbody>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords"
                    ...
                    <td>
                        ...
                        <a  href="#" class="table-image-text flexbox align-items-center tooltip-parent">
                                <div class="image" bg-image="@{{record.banner_url}}" on-error-src="{{url('contus/base/images/no-preview.png')}}">
                                </div>
                            </a>
                            <span class="img-title-move">@{{record.title}}</span>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('landingbanner_all_write')" class="tooltips edit_table_icon tooltip-parent" data-boot-tooltip="true">
                            ...
                            <div class="tooltip-parent" data-ng-if="checkAccess('landingbanner_all_write')">
...
<div class="sidepanel">
        ...
        <form name="bannerForm" method="POST" data-base-validator data-ng-submit="bannerCtrl.save($event,bannerCtrl.banner.id)"
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                    ...
                    <div class="form-input">
                        <input type="text" ng-model="bannerCtrl.banner.title" placeholder="Enter banner title" class="form-control"  id="title" name="title">
                    </div>
            ...
            <!-- order start -->
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.banner_image.has}">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <p class="intimation">Allowed file extensions are jpeg, jpg, png and image resolution should be minimum 1500*730</p>
                        <div class="input-append">
                            <button class="subtitle_btn">
                                ...
                                <input type="file" id="banner-image" name="image" data-action="api/admin/landingbanner/banner-image"  />
                            </button>
                    ...
                    <div class="form-group">
                        <div class="clsFileUpload preview-image">
                            <img id="banner-image-preview-new" on-error="{{url('contus/base/images/no-preview.png')}}" data-ng-show="bannerCtrl.banner." data-ng-src="@{{bannerCtrl.banner.banner_url}}">
 ...
 <div class="form-group" data-ng-class="{'has-error': errors.mobile_image.has}">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <p class="intimation">Allowed file extensions are jpeg, jpg, png and image resolution should be minimum 540*960</p>
                        <div class="input-append">
                            <button class="subtitle_btn">
                                <svg viewBox="0 0 13 15" version="1.1" x="0px" y="0px" width="13px" height="15px">
                                    <g>
                                ...
                                <span class="fileupload-new">{{trans('video::videos.select_image')}}</span>
                                <span class="fileupload-exists">{{trans('video::videos.change')}}</span>
                                <input type="file" id="mobile-image" name="image" data-action="api/admin/landingbanner/mobile-banner-image" />
                            </button>
                            <span class="fileupload-preview"></span>
                        </div>
