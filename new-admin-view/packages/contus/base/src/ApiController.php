...
abstract class ApiController extends Controller {
    ...
    public function postUpdateStatus() {
        if (property_exists ( $this, StringLiterals::REPOSITORY ) && $this->repository instanceof GridableRepository) {
            return $this->repository->prepareGrid ()->gridUpdateStatus () ? $this->getSuccessJsonResponse ( [ ], trans ( 'base::general.updated' ) ) : $this->getErrorJsonResponse ( [ ], trans ( 'base::general.updated_error' ), 403 );
        }
