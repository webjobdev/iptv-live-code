...
@section('content')
    <div data-ng-controller="ShoppingController as shgCtrl">
        <div class="" id="dashboard-page">
            ...
            {{-- <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('subscription_all_write')" data-ng-click="PpCtrl.addData($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="shoppingcart"
                    data-template-route="admin/shoppingcart" data-count="false">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/organization/shopping/shopping.js') }}"></script>
    <script src="{{ asset('adminview/assets/js/common/common.js') }}"></script>
    <script src="{{ asset('adminview/assets/js/grid.js') }}"></script>
    <script src="{{ asset('adminview/assets/js/common/directive.js') }}"></script>
    <script
        src="https://cdnjs.cloudflare.com/ajax/libs/angular-drag-and-drop-lists/2.1.0/angular-drag-and-drop-lists.min.js">
    </script>
@endsection
