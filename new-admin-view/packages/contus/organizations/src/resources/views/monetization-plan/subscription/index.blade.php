...
@section('stylesheet')
    <style>
        ...
        .badge-container .badge {
            white-space: nowrap;
            /* keeps text on one line inside badge */
        }
        ...
        @media (max-width: 576px) {
            .badge-container {
                ...
                /* badges stack one on top of another */
        ...
        <div class="contentpanel" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <!-- permission -->
                    <a data-ng-if="checkAccess('monetization_plans.create')" data-ng-click="subscrCtrl.addData($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/monetization-plan/subscription"
