...
@section('content')
    <div data-ng-controller="SubscriptionController as subscrCtrl">
        ...
        <div ng-init="activeTab='general'">
            <ul id="tabsBar" class="nav nav-tabs" role="tablist">
                <li>
            ...
            <div class="form-page">
                <form name="monetization-planForm" id="monetization-planForm" method="POST" data-base-validator
                        ...
                        <div class="row">
                            <div class="justify-content-center mx-auto filter-wrapper">
                                ...
                                <div class="form-group row" style="margin-bottom: 15px;">
                                    ...
                                    <div class="col-sm-3"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px">
                                        {{-- <div class="form-input"> --}}
                                            <select allowClear="1" data-jquery="select2_custom_ddl" name="subs_time_type"
                                                class="admin_category_sub select2_custom_ddl"
                                                ng-disabled="subscriptionData.subs_unlimited_time"
                                ...
                                <div class="form-group row" style="margin-bottom: 15px;"
                                    ...
                                    <div class="col-sm-10 m-auto">
                                        <input type="text" class="form-control" name="price" id="subs_price"
                                ...
                                <div class="form-group row" style="margin-bottom: 15px;">
                                    ...
                                    <div class="col-sm-6" id="inpt-div"
                                        ng-repeat="inpts in deviceInputs.devices track by inpts.id">
                                        <input type="text" class="form-control mb-2 devc-inpts" name="device"
                                            placeholder="Device Price" ng-model="inpts.inputedVal"
                                            ng-change="calculateTotalDevicePrice()"
                                            style="border-radius: 20px; padding: 0px 9px; height: auto; display: visible; margin-top: 5px;">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="margin-bottom: 15px;">
                                    ...
                                    <div class="col-sm-6" style="margin: 10px 0px 10px 16px;">
                                        @{{ subscrCtrl.getCurrencySymbol(subscriptionData.currency) }} @{{
                    ...
                    <div class="bottom-button text-right">
                        <button type="submit" data-ng-click="subscrCtrl.saveSubscription($event)" id="channelEditFormSubmit"
                            class="button button-blue">
                            Save
                        </button>

                        <button id="channelEditFormSubmit"
                            data-ng-click="channelGridCtrl.saveChannelEdit($event, channel.id)" class="button button-red"
                            style="margin-left: 7px;" ng-if="isEditMode">
                            Remove
                        </button>
