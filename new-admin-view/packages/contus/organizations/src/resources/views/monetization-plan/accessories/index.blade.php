...
@section('content')
    <div data-ng-controller="AccessoriesController as acssCtrl">
        <div class="contentpanel" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('subscription_all_write')" data-ng-click="acssCtrl.addData($event)"
            ...
            <div class="contentpanel product order_list">
                @include('base::partials.errors')
                <div class="response-msg"></div>
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/organizations/monetization-plan/accessories"
                    data-route-name="organization/monetization-plan/accessories" data-count="false">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/monetization-plan/accessories/index.js')}}"></script>
