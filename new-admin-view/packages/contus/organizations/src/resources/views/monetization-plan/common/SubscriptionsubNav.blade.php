...
<ul class="nav nav-tabs" role="tablist">
    <li ng-class="{ 'active': subscrCtrl.btnNo == 0 }">
        <a href="" style="color: black;" ng-click="subscrCtrl.btnNo=0">
    ...
    <li ng-class="{ 'active': subscrCtrl.btnNo == 1 }">
        <a href="" style="color: black;" ng-click="subscrCtrl.btnNo=1">
    ...
    <li ng-class="{ 'active': subscrCtrl.btnNo == 2 }">
        <a href="" style="color: black;" ng-click="subscrCtrl.btnNo=2">
    ...
    <li ng-class="{ 'active': subscrCtrl.btnNo == 3 }">
        <a href="" style="color: black;" ng-click="subscrCtrl.btnNo=3">
