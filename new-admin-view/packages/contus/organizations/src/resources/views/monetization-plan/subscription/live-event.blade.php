...
<div class="content-section text-center">
    ...
    <div class="left-side flexbox align-items-center" style="margin: 10px 0px;">
        <button type="button" class="btn btn-info button button-blue" data-toggle="modal" data-target="#lveventModal"
            ng-click="subscrCtrl.liveEventContentDragDrop()">
    ...
    <div style="margin-top: 10px;">
        <div style="max-height: 200px; overflow-y: auto; padding: 5px;">
            <div class="bundle-item" ng-repeat="bundle in liveEventContentSet.lEvent" data-id="@{{ bundle.id }}"
                data-ng-model="liveEventContentSet.lEvent"
                style="border: 1px solid #ccc; padding: 10px; margin-bottom: 5px; border-radius: 4px;">
                <span class="bundle-title">@{{ bundle.name }}</span>
                <span class="bundle-delete" ng-click="subscrCtrl.removeBundle(bundle, 'levent')"
    ...
    <p class="assigned-text" ng-if="liveEventContentSet.lEvent.length === 0">
        Assigned Content Sets: <span>No Live Event Content Sets</span>
    </p>

    <div id="lveventModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="padding: 10px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Live Event Content Sets</h4>
                    <p style="margin: 0; font-size: 13px;"> <i class="glyphicon glyphicon-info-sign"></i> Please select
                        the Live Event Content sets you want to
                        move</p>
                </div>

                <div class="row">
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Available Live Event</h4>
                        <input type="text" id="searchLiveEventAvailable" class="form-control search-box"
                            placeholder="Search Live Event Content Set">
                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableLiveEventBundles">
                                <div class="panel panel-default content-container data-list" draggable="true"
                                    data-ng-repeat="event in subscrCtrl.liveEventList track by event.id"
                                    data-id="@{{ event.id }}" data-name="@{{ event.name }}"
                                    data-bundle="@{{ event | json }}" {{-- style="border: 2px solid gray; padding: 10px 5px; display: flex; justify-content: space-between;" --}}>
                                    <div class="channel-info content-header"><i
                                            class="glyphicon glyphicon-blackboard"></i>@{{ event.name }}</div>
                    ...
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Assigned Live Event</h4>
                        <input type="text" id="searchLiveEventAdded" class="form-control search-box"
                            placeholder="Search Live Event Content Set">

                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div class="data-list" ng-repeat="levnt in toShowAssignedBundles.assignLeventBundles">
                                <div class="tvs-info">
                                ...
                                <div>
                                    <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                    <span class="bundle-delete" ng-click="removeLeventBundles(levnt)"
                                        style="float: right; color: #585353; cursor: pointer;">
                                        <i class="glyphicon glyphicon-remove-circle"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="" id="addedLiveEventBundles" style="min-height: 145px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="assign-btns">
                    <button type="button" class="button button-blue" data-dismiss="modal"
                        ng-click="assignedLeventBundles()">Assign</button>
...
<div class="content-section">
    ...
    <div class="left-side flexbox align-items-center" style="margin: 10px 0px;">
        <button type="button" class="btn btn-info button button-blue" data-toggle="modal"
            data-target="#lveventcontent-addon-modal" ng-click="subscrCtrl.liveEventContentAddOnsDragDrop()">
            <div style="display: flex; justify-content: center; align-items: center;">
                <svg viewBox="0 0 18 18" width="18px" height="18px">
                    <g>
                        <path
                ...
                <span>Add Live Event Add-Ons</span>
            </div>
        </button>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    <th><i class="glyphicon glyphicon-filter"></i> Live Event Add-on Name
                    </th>
                    <th>Live Event Quantity</th>
            ...
            <tbody>
                ...
                <tr data-ng-repeat="events in liveEventContentAddOnsSet.lEventAddOns track by $index">
                    <td>@{{ events.name }}</td>
                    <td>@{{ count(events.assigned_channels) }}</td>
                    <td>@{{ events.monetization_type == '0' ? "Rent" : "Buy" }}</td>
                    <td>@{{ events.payment_method == '0' ? "Per Bundle" : "Per Item" }}</td>
                    <td>@{{ events.payment_method == '0' ? "Per Bundle" : "Per Item" }}</td>
                    <td>@{{ events.price }}</td>
                    <td>@{{ events.getuser.name }}</td>
                    <td>@{{ events.updated_at| date:'dd-MM-yyyy' }}</td>
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <!-- edit button -->
                            <div class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="subscrCtrl.fetchLiveEvents(events.id)" data-toggle="modal"
                                    data-target="#levnt-editon-modal">
                ...
                <tr>
                    <td colspan="10" class="text-center text-muted"
                        ng-if="liveEventContentAddOnsSet.lEventAddOns.length === 0">
                        No Live Event Sets were found
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div id="lveventcontent-addon-modal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="padding: 10px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Live Event Content Add-Ons</h4>
                    <p style="margin: 0; font-size: 13px;"> <i class="glyphicon glyphicon-info-sign"></i> Please
                        select the Live Event Content sets you want to
                        move</p>
                </div>

                <div class="row">
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Available Live Event Add-Ons</h4>
                        <input type="text" id="searchLiveEventAddOnsAvailable" class="form-control search-box"
                            placeholder="Search Live Event Content Set">
                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableLiveEventAddOnsBundles">
                                <div class="panel panel-default content-container data-list" draggable="true"
                                    data-ng-repeat="event in subscrCtrl.liveEventList track by event.id"
                                    data-id="@{{ event.id }}" data-name="@{{ event.name }}"
                                    data-bundle="@{{ event | json }}" {{-- style="border: 2px solid gray; padding: 10px 5px; display: flex; justify-content: space-between;" --}}>
                    ...
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Assigned Live Event Add-Ons</h4>
                        <input type="text" id="searchLiveEventAddOnsAdded" class="form-control search-box"
                            placeholder="Search Live Event Content Set">

                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div class="data-list" ng-repeat="levnt in toShowAssignedBundles.assignLeventAddOnsBundles">
                                <div class="tvs-info">
                                    <i class="glyphicon glyphicon-blackboard"></i>
                                    @{{ levnt.name }}
                                </div>
                                <div>
                                    <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                    <span class="bundle-delete" ng-click="removeLeventAddOnsBundles(levnt)"
                                        style="float: right; color: #585353; cursor: pointer;">
                                        <i class="glyphicon glyphicon-remove-circle"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="" id="addedLiveEventAddOnsBundles" style="min-height: 145px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="assign-btns">
                    <button type="button" class="button button-blue" data-dismiss="modal"
                        ng-click="assignedLeventAddOnsBundles()">Assign</button>
                    <button class="btn btn-default" data-dismiss="modal">Cancel</button>
                </div>
            </div>
    ...
    <div id="levnt-editon-modal" class="modal fade" role="dialog" style="overflow: auto;">
        <div class="modal-dialog">
            <form name="channl-edit-modal" id="channl-edit-modal" method="POST" data-base-validator
                ...
                <div class="modal-content" style="padding: 10px;">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit Live Event Content Add-Ons</h4>
                    ...
                    <div class="row">
                        <div style="padding: 10px 30px;">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-8 m-auto">
                                    <input type="text" class="form-control" name="name" id="name"
                                        ...
                                        ng-model="liveEventContentAddOnsSet.lEventModalData.name"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-8 m-auto">
                                    <input type="text" class="form-control" name="description" id="description"
                                        ...
                                        ng-model="liveEventContentAddOnsSet.lEventModalData.description"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;margin: 0px 10px;">
                                </div>
                            </div>
                            ...
                            <div class="upload-cover-thumbnail flexbox"
                                ...
                                <div class="cover-image">
                                    ...
                                    <div class="image-content">
                                        <!-- image fetch code -->
                                        <img ng-show="liveEventContentAddOnsSet.lEventModalData.cover_image.length > 0"
                                            ng-class="{'active':liveEventContentAddOnsSet.lEventModalData.cover_image}"
                                            class="uploaded_poster_img uploaded_poster_img_@{{ liveEventContentAddOnsSet.lEventModalData.id }}"
                                            alt="" ng-src="@{{ liveEventContentAddOnsSet.lEventModalData.cover_image }}" />
                                            ...
                                            <div class="fileuploadbox">
                                                <div class="input-append">
                                                    <div class="overlay-content"
                                                        data-ng-class="{'change-image': liveEventContentAddOnsSet.lEventModalData.cover_image.length > 0}">
                                                        <div class="input">
                                                            <div ng-hide="liveEventContentAddOnsSet.lEventModalData.cover_image.length"
                                                                class="flexbox align-items-center">
                                                                <svg viewBox="0 0 27 27" version="1.1" x="0px"
                                                            ...
                                                            <input type="file" class="uploadPosterImg"
                                                                name="image"
                                                                data-video-index="@{{ liveEventContentAddOnsSet.lEventModalData.id }}">
                                                        </div>
                            ...
                            <!-- Live Event Monetization Type -->
                            <div class="form-group row" style="margin-bottom: 15px;">
                                <label class="col-sm-2 control-label" for="monitization_type"
                                    style="font-size: 14px; color: #000; margin-top: 10px;">
                                    Monetization Type<span class="required">*</span>:
                                </label>
                                <div class="col-sm-8 m-auto">
                                    <div class="col-sm-2" style="display: flex; align-items: center;">
                                        <input type="checkbox" class="form-control" name="monitization_type"
                                            id="monitization_type"
                                            ng-model="liveEventContentAddOnsSet.lEventModalData.monitization_type"
                                            ng-checked="liveEventContentAddOnsSet.lEventModalData.monitization_type == 1"
                                            value="buy"
                                            style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;margin: 0px 10px;">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="payment_method" value="per_item"
                                            ng-model="liveEventContentAddOnsSet.lEventModalData.payment_method"
                                            ng-checked="liveEventContentAddOnsSet.lEventModalData.payment_method == 1">
                                        Per Item
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-8 m-auto input-group" style="max-width: 250px;">
                                    <input type="text" class="form-control" name="price" id="price"
                                        ...
                                        ng-model="liveEventContentAddOnsSet.lEventModalData.price" required
                                    ...
                                    <span class="input-group-addon"
                                        ...
                                        @{{ liveEventContentAddOnsSet.lEventModalData.currency }}
                                    </span>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12" style="max-height: 350px; overflow-y: auto; padding: 5px;">
                                    <div id="availableChannelAddOnssBundles">
                                        ...
                                        <div class="content-container panel panel-default data-list" draggable="true"
                                            data-ng-repeat="event in liveEventContentAddOnsSet.lEventModalData.live_event_channels track by event.id"
                                            data-id="@{{ event.id }}" data-name="@{{ event.name }}"
                                            data-bundle="@{{ event | json }}" {{-- style="border: 2px solid gray; padding: 10px 5px; display: flex; justify-content: space-between;" --}}>
                                            <div class="content-header"><i
                                                    class="glyphicon glyphicon-blackboard"></i>@{{ event.channel_name }}
                                            </div>
                                            <div class="col-sm-5 m-auto input-group" style="max-width: 250px;">
                                                <input type="text" class="form-control" name="price"
                                                    ...
                                                    ng-model="liveEventContentAddOnsSet.lEventModalData.subs_price"
                    ...
                    <div class="assign-btns">
                        <button type="button" class="button button-blue"
                            ng-click="subscrCtrl.updateLiveEventModalData(liveEventContentAddOnsSet.lEventModalData)">Save</button>
                        <button class="btn btn-default" data-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </form>
