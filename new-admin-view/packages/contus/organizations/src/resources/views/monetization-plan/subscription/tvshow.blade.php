...
<div class="content-section text-center">
    ...
    <div class="left-side flexbox align-items-center" style="margin: 10px 0px;">
        <button type="button" class="btn btn-info button button-blue" data-toggle="modal" data-target="#tvModal"
            ng-click="subscrCtrl.tvShowContentDragDrop()">
            <div style="display: flex; justify-content: center; align-items: center;">
                ...
                <span>Add TV Show Sets</span>
            </div>
        </button>
    </div>
    <div style="margin-top: 10px;">
        <div style="max-height: 200px; overflow-y: auto; padding: 5px;">
            <div class="bundle-item" ng-repeat="bundle in tvShowContentSet.tvShows" data-id="@{{ bundle.id }}"
                data-ng-model="tvShowContentSet.tvShows"
                style="border: 1px solid #ccc; padding: 10px; margin-bottom: 5px; border-radius: 4px;">
                <span class="bundle-title">@{{ bundle.name }}</span>
                <span class="bundle-delete" ng-click="subscrCtrl.removeBundle(bundle, 'tvshow')"
    ...
    <p class="assigned-text" ng-if="tvShowContentSet.tvShows.length === 0">
        Assigned Content Sets: <span>No TV Show Sets</span>
    </p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="padding: 10px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add TV Show Content Sets</h4>
                    <p style="margin: 0; font-size: 13px;"> <i class="glyphicon glyphicon-info-sign"></i> Please select
                        the TV Show Content sets you want to
                        move</p>
                </div>

                <div class="row">
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Available TV Show</h4>
                        <input type="text" id="searchTvShowAvailable" class="form-control search-box"
                            placeholder="Search TV Show Content Set">
                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableTvShowBundles">
                                <div class="panel panel-default content-container data-list" draggable="true"
                                    data-ng-repeat="tvShow in subscrCtrl.tvShowList track by tvShow.id"
                                    data-id="@{{ tvShow.id }}" data-name="@{{ tvShow.name }}"
                                    data-bundle="@{{ tvShow | json }}" {{--
                                    ...
                                    <div class="channel-info content-header"><i
                                            class="glyphicon glyphicon-blackboard"></i>@{{ tvShow.name }}</div>
                    ...
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Assigned TV Show</h4>
                        <input type="text" id="searchTvShowAdded" class="form-control search-box"
                            placeholder="Search Channel Content Set">

                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div class="data-list" ng-repeat="tvshow in toShowAssignedBundles.assignTvShowBundles">
                                <div class="tvs-info">
                                ...
                                <div>
                                    <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                    <span class="bundle-delete" ng-click="removeTvshowBundles(tvshow)"
                                        style="float: right; color: #585353; cursor: pointer;">
                                        <i class="glyphicon glyphicon-remove-circle"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="" id="addedTvShowBundles" style="min-height: 145px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="assign-btns">
                    <button type="button" class="button button-blue" data-dismiss="modal"
                        ng-click="assignedTvshowBundles()">Assign</button>
...
<div class="content-section">
    ...
    <div class="left-side flexbox align-items-center" style="margin: 10px 0px;">
        <button type="button" class="btn btn-info button button-blue" data-toggle="modal"
            data-target="#tvcontent-addon-modal" ng-click="subscrCtrl.tvShowContentAddOnsDragDrop()">
            <div style="display: flex; justify-content: center; align-items: center;">
                <svg viewBox="0 0 18 18" width="18px" height="18px">
                    <g>
                        <path
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    <th><i class="glyphicon glyphicon-filter"></i> TV Show Add-on Name
                    </th>
                    <th>TV Show Quantity</th>
            ...
            <tbody>
                <tr data-ng-repeat="tvshow in tvShowAddOnsContentSet.tvShowAddOns track by $index">
                    <td>@{{ tvshow.name }}</td>
                    <td>@{{ tvshow.name }}</td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="tvshow.monitization_type_buy == 1">Buy</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="tvshow.monitization_type_rent == 1">Rent</div>
                        </div>
                    </td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="tvshow.payment_method_buy == 0">Per Bundle</div>
                            <div ng-if="tvshow.payment_method_buy == 1">Per Item</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="tvshow.payment_method_rent == 0">Per Bundle</div>
                            <div ng-if="tvshow.payment_method_rent == 1">Per Item</div>
                        </div>
                    </td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="tvshow.monitization_type_buy == 1">Unlimited</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="tvshow.monitization_type_rent == 1">@{{ tvshow.period + ' ' + tvshow.period_type
                                }}</div>
                            <div ng-if="tvshow.payment_method_rent == 1">Per Item</div>
                        </div>
                    </td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="tvshow.buy_price">@{{ tvshow.buy_price }} @{{ tvshow.currency }}</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="tvshow.rent_price">@{{ tvshow.rent_price }} @{{ tvshow.currency }}</div>
                        </div>
                    </td>
                    <td>@{{ tvshow.getuser.name }}</td>
                    <td>@{{ tvshow.updated_at | date:'dd-MM-yyyy' }}</td>
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <!-- edit button -->
                            <div class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="subscrCtrl.fetchTvShow(tvshow.id)" data-toggle="modal"
                                    data-target="#tvshow-editon-modal">
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('api_access')">
                ...
                <tr>
                    <td colspan="10" class="text-center text-muted"
                        ng-if="tvShowAddOnsContentSet.tvShowAddOns.length === 0 ">No TV Show Sets
                        were
                        found</td>
                </tr>
            </tbody>
    ...
    <div id="tvcontent-addon-modal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="padding: 10px;">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                    ...
                    <p style="margin: 0; font-size: 13px;"> <i class="glyphicon glyphicon-info-sign"></i> Please
                        select the TV Show Content sets you want to
                        move</p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Available TV Show</h4>
                        <input type="text" id="searchTvShowAddOnsAvailable" class="form-control search-box"
                            placeholder="Search TV Content Set">
                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableTvShowAddOnsBundles">
                                <div class="panel panel-default content-container data-list" draggable="true"
                                    data-ng-repeat="tvShow in subscrCtrl.tvShowList track by tvShow.id"
                                    data-id="@{{ tvShow.id }}" data-name="@{{ tvShow.name }}"
                                    data-bundle="@{{ tvShow | json }}" {{--
                    ...
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Assigned TV Show</h4>
                        <input type="text" id="searchTvShowAddOnsAdded" class="form-control search-box"
                            placeholder="Search Channel Content Set">

                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div class="data-list"
                                ng-repeat="tvshow in toShowAssignedBundles.assignTvShowAddOnsBundles">
                                <div class="tvs-info">
                                    <i class="glyphicon glyphicon-blackboard"></i>
                                    @{{ tvshow.name }}
                                </div>
                                <div>
                                    <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                    <span class="bundle-delete" ng-click="removeTvshowAddOnsBundles(tvshow)"
                                        style="float: right; color: #585353; cursor: pointer;">
                                        <i class="glyphicon glyphicon-remove-circle"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="" id="addedTvShowAddOnsBundles" style="min-height: 145px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="assign-btns">
                    <button type="button" class="button button-blue" data-dismiss="modal"
                        ng-click="assignedTvshowAddOnsBundles()">Assign</button>
                    <button class="btn btn-default" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    ...
    {{-- edit TV SHow content set add on --}}
    <div id="tvshow-editon-modal" class="modal fade" role="dialog" style="overflow: auto;">
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="padding: 10px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit TV Show Content Add-Ons</h4>
                ...
                <div class="row">
                        ...
                        <div class="form-group row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-sm-8 m-auto">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name"
                                    ng-model="tvShowAddOnsContentSet.tvShowModalData.name"
                            ...
                            <div class="col-sm-6">
                                <label class="radio-inline me-3" style="vertical-align: unset;">
                                    <input type="radio" name="item_type"
                                        ng-model="tvShowAddOnsContentSet.tvShowModalData.item_type" value="tv_show">
                                    Tv
                                    Show
                                </label>
                                ...
                                <label class="radio-inline me-3" style="vertical-align: unset;">
                                    <input type="radio" name="item_type"
                                        ng-model="tvShowAddOnsContentSet.tvShowModalData.item_type" value="season">
                                    Season
                                </label>

                                <label class="radio-inline me-3" style="vertical-align: unset;">
                                    <input type="radio" name="item_type"
                                        ng-model="tvShowAddOnsContentSet.tvShowModalData.item_type" value="episode">
                                    Episode
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-sm-8 m-auto">
                                <input type="text" class="form-control" name="description" id="description"
                                    ...
                                    ng-model="tvShowAddOnsContentSet.tvShowModalData.description"
                                    style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;margin: 0px 10px;">
                            </div>
                        </div>
                        ...
                        <div class="upload-cover-thumbnail flexbox"
                            ...
                            <div class="cover-image">
                                ...
                                <div class="image-content">
                                    <!-- image fetch code -->
                                    <img ng-show="tvShowAddOnsContentSet.tvShowModalData.cover_image.length > 0"
                                        ng-class="{'active':tvShowAddOnsContentSet.tvShowModalData.cover_image}"
                                        class="uploaded_poster_img uploaded_poster_img_@{{ tvShowAddOnsContentSet.tvShowModalData.id }}"
                                        alt="" ng-src="@{{ tvShowAddOnsContentSet.tvShowModalData.cover_image }}" />
                                        ...
                                        <div class="fileuploadbox">
                                            <div class="input-append">
                                                <div class="overlay-content"
                                                    data-ng-class="{'change-image': tvShowAddOnsContentSet.tvShowModalData.cover_image.length > 0}">
                                                    <div class="input">
                                                        <div ng-hide="tvShowAddOnsContentSet.tvShowModalData.cover_image.length"
                                                        ...
                                                        <input type="file" class="uploadPosterImg" name="image"
                                                            data-video-index="@{{ tvShowAddOnsContentSet.tvShowModalData.id }}">
                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border rounded p-3 h-100">
                                            <label class="checkbox-inline d-block mb-3">
                                                <input type="checkbox"
                                                    ng-model="tvShowAddOnsContentSet.tvShowModalData.monitization_type_buy"
                                                    value="1">
                                                Buy
                                            </label>

                                            <div ng-if="tvShowAddOnsContentSet.tvShowModalData.monitization_type_buy">
                                                <!-- payment method -->
                                                <div class="form-group row mb-3" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="radio-inline me-3" style="vertical-align: unset;">
                                                            <input type="radio" class="form-check-input" id="bundleBuy"
                                                                name="payment_method_buy" value="0"
                                                                ng-model="tvShowAddOnsContentSet.tvShowModalData.payment_method_buy">
                                                            Per Bundle
                                                        </label>

                                                        <label class="radio-inline me-3" style="vertical-align: unset;">
                                                            <input type="radio" class="form-check-input" id="itemBuy"
                                                                name="payment_method_buy" value="1"
                                                                ng-model="tvShowAddOnsContentSet.tvShowModalData.payment_method_buy">
                                                            Per Item
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="form-group row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-sm-10 m-auto price-input-wrapper">
                                                        <input type="number" class="form-control price-input"
                                                            ...
                                                            ng-model="tvShowAddOnsContentSet.tvShowModalData.buy_price"
                                                            style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                                                        <span class="currency-label">@{{
                                                            tvShowAddOnsContentSet.tvShowModalData.currency }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border rounded p-3 h-100">
                                            <label class="checkbox-inline d-block mb-3">
                                                <input type="checkbox"
                                                    ng-model="tvShowAddOnsContentSet.tvShowModalData.monitization_type_rent"
                                                    value="0">
                                                Rent
                                            </label>

                                            <div ng-if="tvShowAddOnsContentSet.tvShowModalData.monitization_type_rent">
                                                <!-- payment method -->
                                                <div class="form-group row mb-3" style="margin-bottom: 15px;">
                                                    <label class="col-sm-3 col-form-label fw-bold"
                                                        style="font-size:14px; color:#000;">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="radio-inline me-3" style="vertical-align: unset;">
                                                            <input type="radio" class="form-check-input"
                                                                ...
                                                                ng-model="tvShowAddOnsContentSet.tvShowModalData.payment_method_rent">
                                                            Per Bundle
                                                        </label>
                                                ...
                                                <div class="form-group row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-sm-10 m-auto price-input-wrapper">
                                                        <input type="number" class="form-control price-input"
                                                            name="price" placeholder="Enter vod price"
                                                            ng-model="tvShowAddOnsContentSet.tvShowModalData.rent_price"
                                                            style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                                                        <span class="currency-label">@{{
                                                            tvShowAddOnsContentSet.tvShowModalData.currency }}</span>
                                                    </div>
                                                ...
                                                <div class="form-group row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <!-- Period -->
                                                        <div class="col-md-4">
                                                            <div class="price-input-wrapper d-flex align-items-center">
                                                                <input type="number" class="form-control price-input"
                                                                    name="period" placeholder="Enter Period"
                                                                    ng-model="tvShowAddOnsContentSet.tvShowModalData.period"
                                                                    style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control select2_custom_ddl"
                                                                ...
                                                                ng-model="tvShowAddOnsContentSet.tvShowModalData.period_type">
                    ...
                    <!-- Assigned TV Shows -->
                    <div class="" data-ng-show="tvShowAddOnsContentSet.tvShowModalData.item_type == 'tv_show'"
                        style="padding: 10px 30px;">
                        <h4>Assigned TV Shows</h4>
                        <div class="col-sm-12" style="display: flex; justify-content: space-between;">
                            <div class="col-sm-3">
                                <input type="text" id="searchAddOnsAvailable"
                                    oninput="angular.element(this).scope().subscrCtrl.searchAssignedData()"
                                    class="form-control search-box col-sm-5" placeholder="Search Channels">
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="col-sm-12" style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableChannelAddOnssBundles">
                                ...
                                <div class="content-container panel panel-default data-list" draggable="true"
                                    data-ng-repeat="tvshow in tvShowAddOnsContentSet.tvShowModalData.tvshows track by tvshow.id"
                                    data-id="@{{ tvshow.id }}" data-name="@{{ tvshow.title }}"
                                    data-bundle="@{{ tvshow | json }}" {{--
                                    style="border: 2px solid gray; padding: 10px 5px; display: flex; justify-content: space-between;"
                                    --}}>

                                    <div class="channel-info content-header">
                                        <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                        <i class="glyphicon glyphicon-blackboard"></i>
                                        @{{ tvshow.title }}
                                    </div>
                                    ...
                                    <div class="col-sm-5 m-auto input-group" style="max-width: 250px;">
                                        <input type="text" class="form-control" name="price" id="price" {{--
                                            ...
                                            ng-model="tvShowAddOnsContentSet.tvShowModalData.subs_price" required
                                        ...
                                        <span class="input-group-addon"
                                            ...
                                            @{{ tvShowAddOnsContentSet.tvShowModalData.currency }}
                                        </span>
                                    </div>
                    ...
                    <!-- Assigned TV Show Season -->
                    <div class="" data-ng-show="tvShowAddOnsContentSet.tvShowModalData.item_type == 'season'"
                        style="padding: 10px 30px;">
                        <h4>Assigned Tv Show Seasons</h4>
                        <div class="col-sm-12" style="display: flex; justify-content: space-between;">
                            <div class="col-sm-3">
                                <input type="text" id="searchAddOnsAvailable"
                                    oninput="angular.element(this).scope().subscrCtrl.searchAssignedData()"
                        ...
                        <div class="col-sm-12" style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableChannelAddOnssBundles">
                                <div class="content-container panel panel-default" draggable="true"
                                    ...
                                    <div style="border: 1px solid #ddd; border-radius: 10px; padding: 8px 14px;">
                                        <div class="channel-info content-header">
                                            <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                            {{-- <i class="glyphicon glyphicon-blackboard"></i> --}}
                                            @{{ tvshow.title }}
                                        </div>
                                        <div class="item-box data-list"
                                            data-ng-repeat="tvshowSeason in tvShowAddOnsContentSet.tvShowModalData.tvshow_seasons track by tvshowSeason.id"
                                            draggable="true">
                                            <div>
                                                <span class="tvs-drag">
                                                ...
                                                <i class="glyphicon glyphicon-blackboard"></i>
                                                @{{ tvshowSeason.title }} @{{ tvshowSeason.season_number }}
                                            </div>

                                            <div class="col-sm-5 m-auto input-group" style="max-width: 250px;">
                                                <input type="text" class="form-control" name="price" id="price" {{--
                                                    ng-model="extraPproductContentSet.prtnrProductModalData.price" --}}
                                                    ng-model="tvShowAddOnsContentSet.tvShowModalData.subs_price"
                    ...
                    <!-- Assigned TV Show Episodes -->
                    <div class="" data-ng-show="tvShowAddOnsContentSet.tvShowModalData.item_type == 'episode'"
                        style="padding: 10px 30px;">
                        <h4>Assigned Tv Show Episodes</h4>
                        <div class="col-sm-12" style="display: flex; justify-content: space-between;">
                            <div class="col-sm-3">
                                <input type="text" id="searchAddOnsAvailable"
                                    oninput="angular.element(this).scope().subscrCtrl.searchAssignedData()"
                            ...
                            <div id="availableChannelAddOnssBundles">
                                <div class="content-container panel panel-default" draggable="true"
                                    ...
                                    <div style="border: 1px solid #ddd; border-radius: 10px; padding: 8px 14px;">
                                        ...
                                        <div class="item-box"
                                            ng-repeat="season in tvShowAddOnsContentSet.tvShowModalData.tvshow_seasons track by season.id"
                                            draggable="true" style="border-radius: 10px;">
                                            <div>
                                                <span class="tvs-drag">
                                                    <i class="glyphicon glyphicon-move"></i>
                                                </span>
                                            ...
                                            <div class="item-box data-list"
                                                ng-repeat="episode in tvShowAddOnsContentSet.tvShowModalData.tvshow_season_episodes"
                                                draggable="true">
                                                <div>
                                                    <span class="tvs-drag">
                                                        <i class="glyphicon glyphicon-move"></i>
                                                    ...
                                                    <i class="glyphicon glyphicon-blackboard"></i>
                                                    Ep : @{{ episode.episode_number }} - @{{ episode.episode_name }}
                                                </div>
            ...
            <div class="assign-btns">
                <button type="button" class="button button-blue"
                    ng-click="subscrCtrl.updateTvShowModalData(tvShowAddOnsContentSet.tvShowModalData )">Save</button>
                <button class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
