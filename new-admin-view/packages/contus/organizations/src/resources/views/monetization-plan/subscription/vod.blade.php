...
<div class="content-section text-center">
    ...
    <div class="left-side flexbox align-items-center" style="margin: 10px 0px;">
        <button type="button" class="btn btn-info button button-blue" data-toggle="modal" data-target="#vodModal"
            ng-click="subscrCtrl.vodContentDragDrop()">
    ...
    <div style="margin-top: 10px;">
        <div style="max-height: 200px; overflow-y: auto; padding: 5px;">
            <div class="bundle-item" ng-repeat="bundle in vodContentSet.vodSet" data-id="@{{ bundle.id }}"
                data-ng-model="vodContentSet.vodSet"
                style="border: 1px solid #ccc; padding: 10px; margin-bottom: 5px; border-radius: 4px;">
                <span class="bundle-title">@{{ bundle.name }}</span>
                <span class="bundle-delete" ng-click="subscrCtrl.removeBundle(bundle, 'vod')"
    ...
    <p class="assigned-text" ng-if="vodContentSet.vodSet.length === 0">
        Assigned Content Sets: <span>No VOD Content Sets</span>
    </p>

    <div class="modal fade" id="vodModal" tabindex="-1" role="dialog">
            ...
            <div class="modal-content" style="padding: 10px;">
                ...
                <div class="row">
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Available VOD</h4>
                        <input type="text" id="searchVodAvailable" class="form-control search-box"
                            placeholder="Search VOD Content Set">
                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableVodBundles">
                                <div class="panel panel-default content-container data-list" draggable="true"
                                    data-ng-repeat="vod in subscrCtrl.vodList track by vod.id"
                                    data-id="@{{ vod.id }}" data-name="@{{ vod.name }}"
                                    data-bundle="@{{ vod | json }}" {{-- style="border: 2px solid gray; padding: 10px 5px; display: flex; justify-content: space-between;" --}}>
                                    <div class="channel-info content-header"><i
                                            class="glyphicon glyphicon-blackboard"></i>@{{ vod.name }}</div>
                    ...
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Assigned VOD</h4>
                        <input type="text" id="searchVodAdded" class="form-control search-box"
                            placeholder="Search Channel Content Set">

                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div class="data-list" ng-repeat="vod in toShowAssignedBundles.assignVodBundles">
                                <div class="tvs-info">
                                ...
                                <div>
                                    <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                    <span class="bundle-delete" ng-click="removeVodBundles(vod)"
                                        style="float: right; color: #585353; cursor: pointer;">
                                        <i class="glyphicon glyphicon-remove-circle"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="" id="addedVodBundles" style="min-height: 145px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="assign-btns">
                    <button type="button" class="button button-blue" data-dismiss="modal"
                        ng-click="assignedVodBundles()">Assign</button>
...
<div class="content-section">
    ...
    <div class="left-side flexbox align-items-center" style="margin: 10px 0px;">
        <button type="button" class="btn btn-info button button-blue" data-toggle="modal"
            data-target="#vodcontent-addon-modal" ng-click="subscrCtrl.vodContentAddOnsDragDrop()">
            <div style="display: flex; justify-content: center; align-items: center;">
                <svg viewBox="0 0 18 18" width="18px" height="18px">
                    <g>
                        <path
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    <th><i class="glyphicon glyphicon-filter"></i> VOD Add-on Name
                    </th>
                    <th>VOD Quantity</th>
            ...
            <tbody>
                <tr data-ng-repeat="vod in vodContentSetAddOns.vodContentAddOns track by $index">
                    <td>@{{ vod.name }}</td>
                    <td>@{{ vod.name }}</td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="vod.monitization_type_buy == 1">Buy</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="vod.monitization_type_rent == 1">Rent</div>
                        </div>
                    </td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="vod.payment_method_buy == 0">Per Bundle</div>
                            <div ng-if="vod.payment_method_buy == 1">Per Item</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="vod.payment_method_rent == 0">Per Bundle</div>
                            <div ng-if="vod.payment_method_rent == 1">Per Item</div>
                        </div>
                    </td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="vod.monitization_type_buy == 1">Unlimited</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="vod.monitization_type_rent == 1">@{{ vod.period + ' ' + vod.period_type }}</div>
                            <div ng-if="vod.payment_method_rent == 1">Per Item</div>
                        </div>
                    </td>
                    <td>
                        <div class="multi-value">
                            <div ng-if="vod.buy_price">@{{ vod.buy_price }} @{{ vod.currency }}</div>
                            <hr style="margin: 5px 5px;">
                            <div ng-if="vod.rent_price">@{{ vod.rent_price }} @{{ vod.currency }}</div>
                        </div>
                    </td>
                    <td>@{{ vod.autopay ? vod.autopay : 'No' }}</td>
                    <td>@{{ vod.getuser.name }}</td>
                    <td>@{{ vod.updated_at | date:'dd-MM-yyyy' }}</td>
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <!-- edit button -->
                            <div class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="subscrCtrl.fetchVods(vod.id)" data-toggle="modal"
                                    data-target="#vod-editon-modal">
                ...
                <tr>
                    <td colspan="10" class="text-center text-muted" ng-if="vodContentSet.vodSet.length === 0">No
                        VOD Sets
                        were
                        found</td>
                </tr>
    ...
    <div id="vodcontent-addon-modal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="padding: 10px;">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                    ...
                    <p style="margin: 0; font-size: 13px;"> <i class="glyphicon glyphicon-info-sign"></i> Please
                        select the VOD Content sets you want to
                        move</p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Available VOD</h4>
                        <input type="text" id="searchVodAddOnsAvailable" class="form-control search-box"
                            placeholder="Search VOD Content Set">
                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div id="availableVodAddOnsBundles">
                                <div class="panel panel-default content-container data-list" draggable="true"
                                    data-ng-repeat="vod in subscrCtrl.vodList track by vod.id"
                                    data-id="@{{ vod.id }}" data-name="@{{ vod.name }}"
                                    data-bundle="@{{ vod | json }}" {{-- style="border: 2px solid gray; padding: 10px 5px; display: flex; justify-content: space-between;" --}}>
                                    <div class="channel-info content-header">
                                        <i class="glyphicon glyphicon-blackboard"></i>@{{ vod.name }}
                                    </div>
                                    <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6" style="padding: 10px 30px;">
                        <h4>Assigned VOD</h4>
                        <input type="text" id="searchVodAddOnsAdded" class="form-control search-box"
                            placeholder="Price">

                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <div class="data-list" ng-repeat="vod in toShowAssignedBundles.assignVodAddOnsBundles">
                                <div class="tvs-info">
                                    <i class="glyphicon glyphicon-blackboard"></i>
                                    @{{ vod.name }}
                                </div>
                                <div>
                                    <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                    <span class="bundle-delete" ng-click="removeVodAddOnsBundles(vod)"
                                        style="float: right; color: #585353; cursor: pointer;">
                                        <i class="glyphicon glyphicon-remove-circle"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="" id="addedVodAddOnsBundles" style="min-height: 145px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="assign-btns">
                    <button type="button" class="button button-blue" data-dismiss="modal"
                        ng-click="assignedVodAddOnsBundles()">Assign</button>
                    <button class="btn btn-default" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    ...
    {{--  edit vod content set add on --}}
    <div id="vod-editon-modal" class="modal fade" role="dialog" style="overflow: auto;">
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="padding: 10px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit VOD Content Add-Ons</h4>
                        ...
                        <div class="form-group row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-sm-8 m-auto">
                                <input type="text" class="form-control" name="name" id="name"
                                    placeholder="Enter Name" ng-model="vodContentSetAddOns.vodModalData.name"
                        ...
                        <div class="form-group row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-sm-8 m-auto">
                                <input type="text" class="form-control" name="description" id="description"
                                    ...
                                    ng-model="vodContentSetAddOns.vodModalData.description"
                                    style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;margin: 0px 10px;">
                            </div>
                        </div>
                        ...
                        <div class="upload-cover-thumbnail flexbox"
                            ...
                            <div class="cover-image">
                                ...
                                <div class="image-content">
                                    <!-- image fetch code -->
                                    <img ng-show="vodContentSetAddOns.vodModalData.cover_image.length > 0"
                                        ng-class="{'active':vodContentSetAddOns.vodModalData.cover_image}"
                                        class="uploaded_poster_img uploaded_poster_img_@{{ vodContentSetAddOns.vodModalData.id }}"
                                        alt="" ng-src="@{{ vodContentSetAddOns.vodModalData.cover_image }}" />
                                        ...
                                        <div class="fileuploadbox">
                                            <div class="input-append">
                                                <div class="overlay-content"
                                                    data-ng-class="{'change-image': vodContentSetAddOns.vodModalData.cover_image.length > 0}">
                                                    <div class="input">
                                                        <div ng-hide="vodContentSetAddOns.vodModalData.cover_image.length"
                                                        ...
                                                        <input type="file" class="uploadPosterImg" name="image"
                                                            data-video-index="@{{ vodContentSetAddOns.vodModalData.id }}">
                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border rounded p-3 h-100">
                                            <label class="checkbox-inline d-block mb-3">
                                                <input type="checkbox"
                                                    ng-model="vodContentSetAddOns.vodModalData.monitization_type_buy"
                                                    ng-checked="vodContentSetAddOns.vodModalData.monitization_type_buy == 1"
                                                    value="1">
                                                Buy
                                            </label>

                                            <div ng-if="vodContentSetAddOns.vodModalData.monitization_type_buy">
                                                <!-- payment method -->
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="radio-inline me-3"
                                                            ...
                                                            <input type="radio" class="form-check-input"
                                                                ...
                                                                value="0"
                                                                ng-model="vodContentSetAddOns.vodModalData.payment_method_buy">
                                                            Per Bundle
                                                        </label>
                                                ...
                                                <div class="form-group row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-sm-8 m-auto input-group"
                                                        ...
                                                        <input type="text" class="form-control" name="price"
                                                            id="price" {{-- ng-model="extraPproductContentSet.prtnrProductModalData.price" --}}
                                                            ng-model="vodContentSetAddOns.vodModalData.buy_price"
                                                        ...
                                                        <span class="input-group-addon"
                                                            ...
                                                            @{{ vodContentSetAddOns.vodModalData.currency }}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border rounded p-3 h-100">
                                            <label class="checkbox-inline d-block mb-3">
                                                <input type="checkbox"
                                                    ng-model="vodContentSetAddOns.vodModalData.monitization_type_rent"
                                                    ng-checked="vodContentSetAddOns.vodModalData.monitization_type_rent == 0"
                                                    value="0">
                                                Rent
                                            </label>

                                            <div ng-if="vodContentSetAddOns.vodModalData.monitization_type_rent">
                                                <!-- payment method -->
                                                <div class="form-group row mb-3" style="margin-bottom: 15px;">
                                                    <label class="col-sm-3 col-form-label fw-bold"
                                                        style="font-size:14px; color:#000;">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="radio-inline me-3"
                                                            ...
                                                            <input type="radio" class="form-check-input"
                                                                ...
                                                                ng-model="vodContentSetAddOns.vodModalData.payment_method_rent">
                                                            Per Bundle
                                                        </label>
                                                ...
                                                <div class="form-group row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-sm-8 m-auto input-group"
                                                        ...
                                                        <input type="text" class="form-control" name="price"
                                                            id="price" {{-- ng-model="extraPproductContentSet.prtnrProductModalData.price" --}}
                                                            ng-model="vodContentSetAddOns.vodModalData.rent_price"
                                                            required placeholder="Enter price"
                                                            style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px 0 0 20px; padding: 5px 10px;">
                                                        <span class="input-group-addon"
                                                            style="border: 2px solid rgba(128, 130, 133, 0.36); border-left: 0; border-radius: 0 20px 20px 0;">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="price-input-wrapper d-flex align-items-center">
                                                                <input type="number" class="form-control price-input"
                                                                    ...
                                                                    ng-model="vodContentSetAddOns.vodModalData.period"
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control select2_custom_ddl"
                                                                ...
                                                                ng-model="vodContentSetAddOns.vodModalData.period_type">
                        ...
                        <div class="" style="padding: 10px 30px;">
                            ...
                            <div class="col-sm-12" style="max-height: 350px; overflow-y: auto; padding: 5px;">
                                <div id="availableChannelAddOnssBundles">
                                    {{-- <div>
                                        <input type="checkbox" ng-model="vod.selected" ng-true-value="1"
                                            ng-false-value="0">
                                    </div> --}}
                                    <div class="content-container panel panel-default data-list" draggable="true"
                                        data-ng-repeat="vod in vodContentSetAddOns.vodModalData.vods track by vod.id"
                                        data-id="@{{ vod.id }}" data-name="@{{ vod.title }}"
                                        data-bundle="@{{ vod | json }}" {{-- style="border: 2px solid gray; padding: 10px 5px; display: flex; justify-content: space-between;" --}}>
                                        <div class="channel-info content-header"><i
                                                class="glyphicon glyphicon-blackboard"></i>@{{ vod.title }}
                                        </div>
                                        <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                        <div class="col-sm-5 m-auto input-group" style="max-width: 250px;">
                                            <input type="text" class="form-control" name="price" id="price"
                                                ...
                                                ng-model="vodContentSetAddOns.vodModalData.subs_price" required
                ...
                <div class="assign-btns">
                    <button type="button" class="button button-blue"
                        ng-click="subscrCtrl.updateVodModalData(vodContentSetAddOns.vodModalData)">Save</button>
                    <button class="btn btn-default" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
