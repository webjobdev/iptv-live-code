...
@section('content')
    <div data-ng-controller="AncReminderController as ancRemndrCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="right-side flexbox align-items-center">
                <a data-ng-click="ancRemndrCtrl.addAncReminder($event)" href="javascript:void(0)"
                    ...
                    <span>{{ trans('organizations::index.create_remndr') }}</span>
                </a>
            </div>
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="reminders"
                    data-template-route="admin/reminders" data-count="false">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/organization/announcment/reminder.js') }}"></script>
