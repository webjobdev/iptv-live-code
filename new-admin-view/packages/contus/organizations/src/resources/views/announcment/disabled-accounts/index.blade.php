...
@section('content')
    <div data-ng-controller="AncDisabledAccController as ancDisabledAccCtrl">
                ...
                <div id="home" class="tab-pane fade in active"><br>
                    <div class="row">
                        <div class="mx-auto" style="width:70%; margin-left: 10rem;">
                            <form name="ancDisableAccForm" id="ancDisableAccForm" method="POST" data-base-validator
                                data-ng-submit="ancDisabledAccCtrl.saveAncDisabledAcc($event)"
                                ...
                                <div class="form-group row" data-ng-class="{'has-error': errors.name.has}">
                                    <label for="name" class="col-sm-2 control-label"
                                        style="font-size: 14px; color: #000; margin-top: 10px;"><strong>{{ trans('organizations::index.anc_subject') }}*:</strong>
                                    </label>
                                    <div class="form-input col-sm-10">
                                        <input type="text" name="subject"
                                            data-ng-model="ancDisabledAccCtrl.ancDisableAccData.subject"
                                            class="form-control"
                                ...
                                <div class="form-group row" data-ng-class="{'has-error': errors.name.has}">
                                    <label for="name" class="col-sm-2 control-label"
                                        style="font-size: 14px; color: #000; margin-top: 10px;"><strong>
                                            {{ trans('organizations::index.anc_message') }}*</strong>
                                    </label>
                                    <div class="form-input col-sm-10">
                                        <textarea type="text" rows="4" cols="50" name="message"
                                            data-ng-model="ancDisabledAccCtrl.ancDisableAccData.message" class="form-control"
                                ...
                                <div class="form-group text-center">
                                    <button type="submit" class="button button-blue" id="ancDisabledAccadd">
                                        <strong>Save</strong>
                                    </button>&nbsp;&nbsp;
                                    <button type="button" class="btn btn-default"
                                        ng-click="ancDisabledAccCtrl.cancelAncDisabledAcc($event)">
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/organization/announcment/disableAccount.js') }}"></script>
