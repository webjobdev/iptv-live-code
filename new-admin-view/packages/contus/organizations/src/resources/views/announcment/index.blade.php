...
@section('content')
    <div data-ng-controller="AnnouncmentController as ancCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('announcements.create')" data-ng-click="ancCtrl.addAnnouncement($event)"
                    ...
                    <span>{{ trans('organizations::index.create_anc') }}</span>
                </a>
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="announcment"
                    data-template-route="admin/announcment" data-count="false">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/organization/announcment/announcment.js') }}"></script>
