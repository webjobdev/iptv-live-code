...
<div data-ng-controller="RowOrderController as ROCtrl">
    <div class="page-heading flexbox align-items-center flex-wrap">
        <h4>
            View Rows Order For @{{ rows.title }}
        </h4>
    </div>
    ...
    <div class="contentpanel">
        <div class="form-page">
            <form method="post" data-base-validator enctype="multipart/form-data" id="channelSetForm">
                ...
                <input type="hidden" id="row_id" name="id" value="{{ request()->id }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" id="searchAvailable" class="form-control search-box"
                                            placeholder="Search Rows" style="margin-bottom: 8px;">
                                    </div>
<<<<<<< HEAD
                                    <!-- <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <select class="form-control mb10 select2_custom_ddl"
                                            ng-model="settCtrl.sett.time_zone" id="AvailableType"
                                            data-ng-options="item.type as item.type for item in getUniqueTypes()"
                                            data-jquery="select2_custom_ddl" myPlaceholder="Type">
                                    ...
                                    <div class="scroll-box" id="availableBundles">
                                        <div class="channel-item" draggable="true" ng-repeat="item in ROCtrl.allBundles"
                                            data-id="@{{ item.id }}" data-type="@{{ item.type }}" ng-disabled="true">
...
>>>>>>> d452abd591eeb4cac8089821386db435f6c27c79
                                </div>
...
>>>>>>> d452abd591eeb4cac8089821386db435f6c27c79
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="scroll-box">
                                    <div class="channel-item" draggable="true" ng-repeat="item in rows.selectedBundles"
                                        data-id="@{{ item.id }}" data-type="@{{ item.row_type }}">
                                        ...
                                        <div class="channel-info">
                                            ...
                                            <div class="item-box" ng-if="item.row_type === 'channel'">
                                                <span class="badge channel">CHANNEL</span>
                                            </div>

                                            <div class="item-box" ng-if="item.row_type === 'vod'">
                                                <span class="badge movies">VOD</span>
                                            </div>

                                            <div class="item-box" ng-if="item.row_type === 'liveevent'">
                                                <span class="badge events">EVENT</span>
                                            </div>

                                            <div class="item-box" ng-if="item.row_type === 'tvshow'">
                                                <span class="badge series">Series</span>
                                            </div>

                                            <div class="item-box" ng-if="item.row_type === 'radio'">
                                                <span class="badge default">Other</span>
                                            </div>
                                        </div>
                                    </div>
...
<script src="{{asset('adminview/assets/js/organization/app-customization/view-row-order.js')}}"></script>
