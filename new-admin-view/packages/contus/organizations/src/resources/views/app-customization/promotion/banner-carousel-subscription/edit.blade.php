...
@section('content')
    <div data-ng-controller="BannerCarouselsSubscriptionController as bcscCtrl">
        ...
        <div class="contentpanel">
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="BCSForm">
                    {!! csrf_field() !!}

                    <input type="hidden" id="bcs_id" name="bcs_id" value="{{ request()->get('bcs_id') }}">
                                    ...
                                    @foreach (['Stb', 'Pc/Lg', 'Ios', 'tvOS', 'Android Mobile', 'Samsung Tv', 'Web', 'Others/Roku'] as $platform)
                                        <div>
                                            <input type="checkbox" class="form-check-input" name="select_platform[]"
                                                value="{{ $platform }}"
                                                ng-checked="bnrcrs.select_platform && bnrcrs.select_platform.includes('{{ $platform }}')"
                                                ng-click="bcscCtrl.togglePlatform('{{ $platform }}')">
                    ...
                    <div class="row">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <label class="switch">
                                    <input type="checkbox" ng-model="bnrcrs.is_active" name="is_active" id="is_active"
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button type="submit" value="Save" class="button button-blue"
                            ng-click="bcscCtrl.updatedata($event)">
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/app-customization/banner_carousels_subscription.js')}}"></script>
