        ...
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="left-side flexbox align-items-center">
                    You can add/change the order of rows in the Home Page.
                </div>
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('organization.create')" data-ng-click="ROCtrl.opnPage($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10"
                    data-template-route="admin/org/app-customization/promotion/row-order"
                    data-route-name="organization/app-customization/promotion/row-order" data-count="false">
                </div>
            </div>
    ...
    <!-- <script>
                document.addEventListener("DOMContentLoaded", () => {
                    ...
                    function initDragDrop() {
                        ...
                        // Angular hasn't created list yet → wait & retry
                        if (!sortableList) {
