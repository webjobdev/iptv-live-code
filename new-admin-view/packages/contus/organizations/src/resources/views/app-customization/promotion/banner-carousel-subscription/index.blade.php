        ...
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('banner_featured_carousel.create')" data-ng-click="bcscCtrl.addchannelContent($event)"
            ...
            <div class="contentpanel product order_list">
                @include('base::partials.errors')
                <div class="response-msg"></div>
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/app-customization/banner_carousels_subscription"
                    data-route-name="organization/app-customization/banner_carousels_subscription" data-count="false">
                </div>
            </div>
