...
@section('content')
    <div data-ng-controller="FeatureRowController as fturCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="left-side flexbox align-items-center">
                    Here you can add content to subscription's featured rows
                </div>
                <!-- <div class="right-side flexbox align-items-center">
                        <a data-ng-if="checkAccess('subscription_all_write')" data-ng-click="fturCtrl.opnPage($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10"
                    data-template-route="admin/org/app-customization/promotion/features-row"
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/app-customization/feature-row.js')}}"></script>
