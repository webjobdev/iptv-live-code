        ...
        <div class="contentpanel">
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="channelSetForm"
                    data-ng-submit="chnlsetCtrl.save($event)">
                    {!! csrf_field() !!}
                        ...
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="col-md-6">
                                ...
                                <button type="button" class="button button-blue" data-toggle="modal"
                                    data-target="#exampleModal" style="margin-bottom: 6.5px;">
                                    <strong>Add Number Group</strong>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="channelEditFormSubmit" data-ng-click="chnlsetCtrl.save($event, vodSelectedVideo.id)"
                            class="publish-now">
                            save
                        </button>

                        <button type="submit" value="Save" ng-if="editPage" class="button button-blue"
                            ng-click="chnlsetCtrl.updatedata($event)">
