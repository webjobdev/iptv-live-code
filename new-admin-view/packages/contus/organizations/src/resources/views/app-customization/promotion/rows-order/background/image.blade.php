...
<div class="error-message" ng-if="rows.poster_type !== 'horizontal' && rows.poster_type !== 'vertical'">
    Please select a poster type before continuing.
</div>


<div class="upload-cover-thumbnail flexbox" data-ng-class="{'has-error': errors.horizontal_image.has}">
    <!-- poster image code -->
    <div class="cover-image" ng-if="rows.poster_type == 'horizontal'">
        <h4>{{ __('video::videos.poster') }}</h4>
        <div class="image-content">
            <!-- image fetch code -->
            <img ng-show="rows.horizontal_image.length > 0" ng-class="{'active':rows.horizontal_image}"
                class="uploaded_poster_img uploaded_poster_img_@{{ rows.id }}" alt=""
                ng-src="@{{rows.horizontal_image}}"
                >

            <img ng-show="rows.horizontal_image.length == 0" ng-class="{'active':rows.horizontal_image}"
                class="uploaded_poster_img uploaded_poster_img_@{{ rows.id }}" alt="" ng-src="" />

            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileuploadbox">
                    <div class="input-append">
                        <div class="overlay-content" data-ng-class="{'change-image': rows.horizontal_image.length > 0}">
                            <div class="input">
                                <div ng-hide="rows.horizontal_image.length" class="flexbox align-items-center">
                                    <svg viewBox="0 0 27 27" version="1.1" x="0px" y="0px" width="27px" height="27px">
                                        <g>
                                            <path opacity="0.702"
                                ...
                                <div ng-hide="!rows.horizontal_image.length" class="flexbox align-items-center ng-hide">
                                    <svg x="0px" y="0px" width="13" height="13" viewBox="0 0 528.899 528.899">
                                        <g>
                                            <path
        ...
        <p class="error-msg" data-ng-show="errors.horizontal_image.has">
            @{{errors.horizontal_image.message}}
        </p>
    </div>

    <!-- Thumbnail image code -->
    <div class="thumbnail-image" ng-if="rows.poster_type == 'vertical'">
        <h4>{{ __('video::videos.thumbnail')}}</h4>
        <div class="image-content">
            <img ng-show="rows.vertical_image.length > 0" ng-class="{'active': rows.vertical_image}"
                class="uploaded_img uploaded_img_@{{ rows.id }}" alt="" ng-src="@{{ rows.vertical_image }}" />

            <img ng-show="rows.vertical_image.length == 0" ng-class="{'active': rows.vertical_image}"
                class="uploaded_img uploaded_img_@{{ rows.id }}" alt="" ng-src="" />
            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileuploadbox">
                    <div class="input-append">
                        <div class="overlay-content"
                            data-ng-class="{'change-image': rows.vertical_image.length > 0}">
                            <svg class="upload_img_ic" viewBox="0 0 27 27" version="1.1" x="0px" y="0px" width="27px"
                                height="27px">
                                <g>
                                    <path opacity="0.702"
                                        d="M 13.2792 -0.0598 C 5.9642 -0.0598 0.0342 5.8719 0.0342 13.1886 C 0.0342 20.5052 5.9642 26.4371 13.2792 26.4371 C 20.5941 26.4371 26.5249 20.5052 26.5249 13.1886 C 26.5248 5.8716 20.5941 -0.0598 13.2792 -0.0598 ZM 6.2816 19.976 C 5.9301 19.976 5.6454 19.6915 5.6454 19.3398 L 5.6454 7.0371 C 5.6454 6.6857 5.9301 6.4011 6.2816 6.4011 L 20.2774 6.4011 C 20.6288 6.4011 20.9136 6.6857 20.9136 7.0371 L 20.9136 13.8455 L 19.9603 13.8455 L 19.4176 13.8455 L 19.4176 7.8747 L 7.1269 7.8747 L 7.1269 16.0911 L 7.8289 16.0911 L 10.665 11.6672 L 12.5605 14.6233 L 13.5018 16.0912 L 14.3177 16.0912 L 12.9685 13.9868 L 13.8479 12.6151 L 16.0767 16.0911 L 16.9754 16.0911 L 16.9754 16.8307 L 16.9754 18.2803 L 16.9754 19.1967 L 17.8915 19.1967 L 19.044 19.1967 L 19.044 19.9761 L 6.2816 19.9761 L 6.2816 19.976 ZM 18.3362 10.631 C 18.3362 11.3581 17.7467 11.9478 17.0198 11.9478 C 16.2928 11.9478 15.7034 11.3581 15.7034 10.631 C 15.7034 9.904 16.2928 9.3143 17.0198 9.3143 C 17.7467 9.3143 18.3362 9.9041 18.3362 10.631 ZM 21.4094 18.2803 L 21.4094 20.349 L 19.9606 20.349 L 19.9606 19.976 L 19.9606 18.2803 L 17.8918 18.2803 L 17.8918 16.8307 L 19.9606 16.8307 L 19.9606 14.7618 L 20.9138 14.7618 L 21.4095 14.7618 L 21.4095 16.8307 L 23.478 16.8307 L 23.478 18.2803 L 21.4094 18.2803 Z"
                            ...
                            <div class="input">
                                <div ng-hide="rows.vertical_image.length">
                                    ...
                                    <svg class="change_img_ic" x="0px" y="0px" width="13" height="13"
                                        ...
                                        <g>
                                            <path d="
                                                ...
                                                L27.473,390.597L0.3,512.69z" fill="#ffffff">
                                            </path>
                                        </g>
                                    </svg>
                                    <span>Upload Vertical Image</span>
                                </div>
                                <input type="file" class="uploadImg" name="image" data-video-index="@{{ rows.id }}">
                            </div>
        ...
        <p class="error-msg" data-ng-show="errors.vertical_image.has">
            @{{errors.vertical_image.message}}</p>
    </div>
</div>
