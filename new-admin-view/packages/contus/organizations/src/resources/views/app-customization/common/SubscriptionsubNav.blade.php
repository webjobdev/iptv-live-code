...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li ng-class="{'active': fturCtrl.btnNo == 0}">
        <a style="color: black;" ng-click="fturCtrl.btnNo=0">
    ...
    <li ng-class="{'active': fturCtrl.btnNo == 1}">
        <a style="color: black;" ng-click="fturCtrl.btnNo=1">
    ...
    <li ng-class="{'active': fturCtrl.btnNo == 2}">
        <a style="color: black;" ng-click="fturCtrl.btnNo=2">
