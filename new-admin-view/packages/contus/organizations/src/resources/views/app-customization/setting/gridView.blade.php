            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_accessories">
                        <input type="text" class="form-control" data-ng-model="searchRecords.time_zone"
                            data-boot-tooltip="true" title="Time Zone" placeholder="Time Zone">
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in AssignSettRecords track by $index"
                    ...
                    <td class="td-custom-width">
                        @{{record.screen_server}} Minutes
                    </td>
                    <td class="td-custom-width">
                        @{{ record.get_channel.channel_name }}
                    </td>
                    <td class="td-custom-width">
                        @{{ record.get_channel.sorting_number }}
                    </td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('subscribers')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="settCtrl.edit(record, record.id, record.organization_id)">
