...
@section('content')
    <div data-ng-controller="SettingController as settCtrl">
        ...
        <div class="contentpanel">
            <div class="form-page">
                <form method="post" id="OrgSettingForm" data-base-validator enctype="multipart/form-data"
                    data-ng-submit="settCtrl.update($event, settCtrl.sett.id)">
                    {!! csrf_field() !!}
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-4 m-auto">
                                    <select class="form-control mb10 select2_custom_ddl" ng-model="settCtrl.sett.time_zone"
                                        ng-options="time for time in settCtrl.timezone" data-jquery="select2_custom_ddl"
                                        myPlaceholder="Time Zone" name="time_zone">
