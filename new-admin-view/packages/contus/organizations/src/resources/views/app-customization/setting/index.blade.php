        ...
        <div class="contentpanel" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('organization.create')" data-ng-click="settCtrl.openPage($event)"
            ...
            <div class="contentpanel product order_list">
                @include('base::partials.errors')
                <div class="response-msg"></div>
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/org/app-customization/setting"
                    data-route-name="app-customization/setting" data-count="false">
                </div>
            </div>
