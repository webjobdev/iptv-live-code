            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_accessories">
                        <input type="text" class="form-control" data-ng-model="searchRecords.resource_type"
                            data-boot-tooltip="true" title="Resource Type" placeholder="Resource Type">
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in BannerCarouselSubrecords track by $index"
                    ...
                    <td>
                        <span class="badge bg-dark" ng-repeat="rec in record.select_platform" ng-if="rec"
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('banner_featured_carousel.edit')"
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('banner_featured_carousel.delete')">
