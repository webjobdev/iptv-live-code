...
@section('content')
    <div class="pageheader clearfix">
        <h2 class="pull-left">
            <i class="fa fa-tag"></i> {{ trans('customer::subscription.user') }}
            <span>{{ trans('customer::subscription.add_new_subscription') }}</span>
        </h2>
    </div>
    <form name="subscriptionForm" method="POST" action="{{ url('admin/subscriptions-plans/add') }}"
                        ...
                        <div class="panel-body">
                            <div class="add_form clearfix">
                                <div class="form-group" data-ng-class="{'has-error': errors.name.has}">
                                    ...
                                    </label> <input type="text" name="name" data-unique="@{{ subscriptionCtrl.uniqueRoute }}"
                                        data-ng-model="subscriptionCtrl.subscriptions_plans.name" class="form-control"
                                ...
                                <div class="form-group" data-ng-class="{'has-error': errors.type.has}">
                                    <label class="control-label">{{ trans('customer::subscription.type') }}
                                        ...
                                        data-ng-model="subscriptionCtrl.subscriptions_plans.type" class="form-control"
                                ...
                                <div class="form-group" data-ng-class="{'has-error': errors.description.has}">
                                    ...
                                    <textarea type="text" name="phone" class="form-control"
                                        ...
                                        placeholder="{{ trans('customer::subscription.description_placeholder') }}" value="{{ old('description') }}"></textarea>
                                    <p class="help-block hide"></p>
                                </div>
                                ...
                                <div class="form-group" data-ng-class="{'has-error': errors.amount.has}">
                                    <label class="control-label">{{ trans('customer::subscription.amount') }}
                                        ...
                                        data-ng-model="subscriptionCtrl.subscriptions_plans.amount" class="form-control"
                                ...
                                <div class="form-group" data-ng-class="{'has-error': errors.duration.has}">
                                    ...
                                    <textarea type="text" name="phone" class="form-control"
                                        ...
                                        placeholder="{{ trans('customer::subscription.duration_placeholder') }}" value="{{ old('duration') }}"></textarea>
                                    <p class="help-block hide"></p>
                                </div>
            ...
            <div class="padding10">
                <div class="fixed-btm-action">
                    <div class="text-right btn-invoice">
                        <a class="btn btn-white mr5"
                            href="{{ url('admin/subscriptions-plans') }}">{{ trans('base::general.cancel') }}</a>
