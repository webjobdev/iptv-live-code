        ...
        <div class="dashboard-page " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                ...
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('organization.create')" data-ng-click="dashCtrl.addOrganization($event)"
                        ...
                        <span>{{trans('organizations::index.add_organization')}}</span>
                    </a>
            ...
            <form class="form-inline serch-btn" id="searchForm" method="GET">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" name="organization_name" placeholder="Search here..."
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="" data-route-name="organizations"
                    data-template-route="admin/organizations" data-count="false"></div>
            </div>
