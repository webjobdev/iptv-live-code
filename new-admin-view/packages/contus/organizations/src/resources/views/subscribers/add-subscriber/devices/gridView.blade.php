        ...
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td></td>
                    <td class="center">
                        <select class="select2_custom_ddl" minimumResults="-1" data-jquery="select2_custom_ddl" data-boot-tooltip="true" data-ng-model="searchRecords.status"
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat"
                    ...
                    <td class="center td-custom-width">@{{record.serial_number}}</td>
                    <td class="center td-custom-width">@{{record.identifier}}</td>
                    <td class="center">@{{record.ip_address}}</td>
                    <td class="center">@{{record.location}}</td>
                    <td class="center">@{{record.last_session}}</td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('organizations')" class="form-group row" style="margin-bottom: 0px; margin-right: 5px;">
                                <label class="switch">
                                    <input type="checkbox"
...
<div>
    <div class="form-group row" style="margin-bottom: 15px;">
        <div class="col-sm-3 m-auto" style="padding-left: 13px;">
            <select name="country" id="country" class="form-control rounded-pill border-3" ng-model="subCtrl.org_sub.country"
        ...
        <button type="button" class="btn btn-default" style="border: 2px solid rgba(128, 130, 133, 0.36); margin-top: 0.2rem;">Add</button>
    </div>
</div>