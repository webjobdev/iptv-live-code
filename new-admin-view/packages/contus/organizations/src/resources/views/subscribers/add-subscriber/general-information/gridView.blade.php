    ...
    <div class="table_responsive">
        <table class="table subscription-plan-grid table-custom" id="fixTable"
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.user_name"
                            ...
                            ng-keyup="$event.keyCode == 13 && OrgSubCtrl.filterSubscribers()">
                    </td>
                    <td class="search_product td-custom-width">
                        <input type="text" class="form-control" data-ng-model="searchRecords.first_name"
                            placeholder="Enter Full Name" data-boot-tooltip="true" data-toggle="tooltip"
                    ...
                    <td class="search_product center td-custom-width">
                        <input type="text" class="form-control search-amount-subscription"
                            placeholder="Enter Phone Number" data-ng-model="searchRecords.phone_number"
                            data-boot-tooltip="true" data-toggle="tooltip" data-original-title="number"
                            ng-keyup="$event.keyCode == 13 && OrgSubCtrl.filterSubscribers()">
                    </td>
                    <td class="search_product center td-custom-width">
                        <input type="text" class="form-control search-amount-subscription" placeholder="Enter Address"
                            data-ng-model="searchRecords.address" data-boot-tooltip="true" data-toggle="tooltip"
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in SubscriberRecords track by $index"
                    ...
                    <td> @{{ record.address.length > 10 ? (record.address.substring(0, 20) + '...') : record.address }}
                    </td>
                    ...
                    <td>@{{ record.date_of_birth | date: 'dd-MM-yyyy' }}</td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('subscribers')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="OrgSubCtrl.editSubscriber(record, record.id)">
