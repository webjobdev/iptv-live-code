<style>
    ...
    .vod-info i.glyphicon-blackboard {
        color: #666;
        font-size: 14px;
    }
...
@section('content')
    <div data-ng-controller="VodContentSetsController as vodsetCtrl">
        ...
        <div class="contentpanel">
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="vodSetForm">
                    {!! csrf_field() !!}
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 m-auto">
                                    <input type="text" class="form-control" name="name" required
                                        placeholder="Enter Vod Set Name" ng-model="vodset.name"
                            ...
                            <div class="row dual-list-container">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableBundles">
                                            <div class="vod-item" draggable="true"
                                                data-ng-repeat="live in vodsetCtrl.vodset" data-id="@{{ live.id }}">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="addedBundles" ng-model="vodset.assigned_vod">

                                            <div class="vod-item" data-ng-repeat="bundle in vodset.selectedBundles"
                                                data-id="@{{ bundle.id }}">
                                                <span class="vod-drag"><i class="glyphicon glyphicon-move"></i></span>
                                                <div class="vod-info">
                                                    <i class="glyphicon glyphicon-blackboard"></i>
                                                    @{{ bundle.title }}
                                                </div>
                                                <span class="bundle-remove" data-ng-click="removeContent(bundle)">
                                                    <i class="glyphicon glyphicon-remove-circle"></i>
                                                </span>
                                            </div>

                                            <div class="drop-zone" ng-show="!vodset.selectedBundles.length">DROP HERE</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-6">
                                    <label ng-repeat="currency in vodsetCtrl.orgCurrency"
                                        ...
                                        <input type="radio" id="@{{currency.short_code | lowercase}}" name="currency"
                                            ng-model="vodset.currency" value="@{{currency.short_code}}">
                                        @{{currency.short_code}}
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                <input type="radio" class="form-check-input" id="bundleBuy"
                                                                    ...
                                                                    ng-model="vodset.payment_method_buy"> Per Bundle
                                                            </label>

                                                            <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                <input type="radio" class="form-check-input" id="itemBuy"
                                                                    name="payment_method_buy" value="1"
                                                                    ng-model="vodset.payment_method_buy"> Per Item
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" style="margin-bottom: 15px;">
                                                        ...
                                                        <div class="col-sm-10 m-auto price-input-wrapper">
                                                            <input type="number" class="form-control price-input"
                                                                ...
                                                                style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                                                            <span class="currency-label">@{{ vodset.currency }}</span>
                                                            <p class="error-msg">
                                        ...
                                        <div class="col-md-6">
                                            <div class="border rounded p-3 h-100">
                                                <label class="checkbox-inline d-block mb-3">
                                                    <input type="checkbox" ng-model="vodset.monitization_type_rent"
                                                        value="0">
                                                    Rent
                                                </label>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    ng-model="vodset.payment_method_rent"> Per Bundle
                                                            </label>
                    ...
                    <div class="row">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="upload-cover-thumbnail flexbox"
                                ...
                                <div class="cover-image">
                                    ...
                                    <div class="image-content responsive-center-container">
                                        <!-- image fetch code -->
                                        <img ng-show="vodset.cover_image.length > 0"
                                            ng-class="{'active':vodset.cover_image}"
                                            class="uploaded_poster_img uploaded_poster_img_@{{ vodset.id }}" alt=""
                                            ng-src="@{{vodset.cover_image  }}" />
                                            ...
                                            <div class="fileuploadbox">
                                                <div class="input-append">
                                                    <div class="overlay-content"
                                                        data-ng-class="{'change-image': vodset.cover_image.length > 0}">
                                                        <div class="input">
                                                            <div ng-hide="vodset.cover_image.length"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 m-auto">
                                    <textarea name="w3review" rows="4" class="form-control" cols="50" name="description"
                                        placeholder="Enter vod Set Description" ng-model="vodset.description"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <label class="switch">
                                    <input type="checkbox" ng-model="vodset.is_active" name="is_active"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="vodEditFormSubmit" data-ng-click="vodsetCtrl.save($event, vodSelectedVideo.id)"
                            class="publish-now">
                            Save
                        </button>
