<style>
    ...
    /* Common card style */
    .tvs-item, .content-container, .content-container-episode {
        display: flex;
        align-items: center;
    ...
    .content-container, .content-container-episode {
    ...
    .tvs-item:hover, .content-container:hover, .content-container-episode:hover {
    ...
    .tvs-info i.glyphicon-blackboard, .content-header i.glyphicon-blackboard, .item-box i.glyphicon-blackboard {
        color: #666;
        font-size: 14px;
    }
...
@section('content')
    <div data-ng-controller="TvShowContentSetsController as tvsetCtrl">
        <div class="page-heading flexbox align-items-center flex-wrap">
            <h4>
                Add New Tv Show Sets
            </h4>
        </div>
        ...
        <div class="contentpanel">
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="tvssetForm">
                    {!! csrf_field() !!}
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 m-auto">
                                    <input type="text" class="form-control" name="name" required
                                        placeholder="Enter tvs Set Name" ng-model="tvsset.name"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="item_type" ng-model="tvsset.item_type" value="tv_show"> Tv
                                        Show
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="item_type" ng-model="tvsset.item_type" value="season">
                                        Season
                                    </label>

                                    <label class="radio-inline me-3" style="vertical-align: unset;">
                                        <input type="radio" name="item_type" ng-model="tvsset.item_type" value="episode">
                                        Episode
                                    </label>
                                </div>
                            </div>
                    ...
                    <p class="text-center" style="margin-bottom: 20px; margin-top: 20px;">
                        ...
                        Please select the Tv Show you want to move
                    </p>
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableBundles">
                                            <div class="tvs-item" draggable="false"
                                                data-ng-repeat="live in tvsetCtrl.tvsset track by live.id" data-id="@{{ live.id }}">
                                                <span class="tvs-drag">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box">
                                            <div class="tvs-item" draggable="false" ng-model="tvsset.assigned_tv_show"
                                            ...
                                            <div id="addedBundles" style="min-height: 80px;">
                            ...
                            <div class="row dual-list-container" ng-show="tvsset.item_type == 'season'" style="margin-bottom: 15px;">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableSeasonBundles">
                                                <div class="content-container panel-default" draggable="false" data-ng-repeat="season in tvsetCtrl.seasons track by season.id"
                                                    data-id="@{{ season.id }}">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box">
                                                <div class="content-container panel-default" draggable="false"
                                            ...
                                            <div id="addedSeasonBundles" style="min-height: 80px;">
                            ...
                            <div class="row dual-list-container" ng-show="tvsset.item_type == 'episode'" style="margin-bottom: 15px;">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableEpisodeBundles">
                                                <div class="content-container-episode panel-default" draggable="false" data-ng-repeat="episode in tvsetCtrl.episodes track by episode.id"
                                                    data-id="@{{ episode.id }}">
                                                    <div class="content-header">
                                                        <span class="tvs-drag">
                                                            <i class="glyphicon glyphicon-move"></i>
                                                    ...
                                                    <div class="item-box"
                                                        ...
                                                        draggable="false" style="flex-direction: column; align-items: stretch; background-color: #f7f7f7;">
                                                        ...
                                                        <div class="item-box"
                                                            ...
                                                            draggable="false" style="background-color: #fff; margin-top: 2px;">
                                                            <span class="tvs-drag">
                                                                <i class="glyphicon glyphicon-move"></i>
                                                            </span>
                                                            <i class="glyphicon glyphicon-blackboard"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box">
                                                <div class="content-container-episode panel-default" draggable="false"
                                            ...
                                            <div id="addedEpisodeBundles" style="min-height: 80px;">
                    ...
                    <div class="row">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-6">
                                    <label ng-repeat="currency in tvsetCtrl.orgCurrency"
                                        ...
                                        <input type="radio" id="@{{currency.short_code | lowercase}}" name="currency"
                                            ng-model="tvsset.currency" value="@{{currency.short_code}}">
                                        @{{currency.short_code}}
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="border rounded p-3 h-100">
                                                <label class="checkbox-inline d-block mb-3">
                                                    <input type="checkbox" ng-model="tvsset.monitization_type_buy"
                                                        ng-value="1">
                                                    Buy
                                                </label>

                                                <div ng-if="tvsset.monitization_type_buy">
                                                    <!-- payment method -->
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                <input type="radio" class="form-check-input" id="bundleBuy"
                                                                    ...
                                                                    ng-model="tvsset.payment_method_buy"> Per Bundle
                                                            </label>

                                                            <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                <input type="radio" class="form-check-input" id="itemBuy"
                                                                    name="payment_method_buy" value="1"
                                                                    ng-model="tvsset.payment_method_buy"> Per Item
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" style="margin-bottom: 15px;">
                                                        ...
                                                        <div class="col-sm-10 m-auto price-input-wrapper">
                                                            <input type="number" class="form-control price-input"
                                                                name="price" placeholder="Enter tvs price"
                                                                ng-model="tvsset.buy_price"
                                                                style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                                                            <span class="currency-label">@{{ tvsset.currency }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="border rounded p-3 h-100">
                                                <label class="checkbox-inline d-block mb-3">
                                                    <input type="checkbox" ng-model="tvsset.monitization_type_rent"
                                                        ng-value="0">
                                                    Rent
                                                </label>

                                                <div ng-if="tvsset.monitization_type_rent">
                                                    <!-- payment method -->
                                                    <div class="form-group row mb-3" style="margin-bottom: 15px;">
                                                        <label class="col-sm-3 col-form-label fw-bold"
                                                            style="font-size:14px; color:#000;">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    ng-model="tvsset.payment_method_rent"> Per Bundle
                                                            </label>

                                                            <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                <input type="radio" class="form-check-input"
                                                                    name="payment_method_rent" value="1"
                                                                    ng-model="tvsset.payment_method_rent"> Per Item
                                                            </label>
                                                        </div>
                                                    </div>
                    ...
                    <div class="row">
                        <div class="justify-content-center mx-auto filter-wrapper">
                                ...
                                <div class="cover-image">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-2" style="margin-bottom:10px;">
                                            ...
                                            Cart/client app performance.
                                        </p>
                                    </div>

                                    <div class="image-content responsive-center-container">
                                        <!-- image fetch code -->
                                        <img ng-show="tvsset.cover_image.length > 0"
                                            ng-class="{'active':tvsset.cover_image}"
                                            class="uploaded_poster_img uploaded_poster_img_@{{ tvsset.id }}" alt=""
                                            ng-src="@{{tvsset.cover_image  }}" />
                                            ...
                                            <div class="fileuploadbox">
                                                <div class="input-append">
                                                    <div class="overlay-content"
                                                        data-ng-class="{'change-image': tvsset.cover_image.length > 0}">
                                                        <div class="input">
                                                            <div ng-hide="tvsset.cover_image.length"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 m-auto">
                                    <textarea name="w3review" rows="4" class="form-control" cols="50" name="description"
                                        placeholder="Enter tvs Set Description" ng-model="tvsset.description"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <label class="switch">
                                    <input type="checkbox" ng-model="tvsset.is_active" name="is_active"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="tvsEditFormSubmit" data-ng-click="tvsetCtrl.updatedata($event, tvsSelectedVideo.id)"
                            class="publish-now">
                            Update
                        </button>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/contentset/tvshowset.js')}}"></script>
