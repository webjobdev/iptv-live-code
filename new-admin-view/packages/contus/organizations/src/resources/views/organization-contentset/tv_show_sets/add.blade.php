            ...
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="tvssetForm">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableSeasonBundles">
                                                <div class="content-container panel-default" draggable="false" data-ng-repeat="season in tvsetCtrl.seasons"
                                                    data-id="@{{ season.id }}">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableEpisodeBundles">
                                                <div class="content-container-episode panel-default" draggable="false" data-ng-repeat="episode in tvsetCtrl.episodes"
                                                    data-id="@{{ episode.id }}">
                                                    <div class="content-header">
                                                        <span class="tvs-drag">
                                                            <i class="glyphicon glyphicon-move"></i>
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="tvsEditFormSubmit" data-ng-click="tvsetCtrl.save($event, tvsSelectedVideo.id)"
                            class="publish-now">
                            Save
                        </button>
