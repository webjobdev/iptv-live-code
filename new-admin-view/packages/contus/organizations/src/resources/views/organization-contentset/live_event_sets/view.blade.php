            ...
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="channelSetForm">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box">
                                            <div class="channel-item" draggable="false" ng-model="eventset.assigned_channels"
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <!-- <button id="channelEditFormSubmit" data-ng-click="livesetCtrl.updatedata($event, vodSelectedVideo.id)"
                                            class="publish-now">
                                            save
                                        </button> -->
