        ...
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('organization.create')" data-ng-click="tvsetCtrl.addContent($event)"
            ...
            <div class="contentpanel product order_list">
                @include('base::partials.errors')
                <div class="response-msg"></div>
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/tv-show/content-set"
                    data-route-name="tv-show/content-set" data-count="false">
                </div>
            </div>
