        ...
        <div class="contentpanel">
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="channelSetForm">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box">
                                            <div class="channel-item" draggable="true" ng-model="channlset.assigned_channels"
                    ...
                    <!-- <pre>@{{ channlset.selectedBundles | json }}</pre> -->
                                ...
                                <div class="col-sm-6">
                                    <label ng-repeat="currency in setCtrl.orgCurrency"
                                        ...
                                        <input type="radio" id="@{{currency.short_code | lowercase}}" name="currency"
                                            ng-model="channlset.currency" value="@{{currency.short_code}}"> @{{currency.short_code}}
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button type="submit" value="Save" class="button button-blue" ng-click="setCtrl.updatedata($event)">
