    ...
    <div class="table_responsive">
        <table class="table subscription-plan-grid table-custom" id="fixTable"
            ...
            <tbody>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in VodSetrecords track by $index"
                    ...
                    <td class="td-custom-width">@{{vodCount(record) || '-'}}</td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('subscribers')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="vodsetCtrl.view(record, record.id, record.organization_id)">
                            ...
                            <div data-ng-if="checkAccess('subscribers')" class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="vodsetCtrl.edit(record, record.id, record.organization_id)">
