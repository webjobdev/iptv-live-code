            ...
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="vodSetForm">
                                    ...
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableBundles">
                                            <div class="vod-item" draggable="true"
                                                data-ng-repeat="live in vodsetCtrl.vodset track by live.id"
                                                data-id="@{{ live.id }}">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box">
                                            <div class="vod-item" draggable="true" ng-model="vodset.assigned_vod"
                                                data-ng-repeat="show in vodset.selectedBundles" data-id="@{{ show.id }}">
                                                ...
                                                <span class="bundle-remove" ng-click="removeContent(show)">
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="vodEditFormSubmit" data-ng-click="vodsetCtrl.updatedata($event, vodSelectedVideo.id)"
                            class="publish-now">
                            Update
                        </button>
