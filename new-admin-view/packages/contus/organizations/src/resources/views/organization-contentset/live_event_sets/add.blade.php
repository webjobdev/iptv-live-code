<style>
    ...
    @section('content')
        <div data-ng-controller="LiveEventContentSetsController as livesetCtrl">
        <div class="page-heading flexbox align-items-center flex-wrap">
            <h4>
                Add New Live Event Sets
            </h4>
        </div>
            ...
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="channelSetForm">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 m-auto">
                                    <input type="text" class="form-control" name="name" required
                                        placeholder="Enter Channel Set Name" ng-model="eventset.name"
                            ...
                            <div class="row dual-list-container">
                                    ...
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableBundles">
                                            <div class="channel-item" draggable="true"
                                                data-ng-repeat="live in livesetCtrl.eventset" data-id="@{{ live.id }}">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="addedBundles" style="min-height: 145px;"
                                            ng-model="eventset.assigned_channels">

                                            <div class="channel-item" data-ng-repeat="bundle in eventset.selectedBundles"
                                                data-id="@{{ bundle.id }}">
                                            ...
                                            <div class="drop-zone" ng-show="!eventset.selectedBundles.length">DROP HERE</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-6">
                                    <label ng-repeat="currency in livesetCtrl.orgCurrency"
                                        ...
                                        <input type="radio" id="@{{currency.short_code | lowercase}}" name="currency"
                                            ng-model="eventset.currency" value="@{{currency.short_code}}">
                                        @{{currency.short_code}}
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 d-flex align-items-center">
                                    <div class="form-check me-4">
                                        <input class="form-check-input" type="radio" ng-model="eventset.monitization_type"
                                            value="1">
                                ...
                                <div class="col-sm-6">
                                    <!-- <label class="radio-inline me-3" style="vertical-align: unset;">
                                                                                <input type="radio" name="payment_method" value="0"
                                                                                    ng-model="eventset.payment_method">
                                                                                Per Bundle
                                                                            </label> -->
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 m-auto price-input-wrapper">
                                    <input type="number" class="form-control price-input" name="price"
                                        placeholder="Enter Channel price" ng-model="eventset.price"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                                    <span class="currency-label">@{{ eventset.currency }}</span>
                                    <p class="error-msg">
                    ...
                    <div class="row">
                        <div class="justify-content-center mx-auto filter-wrapper">
                            ...
                            <div class="upload-cover-thumbnail flexbox"
                                ...
                                <div class="cover-image">
                                    ...
                                    <div class="image-content responsive-center-container">
                                        <!-- image fetch code -->
                                        <img ng-show="eventset.cover_image.length > 0"
                                            ng-class="{'active':eventset.cover_image}"
                                            class="uploaded_poster_img uploaded_poster_img_@{{ eventset.id }}" alt=""
                                            ng-src="@{{eventset.cover_image  }}" />
                                            ...
                                            <div class="fileuploadbox">
                                                <div class="input-append">
                                                    <div class="overlay-content"
                                                        data-ng-class="{'change-image': eventset.cover_image.length > 0}">
                                                        <div class="input">
                                                            <div ng-hide="eventset.cover_image.length"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10 m-auto">
                                    <textarea name="w3review" rows="4" class="form-control" cols="50" name="description"
                                        placeholder="Enter Channel Set Description" ng-model="eventset.description"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <label class="switch">
                                    <input type="checkbox" ng-model="eventset.is_active" name="is_active"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="channelEditFormSubmit" data-ng-click="livesetCtrl.save($event, vodSelectedVideo.id)"
                            class="publish-now">
                            Save
                        </button>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/contentset/live-event.js')}}"></script>
