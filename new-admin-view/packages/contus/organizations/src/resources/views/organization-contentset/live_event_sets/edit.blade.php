            ...
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="channelSetForm">
                    ...
                    <p class="text-center" style="margin-bottom: 20px; margin-top: 20px;">
                        ...
                        Please select the Live Event you want to move
                    </p>
                                    ...
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableBundles">
                                            <div class="channel-item" draggable="true"
                                                data-ng-repeat="live in livesetCtrl.eventset track by live.id"
                                                data-id="@{{ live.id }}">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box">
                                            <div class="channel-item" draggable="true" ng-model="eventset.assigned_channels"
                                                data-ng-repeat="show in eventset.selectedBundles" data-id="@{{ show.id }}">
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="channelEditFormSubmit"
                            data-ng-click="livesetCtrl.updatedata($event, vodSelectedVideo.id)" class="publish-now">
                            Update
                        </button>
