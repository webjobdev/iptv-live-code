            ...
            <div class="form-page">
                <form method="post" data-base-validator enctype="multipart/form-data" id="channelSetForm">
                                    ...
                                    <div class="list-wrapper">
                                        ...
                                        <div class="scroll-box" id="availableBundles">
                                            <div class="channel-item" draggable="true"
                                                data-ng-repeat="channel in setCtrl.channlset" data-id="@{{ channel.id }}">
                                ...
                                <div class="col-md-6">
                                    <div class="list-wrapper">
                                        ...
                                        <input type="text" id="searchAdded" class="form-control search-box"
                                            ng-model="channlset.assigned_channels" placeholder="Search Channels">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <!-- <label class="radio-inline me-3" style="vertical-align: unset;">
                                                    <input type="radio" name="currency" ng-model="channlset.currency" value="EUR"> EUR
                                                </label>

                                                <label class="radio-inline me-3" style="vertical-align: unset;">
                                                    <input type="radio" name="currency" ng-model="channlset.currency" value="INR"> INR
                                                </label>

                                                <label class="radio-inline me-3" style="vertical-align: unset;">
                                                    <input type="radio" name="currency" ng-model="channlset.currency" value="AED"> AED
                                                </label>

                                                <label class="radio-inline me-3" style="vertical-align: unset;">
                                                    <input type="radio" name="currency" ng-model="channlset.currency" value="BOB"> BOB
                                                </label> -->
                                </div>
                            </div>
                    ...
                    <div class="bottom-button text-center"
                        ...
                        <button id="channelEditFormSubmit" data-ng-click="setCtrl.save($event, vodSelectedVideo.id)"
                            class="publish-now">
                            Save
                        </button>
