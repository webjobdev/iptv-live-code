        ...
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('organization.create')" data-ng-click="setCtrl.addchannelContent($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/channel/content-set"
                    data-route-name="channel/content-set" data-count="false">
                </div>
            </div>
