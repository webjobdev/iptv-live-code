    ...
    <div data-ng-controller="PartnerProductController as PpCtrl">
        <div class="contentpanel" id="dashboard-page">
            ...
            <div class="contentpanel product order_list">
                @include('base::partials.errors')
                <div class="response-msg"></div>
                <div data-grid-view data-rows-per-page="10" data-template-route="admin/organizations/partner-product"
                    data-route-name="organizations/partner-product" data-count="false">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/partner-product/index.js')}}"></script>
