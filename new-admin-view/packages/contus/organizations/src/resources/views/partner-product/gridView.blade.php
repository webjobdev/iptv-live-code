            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.product_name"
                            data-boot-tooltip="true" title="Type Product Name" placeholder="Type Product Name">
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr data-ng-if="showRecords"
                    data-ng-repeat="record in partnerProductRecords track by $index"
                    ...
                    <td class="td-custom-width">
                        <div class="product_img flexbox align-items-center">
                            <a class="table-image-text flexbox align-items-center">
                                <div class="image" bg-image="@{{record.product_image.replaceAll('\\','/')}}"
                                    on-error-src="{{url('adminview/assets/images/default_image.png')}}">
                                </div>
                            </a>
                            <div class="product_description tooltip-parent">
                                <p class="img_description">@{{ record.product_name}}
                                    <span class="tooltip_title">@{{record.product_name}}</span>
                                </p>
                            </div>
                        </div>
                    </td>
                    <td class="td-custom-width">@{{record.partner_program}}</td>
                    <td class="td-custom-width">@{{record.by_user.email}}</td>
                    <td class="td-custom-width">@{{record.updated_at | date:'dd-MM-yyyy HH:MM:ss'}}</td>
...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="partner-productForm" id="partner-productForm" method="POST" data-base-validator
            data-ng-submit="PpCtrl.save($event, PpCtrl.product.id)" enctype="multipart/form-data">

            {!! csrf_field() !!}

            <!-- Header -->
            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!PpCtrl.product.id">
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control mb10 select2_custom_ddl" ng-model="PpCtrl.product.partner_program"
                        data-jquery="select2_custom_ddl" myPlaceholder="Select Partner Program" name="partner_program">
                        <option value="" disabled>-- Select Partner Program --</option>
                        <option value="reseller">Reseller Program</option>
                        <option value="affiliate">Affiliate Program</option>
                        <option value="technology">Technology Partner Program</option>
                        <option value="strategic">Strategic Alliance Program</option>
                        <option value="content">Content Provider Program</option>
                        <option value="distributor">Distributor Program</option>
                        <option value="whitelabel">White Label Program</option>
                    </select>
                    <p class="error-msg">@{{ errors.partner_program.message }}</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="product_name" data-unique="@{{productCtrl.uniqueRoute}}"
                            data-ng-model="PpCtrl.product.product_name" class="form-control" placeholder="Type Name">
                        <p class="error-msg">
                ...
                <div class="upload-cover-thumbnail flexbox" data-ng-class="{'has-error': errors.poster_image.has}">
                    ...
                    <div class="thumbnail-image">
                        ...
                        <div class="image-content">
                            <img ng-show="PpCtrl.product.product_image.length > 0"
                                ng-class="{'active': PpCtrl.product.product_image}"
                                class="uploaded_img uploaded_img_@{{ PpCtrl.product.id }}" alt=""
                                ng-src="@{{ PpCtrl.product.product_image }}" />

                            <img ng-show="PpCtrl.product.product_image.length == 0"
                                ng-class="{'active': PpCtrl.product.product_image}"
                                class="uploaded_img uploaded_img_@{{ PpCtrl.product.id }}" alt="" ng-src="" />
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileuploadbox">
                                    <div class="input-append">
                                        <div class="overlay-content"
                                            data-ng-class="{'change-image': PpCtrl.product.product_image.length > 0}">
                                            ...
                                            <div class="input">
                                                <div ng-hide="PpCtrl.product.product_image.length">
                                                ...
                                                <input type="file" class="uploadImg" name="image"
                                                    data-video-index="@{{ PpCtrl.product.id }}">
                                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text" name="product_description" data-unique="@{{productCtrl.uniqueRoute}}"
                            data-ng-model="PpCtrl.product.product_description" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="number" name="product_id" data-unique="@{{productCtrl.uniqueRoute}}"
                            data-ng-model="PpCtrl.product.product_id" class="form-control"
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                <input type="button" value="{{ trans('base::general.cancel') }}"
                    data-ng-click="PpCtrl.closeSubscriptionEdit()" name="cancel" class="save">
