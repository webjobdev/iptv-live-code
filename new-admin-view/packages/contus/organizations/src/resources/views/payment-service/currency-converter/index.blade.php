    ...
    <div data-ng-controller="ConverterController as ConvCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="organization/payment-service/currency-converter"
                    data-template-route="admin/organizations/payment-service/currency-converter" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/payment-service/currency-converter.js')}}"></script>
