    ...
    <div data-ng-controller="CurrencyController as CurrCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="organization/payment-service/currency"
                    data-template-route="admin/organizations/payment-service/currency" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/organization/payment-service/currency.js')}}"></script>
