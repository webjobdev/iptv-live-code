    ...
    <div data-ng-controller="DeviceController as deviceCtrl">
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>{{ __('devices::index.devices') }}</h4>

                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('devices')" data-ng-click="deviceCtrl.addDevices($event)"
                        ...
                        <span>{{ trans('devices::index.create_devices') }}</span>
                    </a>
                </div>
            </div>
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="divice" data-template-route="admin/divice"
