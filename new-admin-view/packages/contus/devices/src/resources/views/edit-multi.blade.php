        ...
        <div class=" " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Mutiple Device</li>
                </ol>
            </div>
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" id="selected-option-input" class="form-control"
                                        placeholder="Selected Orgs" ng-model="deviceCtrl.deviceData.slectedOrgName" readonly
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto; margin:10px 10px;">
                                    <select name="organization" id="organization_optns"
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" name="security_code_req" id="security_code_req"
                                        ...
                                        ng-checked="deviceCtrl.deviceData.security_code_req == '1'">
                                </div>
                            </div>
