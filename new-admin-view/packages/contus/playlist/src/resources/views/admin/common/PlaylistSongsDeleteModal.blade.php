<div class="alert-popup modal fade" id="single-song-record-delete-popup" >             
    <div class="alert-popup-content">
        <div class="popup_head">
            <h3>{{__('base::gridlist.single_record_delete_action_modal_title')}} @{{playlistViewCtrl.selectedId}}</h3>
        </div>
        <div class="popup_content"> 
            ...
            <div class="popup_btns text-center">
                ...
                <a data-ng-click="playlistViewCtrl.confirmDelete()" href="javascript:void(0)" class="pop_confirm_btn" data-dismiss="modal">{{trans('base::gridlist.confirm')}}</a>
            </div>
        </div>
    </div>
</div>