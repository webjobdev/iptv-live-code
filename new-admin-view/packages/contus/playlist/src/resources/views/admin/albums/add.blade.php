...
@section('content')
    <div ng-app="AlbumAddFormApp" data-ng-controller="AlbumAddFormController as albumAddCtrl" class="album-panel">        
...
<script src="{{$getAudioAssetsUrl('js/albums/add.js')}}"></script>
