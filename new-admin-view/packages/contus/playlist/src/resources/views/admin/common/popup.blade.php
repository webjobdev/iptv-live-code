<div class="alert-popup modal fade" id="singleDeleteModal">             
    <div class="alert-popup-content">
        ...
        <div class="popup_content"> 
            ...
            <span data-ng-show="ConfirmationDeleteBox" class="conformation_txt">{{__('base::gridlist.delete_confirm')}}</span>
            <!-- data-ng-show="videoConfirmationDeleteBox" -->
            <!-- <span class="delete_detail">Skyccraper(2018)- Offical trailer</span> -->

            <div class="popup_btns text-center">
                <a data-ng-click="{{ $control }}.cancelDelete()" href="javascript:void(0)" class="pop_cancel_btn" data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                <a data-ng-click="{{ $control }}.confirmDelete('single-delete-action')" href="javascript:void(0)" class="pop_confirm_btn" data-dismiss="modal">{{__('base::gridlist.delete')}}</a>
            </div>
        </div>
    </div>
</div>