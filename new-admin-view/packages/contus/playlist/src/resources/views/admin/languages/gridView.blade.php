        ...
        <table class="table" id="fixTable" data-ng-class="{'no-records': noRecords}">
            <thead>
                <tr>
                    ...
                    <th data-ng-repeat="field in heading" ng-class="{'centre': field.name == 'Order'}">
                        @{{field.name}}
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.language_name" data-boot-tooltip="true" title="{{trans('audio::languages.enter_language_name')}}">
                    </td>
                    <td></td>
                    <td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                    ...
                    <td>
                         <div class="tooltip-parent">
                            ...
                            <span class="tooltip_title">{{trans('audio::languages.tooltips.click_to_deactivate')}}</span>
                        </div>
                        <div class="tooltip-parent">
                            ...
                            <span class="tooltip_title">{{trans('audio::languages.tooltips.click_to_activate')}}</span>
                        </div>
                    </td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <div class="column edit_table_icon tooltip-parent">
                                <button class="table_action sidepanel-open" data-ng-click="langgridCtrl.editLanguage(record)">
