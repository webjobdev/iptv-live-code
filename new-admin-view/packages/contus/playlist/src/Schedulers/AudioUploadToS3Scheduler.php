 ...
 */
namespace Contus\Playlist\Schedulers;

use Contus\Base\Schedulers\Scheduler;
use Aws\S3\S3Client;
use Aws\ElasticTranscoder\ElasticTranscoderClient;
use Contus\Playlist\Models\Audios;
use Contus\Playlist\Models\TranscoderTracking;
use Contus\Playlist\Repositories\AWSUploadRepository;
use Exception;
use Contus\Playlist\Helpers\DeletedAudioException;

class AudioUploadToS3Scheduler extends Scheduler{
    /**
     * Class property to hold audio instance
     *
     * @var \Contus\Playlist\Models\Audio
     */
     ...
     *
     * @var \Contus\Playlist\Repositories\AWSUploadRepository
     */
