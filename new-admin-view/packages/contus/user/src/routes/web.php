...
Route::prefix('admin')->group(function () {
  ...
  Route::get('demo/auth/login', [AuthController::class, 'DemogetLogin'])->name('admin.demo.auth.login.get');
  ...
  Route::get('users/profile', [AdminUserController::class, 'getProfile'])->name('admin.users.profile');
  Route::get('demo/users/profile', [AdminUserController::class, 'demoGetProfile']);
  ...
  Route::get('users/feedback', [AdminUserController::class, 'getFeedback'])->name('feedback.index');
});
