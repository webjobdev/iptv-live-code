                        ...
                        <div class="one-set width-50">
                            <div class="form-group" data-ng-class="{'has-error': errors.name.has}">
                                ...
                                <div class="form-input">
                                    <input type="text" name="name" data-ng-model="prfCtrl.user.name"
                                        class="form-control"
                        ...
                        <div class="one-set width-50">
                            ...
                            <div class="upload-cover-thumbnail">
                                <div class="thumbnail-image ml-zero"
                                                    ...
                                                    <div class="overlay-content"
                                                        ...
                                                        <div class="input">
                                                            ...
                                                            <input type="file" accept="image/*" class="uploadImg"
                                                                name="image">
                                                            <input type="hidden" class="module" id="module"
                                                                name="module" value="album">
                                                            <input type="hidden" class="size" id="size"
                                                                name="size" value="thumb">
                                                        </div>
                                    ...
                                    <p class="error-msg" data-ng-show="errors.profile_image.has">@{{ errors.profile_image.message }}
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="geofence-lists-ul">
                                <li class="geofence-lists-li">
                                    <div class="head flexbox align-items-center">
                                        ...
                                        <svg viewBox="0 0 6 9" version="1.1" x="0px" y="0px" width="6px"
                                            height="9px">
                                            <g>
                                                <path
