...
class AdminUserController extends ApiController {
    ...
    public function postProfileImage() { 
        $moduleName = 'profile';
        $tempImageInfo = $this->uploadRepository->setModelIdentifier ( UploadRepository::MODEL_IDENTIFIER_ADMIN_USER_PROFILE )->tempPrepare ()->tempUpload ($moduleName,$this->request->size); 
