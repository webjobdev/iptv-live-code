...
<div class="video-detail form-page profile-page contentpanel product order_list">
    <div class="panel main_container clearfix" style="border: 1px solid __parent;">
        <div class="add_form form_container">
            <form id="albumForm" name="albumForm" method="POST" data-ng-init="{{ $control }}.fetchData()"
                data-base-validator data-ng-submit="{{ $control }}.albumSave($event,'{{URL::previous()}}')"
                    ...
                    <div class="division flexbox">
                        <div class="one-set width-50">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.album_artists.has}">
                                ...
                                <div class="form-input">
                                    <select class="select2_custom_ddl"  allowClear="1" data-jquery="select2_custom_ddl" name="album_artists" class="admin_category_sub  form-control"  myValue="albumPostData.album_artists"
                                    myPlaceholder="{{ __('audio::album.select_artist') }}" data-ng-model="albumPostData.album_artists">
                                        <option value="">{{ __('audio::album.select_artist') }}</option>
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.audio_language.has}">
                                ...
                                <div class="form-input">
                                    <select class="select2_custom_ddl" allowClear="1" data-jquery="select2_custom_ddl" name="audio_language" class="admin_category_sub form-control" myValue="albumPostData.audio_language"
                                    myPlaceholder="{{ __('audio::album.select_language') }}" data-ng-model="albumPostData.audio_language">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.album_release_date.has}">
                                ...
                                <p class="error-msg" data-ng-show="errors.album_release_date.has">@{{ errors.album_release_date.message }}</p>
                            </div>
                        </div>
                        ...
                        <div class="one-set width-50">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.audio_genre.has}">
                                ...
                                <div class="form-input">
                                    <select class="select2_custom_ddl" allowClear="1" data-jquery="select2_custom_ddl" name="audio_genre" class="admin_category_sub  form-control"  myValue="albumPostData.audio_genre"
                                    myPlaceholder="{{ __('audio::album.select_genre') }}" data-ng-model="albumPostData.audio_genre">
                                ...
                                <div class="switch-concept flexbox align-items-center">
                                    ...
                                    <div class="swich-content flexbox align-items-center flex-wrap">
                                        ...
                                        <div class="right-side flexbox align-items-center">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="is_active" ng-model="albumPostData.is_active">
                            ...
                            <div class="profile_image_upload upload-cover-thumbnail">
                                <div class="thumbnail-image ml-zero" data-ng-class="{'has-error': errors.thumbnail.has}">
                                    ...
                                    <div class="image-content">
                                        <img ng-src="@{{ $control.albumPostData.thumbnail_image }}" ng-class="{'active': albumPostData.thumbnail_image}" class="uploaded_img" alt="">
...
@include('audio::admin.common.audio_upload',['form_type' => 'addAlbum', 'control' => $control]) 
