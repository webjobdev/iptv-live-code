<div class="page-heading flexbox align-items-center flex-wrap">
    ...
    <div class="right-side flexbox align-items-center">
        <a data-ng-click="{{$control}}"  href="javascript:void(0)" class="button button-blue sidepanel-open upload_video">
        ...
        <a href="javascript:void(0)" class="video-demo-ancher" ng-click="showDemoVideo = !showDemoVideo">
            ...
            <svg viewBox="0 0 47 48" version="1.1" x="0px" y="0px" width="45px" height="45px" class="demo-ic">
                <g>
