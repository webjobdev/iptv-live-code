...
@section('content')
    <div ng-app="AudioEditFormApp" data-ng-controller="AudioEditFormController as audioEditCtrl">
        <div class="page-heading flexbox align-items-center flex-wrap">
            <h4>{{trans('audio::audio.edit_audio')}}</h4>
      ...
      {{--   @{{albumAddCtrl.audioUploadLists}} --}}
        @include('audio::admin.audios.audioEdit_form',['form_type' => 'edit', 'control' => 'audioEditCtrl']) 
    </div>
@endsection
...
<script src="{{$getAudioAssetsUrl('js/audios/edit.js')}}"></script>
