        ...
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td></td>
                    <td>
                        <input type="text" class="form-control" data-ng-model="searchRecords.video_on_demand_list"
                            placeholder="Video On Demand List" data-boot-tooltip="true" data-toggle="tooltip"
                            data-original-title="Video On Demand List"> 
                    </td>
                </tr>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index"
                            ...
                            <div data-ng-if="checkAccess('subscribers')" class="form-group row"
                                ...
                                <label class="switch">
                                    <input type="checkbox" ng-checked="record.is_active == 1"
                                        ng-disabled="vodCtrl.isExpired(record.end_date) || !record.end_at"
                                        ng-click="!(vodCtrl.isExpired(record.end_date) || !record.end_at) && togglePublishNow(record, record.id)">
                    ...
                    <td class="table-action center">
                        <div data-ng-if="checkAccess('subscribers')" class="column edit_table_icon tooltip-parent">
                            <button data-ng-click="vodCtrl.editvod(record)">
...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="channelcardForm" id="channelcardForm" method="POST" data-base-validator
            data-ng-submit="vodCtrl.saveVOD($event, vodCtrl.VOD.id)" enctype="multipart/form-data">
            ...
            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!vodCtrl.VOD.id">Create Subscribers channel Card</h5>
                <h5 data-ng-if="vodCtrl.VOD.id">Edit Tv Channel</h5>
            </div>
            ...
            <div class="sidepanel-scroll">
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="form-input">
                        <input type="text"
                            name="profile_name"
                            data-unique="@{{vodCtrl.uniqueRoute}}"
                            data-ng-model="vodCtrl.channel.channel_list"
                            class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="form-input">
                        <select class="form-control" data-jquery="select2_custom_ddl" name="end_at"
                            data-ng-change="vodCtrl.updateCardPattern()" myPlaceholder="Choose Month"
                            data-ng-model="vodCtrl.VOD.end_at" myValue="vodCtrl.VOD.end_at">
                            <option value=""></option>
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                <input type="button" value="{{ trans('base::general.cancel') }}"
                    data-ng-click="vodCtrl.closeSubscriptionEdit()" name="cancel" class="save">
