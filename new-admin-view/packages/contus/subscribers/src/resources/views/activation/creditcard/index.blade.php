...
@section('content')
    <div data-ng-controller="CreditCardController as credCtrl">
        <div class="" id="dashboard-page">
            ...
            @include('subscribers::layouts.tabview')<br>

            <div class="page-heading flexbox align-items-center flex-wrap">
                <h1 style="font-weight: 900; font-size: 1.2rem;">Credit Card</h1><br>
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('credit_cards.create')" data-ng-click="credCtrl.addCreditcard($event)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="subscriber/credit-card"
                    data-request-subscriber-id="{{ request('subscriber-id') }}"
                    data-template-route="admin/activation/credit-card" data-count="false">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/subscribers/creditcard.js')}}"></script>
