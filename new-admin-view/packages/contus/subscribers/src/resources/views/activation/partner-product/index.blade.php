...
@section('content')
    <div data-ng-controller="PartnerProductController as ppCtrl">
        <div class="" id="dashboard-page">
            ...
            <div id="subscriptions" class="tab-pane fade in active">
                <h1 style="font-weight: 900; font-size: 1.2rem;">Partner Product</h1><br>
                <div class="contentpanel product order_list">
                    @include('base::partials.errors')
                    <div class="response-msg"></div>
                    <div data-grid-view data-rows-per-page="10" data-route-name="subscriber/partner-product"
                        data-request-subscriber-id="{{ request('subscriber-id') }}"
                        data-template-route="admin/activation/partner-product" data-count="false">
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/subscribers/partner-product.js')}}"></script>
