...
@section('header')
    ...
    <link rel="stylesheet" href="{{ asset('adminview/assets/js/subscribers/richtexteditor/rte_theme_default.css') }}">
@endsection

@section('content')
    <div data-ng-controller="NotesController as snCtrl">
        <div class="" id="dashboard-page">
            @include('subscribers::layouts.subscribernav')<br>
            <h1 style="font-size: 1.7rem; font-weight: 900;">Activation</h1><br>
           ...
           {{-- @include('subscribers::layouts.tabview') --}}
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('notes.create')" data-ng-click="snCtrl.openNoteForm()" data-toggle="modal"
                        data-target="#flipFlop" class="button button-blue ">
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="subscriber/note"
                    data-request-subscriber-id="{{ request('subscriber-id') }}" data-template-route="admin/activation/notes"
                    data-count="false">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/subscribers/notes.js')}}"></script>
    <script src="{{asset('adminview/assets/js/subscribers/rte-upload.js')}}"></script>
    <script src="{{asset('adminview/assets/js/subscribers/richtexteditor/rte.js')}}"></script>
    <script src="{{asset('adminview/assets/js/subscribers/richtexteditor/plugins/all_plugins.js')}}"></script>
    <!-- <script src="{{asset('adminview/assets/js/subscribers/ckeditor.js')}}"></script> -->
