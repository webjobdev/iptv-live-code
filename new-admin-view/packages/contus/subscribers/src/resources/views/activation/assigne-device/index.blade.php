<div id="assign-device" class="tab-pane fade in active">
    <h1 style="font-weight: 900; font-size: 1.2rem;">{{ __('subscribers::index.assigned_device') }}</h1><br>
    <div class="contentpanel product order_list">
        <!-- @include('base::partials.errors') -->
        <!-- <div class="response-msg"></div> -->
        <div data-grid-view data-rows-per-page="10" data-route-name="only-assigned-device"
            data-request-subscriber-id="{{ request('subscriber-id') }}" data-template-route="admin/assigne-device"
            data-records-name="deviceRecords" data-count="false">
        </div>
    </div>
</div>
    ...
    <form method="POST" enctype="multipart/form-data" id="devicesoltadd" data-base-validator
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <div class="panel panel-default"
                    ...
                    <div class="panel-body">
                        <div class="form-group row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-sm-10">
                                <select name="product_type" id="product_type" ng-model="actCtrl.addslot.product_type"
                                    class="form-control"
                                    ...
                                    <option value="custom subscription"
                                        ng-if="actCtrl.orgSettings.custom_subscription == 1">Custom Subscription
                                    </option>
                                    ...
                                    <option value="custom charge" ng-if="actCtrl.orgSettings.custom_charges == 1">
                                        Custom Charge
                                    </option>
                            ...
                            <div class="col-sm-10" style="margin-top: 8px;">
                                <label class="radio-inline">
                                    <input class="radio" type="radio" ng-model="actCtrl.addslot.activation"
                                        ng-disabled="!actCtrl.hasSubscriptionRecords" name="activation"
                                        value="override"> Override
                                </label>
                                <label class="radio-inline">
                                    <input class="radio" type="radio" ng-model="actCtrl.addslot.activation"
                                        ng-disabled="!actCtrl.hasSubscriptionRecords" name="activation" value="top-up">
                                    Top-Up
                                </label>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <!-- prorate subsription -->
                            <!-- <div class="form-group row" style="margin-bottom: 15px;"
                                ng-if="actCtrl.addslot.activation == 'override' && (actCtrl.addslot.product_type == 'subscription sets' || actCtrl.addslot.product_type == 'free subscription')">
                                <label class="col-sm-2 control-label"
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" ng-model="actCtrl.addslot.prorate_subscription"
                                                ng-true-value="1" ng-false-value="0" name="prorate_subscription">
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;"
                                ng-if="actCtrl.addslot.subscription && (actCtrl.addslot.product_type == 'subscription sets' || actCtrl.addslot.product_type == 'free subscription')">
                                <label class="col-sm-2 control-label"
                                    style="font-size: 14px; color: #000; margin-top: 10px;">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6" style="margin-top: 5px;">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="adjust_length"
                                                        ng-model="actCtrl.addslot.adjust_length"
                                                        ng-change="actCtrl.onAdjustLengthChange()"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group row" style="margin-bottom: 15px;"
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group row" style="margin-bottom: 15px;">
                                                        <label for="end_date" class="col-sm-2 fw-bold col-form-label"
                                                            style="font-size: 14px; color: #000; margin-top: 10px;">
                                                            Active untill:
                                                        </label>
                                                        <div class="col-sm-10 m-auto">
                                                            <div class="row">
                                                                <div class="col-sm-6 m-auto">
                                                                    <input class="form-control rounded-pill"
                                                                        type="number" id="adjust_length_value"
                                                                        name="adjust_length_value"
                                                                        ng-model="actCtrl.addslot.adjust_length_value"
                                                                        ng-change="actCtrl.updateEndDateFromAdjustment()"
                                                                        placeholder="Enter Value"
                                                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 10px 15px; height: 45px; font-weight: bold;">
                                                                </div>
                                                                <div class="col-sm-6 m-auto">
                                                                    <select class="form-control rounded-pill"
                                                                        id="adjust_length_type"
                                                                        name="adjust_length_type"
                                                                        ng-model="actCtrl.addslot.adjust_length_type"
                                                                        ng-change="actCtrl.updateEndDateFromAdjustment()"
                                                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 15px; height: 45px; font-weight: bold;">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="button button-gray" data-dismiss="modal">
                                                Close
                                            </button>
                                        </div>
                        ...
                        <div ng-if="actCtrl.addslot.product_type == 'custom subscription'">
                            <div class="form-group row" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10" style="padding-top: 8px;">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" ng-model="actCtrl.addslot.length_type"
                                            data-ng-click="actCtrl.CelnderClick()" name="length_type" value="celnder">
                                        Calendar
                                    </label>
                                </div>
                            </div>
                            ...
                            <!-- days -->
                            <div class="form-group row" style="margin-bottom: 15px;"
                                ng-if="actCtrl.addslot.day_month_type == 'day' && actCtrl.addslot.length_type != 'celnder'">
                                <label for="start_date" class="col-sm-2 fw-bold col-form-label"
                                    style="font-size: 14px; color: #000; margin-top: 10px;">Days*:</label>
                                <div class="col-sm-10 m-auto">
                                    <input class="form-control rounded-pill border-3" type="number" name="start_date"
                                        required ng-model="actCtrl.addslot.custom_length_input"
                                        ng-change="actCtrl.calculateCustomSubscriptionPrice()" placeholder="Enter Days"
                                        id="start_date"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;"
                                ...
                                <div class="col-sm-10 m-auto">
                                    <select name="subscription" id="subscription"
                                        ng-model="actCtrl.addslot.custom_length_input"
                                        ng-change="actCtrl.calculateCustomSubscriptionPrice()" class="form-control"
                                        style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;"
                                        ng-options="plan.id as plan.subscription_name for plan in actCtrl.subscriptionPlans">
                                        <option disabled value="">Select Subscription</option>
                                    </select>
                            ...
                            <div class="form-group row" style="margin-bottom: 15px;"
                                ...
                                <div class="col-sm-10 m-auto">
                                    <input class="form-control rounded-pill border-3" type="date" name="start_date"
                                        required id="set_date" ng-model="actCtrl.addslot.custom_length_input"
                        ...
                        <div class="form-group" ng-if="actCtrl.addslot.product_type == 'accessories'"
                            ...
                            <div class="col-sm-10 form-input">
                                <select multiple name="accessory" myValue="hello" ng-model="actCtrl.addslot.accessory"
                        ...
                        <div class="form-group" ng-if="actCtrl.addslot.product_type == 'custom charge'">
                            ...
                            <div class="col-sm-10 m-auto">
                                <textarea class="form-control rounded-pill border-3" type="text"
                                    ...
                                    placeholder="{{trans('organizations::index.address')}}" id="custom_charge_comment"
                                                    ...
                                                    <div class="bundle-card" draggable="true"
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <strong>@{{bundle.price}} @{{bundle.monitization_type ==
                                                                    0 ? 'Rent' : 'Buy'}}</strong>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="modal fade" id="bundle_adjust_length" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header"
                                        ng-if="actCtrl.addslot.product_type && actCtrl.addslot.product_type.trim().toLowerCase() !== 'custom subscription'">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                        <h4 class="modal-title" id="modalLabel">Adjust Length</h4>
                                        ...
                                        <div class="panel panel-default"
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control"
                                                            ng-model="bundle.start_at" placeholder="Select start date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" ng-model="bundle.end_at"
                                                            placeholder="Select end date" min="{{ date('Y-01-01') }}"
                                                            max="{{ date('Y-12-31') }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="bundle-item"
                                                            ...
                                                            <div class="checkbox" style="margin: 0;">
                                                                <label style="margin: 0;">
                                                                    <input type="checkbox" ng-disabled="!bundle.end_at"
                ...
                <!-- ==============================***********************************============================== -->
                <div class="panel panel-default"
                    ng-if="actCtrl.addslot.product_type && actCtrl.addslot.product_type !== 'free subscription'"
                    style="font-size: 22px; color: #000; font-weight: 900; padding: 15px; border-radius: 5px; border: 2px solid rgba(128, 130, 133, 0.36)">
                    <div class="panel-heading"
                        style="font-size: 22px; color: #000; font-weight: 900; padding: 15px; border-radius: 5px; border: 1px solid rgba(128, 130, 133, 0.36)">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-sm-10">
                                <select name="payment_service" id="payment_service"
                                    ...
                                    <option value="free" ng-if="actCtrl.addslot.product_type == 'free subscription'">
                                        Free
                                    </option>
                                </select>
                                    ...
                                    <div ng-if="actCtrl.creditCard && actCtrl.creditCard.length > 0"
                                        ...
                                        <div
                                            ...
                                            <label
                                                style="display: flex; align-items: center; margin: 0; width: 100%; cursor: pointer; font-weight: normal;">
                                                <input type="radio" name="selected_credit_card_id"
                                                    ng-model="actCtrl.addslot.selected_credit_card_id" ng-value="'new'"
                                                    ng-change="actCtrl.onSelectedCardChange()"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-5">
                                                        <div class="form-group" style="margin-bottom: 20px;">
                                                            ...
                                                            <div style="position: relative;">
                                                                <input type="text" class="form-control" name="cc_cvv"
                                                                    ng-model="actCtrl.addslot.cc_cvv" placeholder="123"
                        ...
                        <div class="form-group row" style="margin-bottom: 15px;"
                            ...
                            <div class="col-sm-10">
                                <select name="cash_location" id="cash_location" ng-model="actCtrl.addslot.cash_location"
                                    class="form-control"
                                    style="border: 2px solid rgba(128, 130, 133, 0.36); border-radius: 20px; padding: 0px 9px; height: auto;">
            ...
            <div class="col-sm-4">
                <div class="panel panel-default"
                    ng-if="actCtrl.addslot.product_type == 'free subscription' || (actCtrl.addslot.product_type && actCtrl.addslot.payment_service)"
                    style="font-size: 22px; color: #000; font-weight: 900; padding: 15px; border-radius: 5px; border: 2px solid rgba(128, 130, 133, 0.36)">
                    <div class="panel-heading"
                        style="font-size: 22px; color: #000; font-weight: 900; padding: 15px; border-radius: 5px; border: 1px solid rgba(128, 130, 133, 0.36)">
                    ...
                    <div class="panel-body">
                        ...
                        <div ng-if="actCtrl.addslot.product_type !== 'custom charge'">
                            <p style="margin-bottom: 5px; font-weight: bold;"><span class="glyphicon glyphicon-calendar"
                        ...
                        <div class="form-group row" style="margin-bottom: 15px;"
                            ng-if="actCtrl.orgSettings.active_toa == 1">
                            <div class="col-sm-10" style="margin-top: 8px;">
                                <div class="checkbox">
