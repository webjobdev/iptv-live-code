...
@section('content')
    <div data-ng-controller="CustomStreamController as cmsCtrl">
        <div class="" id="dashboard-page">
            ...
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h1 style="font-weight: 900; font-size: 1.2rem;">Tv Channel List</h1><br>
                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('subscribers')" data-toggle="modal" data-target="#add-bundles"
                        ...
                        <span>Assign Tv Channels</span>
                    </a>
                </div>
            </div>

            <!-- Form -->
            <form method="POST" enctype="multipart/form-data" id="custom-stream" data-base-validator
                data-ng-submit="cmsCtrl.savechannel($event)">
                {!! csrf_field() !!}
                        ...
                        <div class="modal-content p-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                                            <div id="availableBundles" class="drop-zone panel panel-default p-2"
                                                ...
                                                <div class="bundle-card" ng-repeat="bundle in cmsCtrl.channelList"
                                                    draggable="true" data-id="@{{bundle.id}}"
                                                    ng-attr-data-title="@{{bundle.channel_name}}"
                                                    style="margin-bottom: 10px; padding: 10px; border: 1px solid #ccc; border-radius: 5px; cursor: move;">
                                                    <i class="fa fa-light fa-tv"></i>
                                                    <strong>@{{bundle.channel_name}}</strong><br>
                                                    <span class="sub-text">TV Channel</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                                            <div id="addedBundles" class="drop-zone panel panel-default p-2"
                                                style="min-height: 130px;" ng-model="cmsCtrl.channel.channel_list">
                            ...
                            <div class="modal-footer">
                                <button id="assignBtn" class="btn btn-primary btn-sm"
                                    ng-click="cmsCtrl.assignSelectedBundles();">Assign</button>
            ...
            <!-- TV Channel Table Content -->
            <div class="contentpanel product order_list mt-4">
                @include('base::partials.errors')
                <div class="response-msg"></div>
                <div data-grid-view data-rows-per-page="10" data-route-name="subscriber/custom-stream"
                data-request-subscriber-id="{{ request('subscriber-id') }}"
                    data-template-route="admin/subscriber/custom-stream/tv-channel" data-count="false">
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/subscribers/custom-stream.js')}}"></script>
