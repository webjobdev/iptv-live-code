        ...
        <div class="" id="dashboard-page">
            ...
            <!-- <div class="page-heading flexbox align-items-center flex-wrap">
                            <div class="right-side flexbox align-items-center">
                                <a data-ng-click="decCtrl.addDevice($event)" href="javascript:void(0)"
                                    ...
                                    <span>{{ __('subscribers::index.create_device') }}</span>
                                </a>
                            </div>
                        </div> -->
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="devices"
                    data-request-subscriber-id="{{ request('subscriber-id') }}" data-template-route="admin/devices"
                    data-count="false">
                </div>
            </div>
