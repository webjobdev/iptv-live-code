        ...
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                ...
                <div class="right-side flexbox align-items-center">
                    {{-- <a data-ng-if="checkAccess('geo_blocking')" data-ng-click="geoRestrctnsCtrl.addGeoRestrictions($event)" --}}
                    <a data-ng-if="checkAccess('geo_blocking.create')" data-ng-click="geoRestrctnsCtrl.addGeoRestrictions($event)" href="javascript:void(0)"
                        ...
                        <span>Add Geo Restrictions</span>
                    </a>
            ...
            {{-- <form class="form-inline serch-btn" id="searchForm" method="GET">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" ng-model="searchRecords.serial_no"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="geo-blocking/geo-restrictions"
                    data-template-route="admin/geo-blocking/geo-restrictions" data-count="false"></div>
            </div>
        </div>
    </div>
@endsection
