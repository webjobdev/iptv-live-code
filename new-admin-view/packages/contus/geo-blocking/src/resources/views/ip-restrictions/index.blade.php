        ...
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                ...
                <div class="right-side flexbox align-items-center">
                    {{-- <a data-ng-if="checkAccess('geo_blocking')" data-ng-click="ipRestrctnsCtrl.addIpRestrictions($event)" --}}
                    <a data-ng-if="checkAccess('geo_blocking.create')" data-ng-click="ipRestrctnsCtrl.addIpRestrictions($event)" href="javascript:void(0)"
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="geo-blocking/ip-restrictions"
                    data-template-route="admin/geo-blocking/ip-restrictions" data-count="false"></div>
            </div>
        </div>
    </div>
@endsection
