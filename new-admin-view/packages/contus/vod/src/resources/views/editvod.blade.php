...
@section('content')
    @include('vod::common.subMenu', ['template' => 'edit_vod'])

    <div class="form-page" data-base-validator data-ng-controller="VodUploadController as vodGridCtrl"
        id="video-detail-start" data-ng-init="vodGridCtrl.fetchData('{{$id}}')">
        ...
        <div id="video_accordion_wrapper">
            <div class="form-page">
                ...
                @include('vod::common.popup', ['control' => 'vodGridCtrl'])
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/vod/vodvideoUpload.js')}}"></script>
