...
<div class="card main-container">
    <div class="card-left">
        <!-- <button ng-if="!livePage && !editPage" class="button button-blue" ng-click="vodGridCtrl.addMoreVideos()">+
    ...
    <div class="card-right">
        <div class="card-content">
            <div class="header-section flexbox align-items-center flex-wrap">
                <h3>@{{ vodSelectedVideo.title }}</h3>
            </div>

            <form id="videoEditForm" name="videoEditForm" method="POST" data-base-validator
                enctype="multipart/form-data" data-ng-submit="vodGridCtrl.saveVodEdit($event, vodSelectedVideo.id)">
                ...
                <div class="upload-cover-thumbnail flexbox" data-ng-class="{'has-error': errors.poster_image.has}">
                    ...
                    <div class="cover-image">
                        ...
                        <div class="image-content responsive-center-container">
                            <!-- image fetch code -->
                            <img ng-show="vodSelectedVideo.poster_image.length > 0"
                                ng-class="{'active':vodSelectedVideo.poster_image}"
                                class="uploaded_poster_img uploaded_poster_img_@{{ vodSelectedVideo.id }}" alt=""
                                ng-src="@{{ vodSelectedVideo.poster_image }}" />
                                ...
                                <div class="fileuploadbox">
                                    <div class="input-append">
                                        <div class="overlay-content"
                                            data-ng-class="{'change-image': vodSelectedVideo.poster_image.length > 0}">
                                            <div class="input">
                                                <div ng-hide="vodSelectedVideo.poster_image.length"
                                                ...
                                                <input type="file" class="uploadPosterImg" name="image"
                                                    data-video-index="@{{ vodSelectedVideo.id }}">
                                            </div>
                        ...
                        <p class="error-msg" data-ng-show="errors.poster_image.has">@{{ errors.poster_image.message }}
                        </p>
                    </div>
                    ...
                    <div class="thumbnail-image">
                        ...
                        <div class="image-content">
                            <img ng-show="vodSelectedVideo.thumbnail_image.length > 0"
                                ng-class="{'active': vodSelectedVideo.thumbnail_image}"
                                class="uploaded_img uploaded_img_@{{ vodSelectedVideo.id }}" alt=""
                                ng-src="@{{ vodSelectedVideo.thumbnail_image }}" />

                            <img ng-show="vodSelectedVideo.thumbnail_image.length == 0"
                                ng-class="{'active': vodSelectedVideo.thumbnail_image}"
                                class="uploaded_img uploaded_img_@{{ vodSelectedVideo.id }}" alt="" ng-src="" />
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileuploadbox">
                                    <div class="input-append">
                                        <div class="overlay-content"
                                            data-ng-class="{'change-image': vodSelectedVideo.thumbnail_image.length > 0}">
                                            ...
                                            <div class="input">
                                                <div ng-hide="vodSelectedVideo.thumbnail_image.length">
                ...
                <div class="division flexbox">
                    <div class="one-set width-50">
                        <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                            ...
                            <div class="form-input" data-ng-class="{'has-error': errors.title.has}">
                                <input type="text" name="title" class="form-control" placeholder="Enter Title"
                                    data-ng-model="vodSelectedVideo.title">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input">
                                <input type="number" onkeypress="return this.value.length < 4;"
                                    oninput="if(this.value.length>=4) { this.value = this.value.slice(0,4); }"
                                    class="form-control" name="release_year"
                                    placeholder="{{ __('video::videos.enter_release_year') }}"
                                    data-ng-model="vodSelectedVideo.release_year">
                            </div>
                            <p class="error-msg release_year" data-ng-show="errors.release_year.has">
                                @{{ errors.release_year.message }}</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input">
                                <input type="text" name="directors" class="form-control"
                                    placeholder="Enter Director Name" data-ng-model="vodSelectedVideo.directors">
                            </div>
                            <p class="error-msg" data-ng-show="errors.directors.has">@{{ errors.presenter.message }}</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input">
                                <input type="text" name="presenter" class="form-control"
                                    placeholder="Enter Cast & Crew Name" data-ng-model="vodSelectedVideo.presenter">
                            </div>
                        ...
                        <div class="form-group" data-ng-class="{'has-error': errors.expire_scheduled_time.has}">
                            ...
                            <div class="form-input calender-left">
                                ...
                                <div class="time-picker-wrapper">
                                    <div class="time-section" ng-repeat="unit in ['hour', 'minute', 'second']">
                                        <button type="button" class="arrow-btn"
                                            ng-click="increment(unit)">&#9650;</button>
                                        <input type="text" class="circle-input" style="padding-left: 3px;" s
                                            ng-model="vodSelectedVideo.timeParts[unit]" ng-change="updateModel()"
                                        ...
                                        <button type="button" class="arrow-btn"
                                            ng-click="decrement(unit)">&#9660;</button>
                                    </div>
                                </div>
                                ...
                                <!-- <input type="hidden" name="expire_scheduled_time"
                                    data-ng-model="vodSelectedVideo.expire_scheduled_time" /> -->
                            </div>
                    ...
                    <div class="one-set width-50">
                        <div class="form-group" data-ng-class="{'has-error': errors.description.has}">
                            ...
                            <div class="form-input" data-ng-class="{'has-error': errors.description.has}">
                                <textarea rows="7" name="description" maxlength="50000" class="form-control"
                                    data-ng-model="vodSelectedVideo.description"
                                    ...
                                    <div class="right-side flexbox align-items-center">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="scheduled_publishing"
                                                ng-model="vodSelectedVideo.scheduled_publishing"
                        ...
                        <div ng-if="vodSelectedVideo.scheduled_publishing">
                            <div class="form-group" data-ng-class="{'has-error': errors.scheduled_time.has}">
                                ...
                                <div class="form-input calender-left">
                                    <i class="calender-icon"></i>
                                    <input ng-if="!editPage" futureDate="true" myValue="vodSelectedVideo.scheduled_time"
                                        autocomplete="off" data-jquery="date_time_picker" datetime-picker type="text"
                                        name="scheduled_time" id="scheduled_time"
                                        data-ng-model="vodSelectedVideo.scheduled_time" size="30"
                                        placeholder="{{ __('video::videos.scheduled_time') }}"
                                        data-validation-name="scheduled_time" class="form-control jay"
                                        ng-blur="dateBlur($event, vodSelectedVideo.scheduled_time)"
                                        ng-keyup="dateKeyup($event, vodSelectedVideo.scheduled_time)" />

                                    <input ng-if="editPage" futureDate="true" myValue="vodSelectedVideo.scheduled_time"
                                        autocomplete="off" type="text" name="scheduled_time" id="scheduled_time"
                                        data-ng-model="vodSelectedVideo.scheduled_time" size="30"
                                        placeholder="{{ __('video::videos.scheduled_time') }}"
                                        data-validation-name="scheduled_time" class="form-control hello"
                                        ng-blur="dateBlur($event, vodSelectedVideo.scheduled_time)"
                                        ng-keyup="dateKeyup($event, vodSelectedVideo.scheduled_time)" />
                                    <!-- @{{ vodSelectedVideo.scheduled_time }} -->
                                </div>
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.expire_scheduled_time.has}">
                                ...
                                <div class="form-input calender-left">
                                    ...
                                    <input ng-if="!editPage" futureDate="true"
                                        myValue="vodSelectedVideo.expire_scheduled_time" autocomplete="off"
                                        data-jquery="date_time_picker" datetime-picker type="text"
                                        name="expire_scheduled_time" id="expire_scheduled_time"
                                        data-ng-model="vodSelectedVideo.expire_scheduled_time" size="30"
                                        placeholder="Expire Scheduled Time" data-validation-name="expire_scheduled_time"
                                        class="form-control hello"
                                        ng-blur="dateBlur($event, vodSelectedVideo.expire_scheduled_time)"
                                        ng-keyup="dateKeyup($event, vodSelectedVideo.expire_scheduled_time)" />

                                    <input ng-if="editPage" futureDate="true"
                                        myValue="vodSelectedVideo.expire_scheduled_time" autocomplete="off" type="text"
                                        name="expire_scheduled_time" id="expire_scheduled_time"
                                        data-ng-model="vodSelectedVideo.expire_scheduled_time" size="30"
                                        placeholder="Expire Scheduled Time" data-validation-name="expire_scheduled_time"
                                        class="form-control hello"
                                        ng-blur="dateBlur($event, vodSelectedVideo.expire_scheduled_time)"
                                        ng-keyup="dateKeyup($event, vodSelectedVideo.expire_scheduled_time)" />
                                    <!-- @{{ vodSelectedVideo.expire_scheduled_time }} -->
                                </div>
                                <p class="error-msg" data-ng-show="errors.expire_scheduled_time.has">
                                    @{{ errors.expire_scheduled_time.message }}</p>
                            </div>
                                    ...
                                    <div class="right-side flexbox align-items-center">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="publish_now"
                                                ng-model="vodSelectedVideo.publish_now" ng-change="togglePublishDate()">
                                            <span class="slider round"></span>
                                        </label>
                                        <span class="text">{{ __('video::videos.active') }}</span>
                                    </div>
                        ...
                        <div class="form-group" ng-if="vodSelectedVideo.publish_now != 1">
                            <label>
                                Enter Publish Time
                                <span class="required">*</span>
                            </label>
                            <div class="form-input calender-left">
                                <i class="calender-icon"></i>
                                <input ng-if="!editPage" futureDate="true" myValue="vodSelectedVideo.publish_date"
                                    autocomplete="off" data-jquery="date_time_picker" datetime-picker type="text"
                                    name="publish_date" id="publish_date" data-ng-model="vodSelectedVideo.publish_date"
                                    size="30" placeholder="Enter Publish Time" data-validation-name="publish_date"
                                    class="form-control" ng-blur="dateBlur($event, vodSelectedVideo.publish_date)"
                                    ng-keyup="dateKeyup($event, vodSelectedVideo.publish_date)" />
                        ...
                        <div class="form-group" ng-if="vodSelectedVideo.publish_now == 1">
                            ...
                            <div class="form-input calender-left">
                                ...
                                <input readonly type="text" name="publish_date" class="form-control"
                                    ng-model="vodSelectedVideo.publish_date" placeholder="Auto Publish Time" />
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="form-input">
                                    <select allowClear="1" data-jquery="select2_custom_ddl" name="video_quality"
                                        ...
                                        myValue="vodSelectedVideo.video_quality" myPlaceholder="Select video quality"
                                        data-ng-model="vodSelectedVideo.video_quality"
                                        ng-init="vodSelectedVideo.video_quality">
                                        <option value="">--- Select ---</option>
                                        <option ng-selected="vodSelectedVideo.video_quality == 'SD'" value="SD">SD
                                        </option>
                                        <option ng-selected="vodSelectedVideo.video_quality == 'HD'" value="HD">HD
                                        </option>
                                        <option ng-selected="vodSelectedVideo.video_quality == 'FHD'" value="FHD">
                                            FHD
                                        </option>
                                        <option ng-selected="vodSelectedVideo.video_quality == 'UHD'" value="UHD">
                                            UHD
                                        </option>
                                        <option ng-selected="vodSelectedVideo.video_quality == '4K'" value="4K">4K
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input">
                                <select multiple data-jquery="select2_custom_ddl"
                                    myValue="vodSelectedVideo.organization" myPlaceholder="Select organization"
                                    ng-init="vodGridCtrl.editVideo.category" name="organization"
                                    class="admin_category_sub form-control select2_custom_ddl"
                                    data-ng-model="vodSelectedVideo.organization" style="width: 100%;"
                                    ng-options="org.id as org.organization_name for org in vodGridCtrl.OrganizationList">
                                </select>
                            </div>
                            <p class="error-msg" data-ng-show="errors.age_limit.has">Age limit required</p>
                        </div>
                ...
                <div class="panel-heading">
                    ...
                    <div class="division flexbox">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.streaming_url.has}">
                                ...
                                <div class="form-input" data-ng-class="{'has-error': errors.streaming_url.has}">
                                    <input type="text" name="streaming_url" class="form-control"
                                        ...
                                        data-ng-model="vodSelectedVideo.streaming_url">
                                </div>
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.trailer_url.has}">
                                ...
                                <div class="form-input" data-ng-class="{'has-error': errors.trailer_url.has}">
                                    <input type="text" name="trailer_url" class="form-control"
                                        placeholder="Enter Trailer Url" data-ng-model="vodSelectedVideo.trailer_url">
                                </div>
                        ...
                        <div class="one-set width-50">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <select allowClear="1" data-jquery="select2_custom_ddl" name="drm_type"
                                        class="admin_category_sub form-control select2_custom_ddl"
                                        myValue="vodSelectedVideo.drm_type" myPlaceholder="Select DRM Type"
                                        data-ng-model="vodSelectedVideo.drm_type"
                                        data-ng-options="drm.drm_provider as drm.drm_provider for drm in vodGridCtrl.drmProfiles | unique:'drm_provider'">
                            ...
                            <div class="form-group"
                                data-ng-if="vodSelectedVideo.drm_type === 'Pallycon' || vodSelectedVideo.drm_type === 'EZDRM'">
                                <label>
                                    Select DRM Profile
                                    <!-- <span class="required">*</span> -->
                                </label>
                                <div class="form-input">
                                    <select allowClear="1" data-jquery="select2_custom_ddl" name="drm_profile"
                                        class="admin_category_sub form-control select2_custom_ddl"
                                        myValue="vodSelectedVideo.drm_profile" myPlaceholder="Select DRM Profile"
                                        data-ng-model="vodSelectedVideo.drm_profile"
                                        data-ng-options="drm.drmprofile.id as drm.drmprofile.drm_name for drm in vodGridCtrl.drmProfiles | filter:{drm_provider: vodSelectedVideo.drm_type}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <select allowClear="1" data-jquery="select2_custom_ddl" name="playback_token"
                                        class="admin_category_sub form-control select2_custom_ddl"
                                        myValue="vodSelectedVideo.playback_token"
                                        myPlaceholder="Select Playback Token Generator"
                                        ng-options="token.id as token.name for token in vodGridCtrl.playbackTokenList"
                                        data-ng-model="vodSelectedVideo.playback_token">
                                        <option value="">--- Select ---</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-input">
                                                    <select allowClear="1" data-jquery="select2_custom_ddl"
                                                        name="policy"
                                                        class="admin_category_sub form-control select2_custom_ddl"
                                                        myValue="vodSelectedVideo.policy" myPlaceholder="Select Policy"
                                                        data-ng-model="vodSelectedVideo.policy"
                                                        ng-options="policy.id as policy.policy_name for policy in vodGridCtrl.PolicyList">
                                                        <option value="">--- Select ---</option>
                                                        <!-- <option value="hello">hello</option>
                                                        <option value="byy">byy</option> -->
                                                    </select>
                ...
                <hr data-ng-if="!livePage" style="border-top: 1px dashed #e0e4e9;">

                <!-- contetn Sets -->
                <div data-ng-if="!livePage" class="panel-group" id="accordian-content-set" role="tablist"
                            ...
                            <div class="panel-body">
                                ...
                                <div style="margin-top: 10px;">
                                    <div style="max-height: 200px; overflow-y: auto; padding: 5px;">
                                        ...
                                        <div class="bundle-item" ng-repeat="bundle in vodGridCtrl.selectedVideo.bundles"
                                            data-id="@{{ bundle.organization_id }}"
                                            ...
                                            <span class="bundle-sub center">
                                                <span ng-repeat="bundles in bundle.bundles | limitTo:3">
                                                    @{{ bundles.name }}<span ng-if="!$last">, </span>
                                                </span>
                                                <span ng-if="bundle.bundles.length > 3">, more</span>
                                            </span>
                    ...
                    <div class="division flexbox">
                        <div class="one-set width-50">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.category.has}">
                                ...
                                <div class="form-input">
                                    <select multiple data-jquery="select2_custom_ddl"
                                        myValue="vodSelectedVideo.category"
                                        myPlaceholder="{{ __('video::videos.select_category') }}"
                                        ng-init="vodGridCtrl.editVideo.category" name="category"
                                        class="admin_category_sub form-control select2_custom_ddl"
                                        data-ng-model="vodSelectedVideo.category"
                                        ng-options="cat.vod_categorie_name as cat.vod_categorie_name for cat in vodGridCtrl.vodCategoryList | filter:vodGridCtrl.categoryFilter">
                                    </select>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="right-side flexbox align-items-center">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="is_active"
                                                    ng-model="vodSelectedVideo.is_active">
                                                <span class="slider round"></span>
                                            </label>
                                            <span class="text">{{ __('video::videos.active') }}</span>
                                        </div>
                ...
                <div class="division flexbox">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" name="age_rating"
                                            data-ng-model="vodSelectedVideo.age_rating" value="0"> Default Age
                                        Rating
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="age_rating"
                                            data-ng-model="vodSelectedVideo.age_rating" value="1"> Country based
                                        Age
                                        Rating
                                    </label>
                                </div>
                        ...
                        <div class="form-group" data-ng-class="{'has-error': errors.age_limit.has}">
                            ...
                            <div class="form-input">
                                <select allowClear="1" data-jquery="select2_custom_ddl" name="age_limit"
                                    class="admin_category_sub form-control select2_custom_ddl"
                                    myValue="vodSelectedVideo.age_limit" myPlaceholder="Select age limit"
                                    data-ng-model="vodSelectedVideo.age_limit" ng-init="vodSelectedVideo.age_limit">
                                    <option value="">--- Select ---</option>
                                    <option ng-selected="vodSelectedVideo.age_limit == 'G'" value="G">G</option>
                                    <option ng-selected="vodSelectedVideo.age_limit == 'PG'" value="PG">PG
                                    </option>
                                    <option ng-selected="vodSelectedVideo.age_limit == '13+'" value="13+">13+
                                    </option>
                                    <option ng-selected="vodSelectedVideo.age_limit == '16+'" value="16+">16+
                                    </option>
                                    <option ng-selected="vodSelectedVideo.age_limit == 'R'" value="R">R</option>
                                </select>
                            </div>
                            <p class="error-msg" data-ng-show="errors.age_limit.has">Age limit required</p>
                        </div>
                    ...
                    <div class="one-set width-50">
                        ...
                        <div class="form-group">
                            <div class="switch-concept flexbox align-items-center">
                                ...
                                <div class="swich-content flexbox align-items-center flex-wrap">
                                    ...
                                    <div class="right-side flexbox align-items-center">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="scheduled_publishing"
                                                ng-model="vodSelectedVideo.geo_policy">
                                            <span class="slider round"></span>
                                        </label>
                                        <span class="text">{{ __('video::videos.active') }}</span>
                                    </div>
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.category.has}"
                                ng-if="vodSelectedVideo.geo_policy">
                                <label>
                                    <span>
                                        Geo Country
                                    </span>
                                ...
                                <div class="form-input">
                                    <select multiple data-jquery="select2_custom_ddl"
                                        myValue="vodSelectedVideo.geo_block_country_list" myPlaceholder="Select Country"
                                        name="geo_block_country_list"
                                        class="admin_category_sub form-control select2_custom_ddl"
                                        data-ng-model="vodSelectedVideo.geo_block_country_list"
                                        ng-options="geoblock.name as geoblock.name for geoblock in vodGridCtrl.geoBlockList">
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="switch-concept flexbox align-items-center">
                                <div class="swich-content flexbox align-items-center flex-wrap">
                                    <span>Always Pin Locked</span>
                                    <div class="right-side flexbox align-items-center">
                                        <span class="text">{{ __('video::videos.inactive') }}</span>
                                        <label class="switch">
                                            <input type="checkbox" name="is_parental"
                                                ng-model="vodSelectedVideo.is_parental">
                                            <span class="slider round"></span>
                                        </label>
                                        <span class="text">{{ __('video::videos.active') }}</span>
                                    </div>
        ...
        <div class="bottom-button text-right ">
            <a ng-if="vodSelectedVideo.id" class="delete-button" href="javascript:void(0)" data-toggle="modal"
                data-target="#videoDeleteModal"
                data-ng-click="vodGridCtrl.deleteSingleRecordVideos(vodSelectedVideo.id, vodSelectedVideo.title)">
            ...
            <a class="save" ng-if="livePage || vodSelectedVideo.is_live" href="{{ url('admin/vod') }}">
                {{ __('video::videos.back') }}
            </a>

            <a class="save" ng-if="!livePage" href="{{ url('admin/vod') }}">
                {{ __('video::videos.back') }}
            </a>

            <button ng-if="!livePage" id="channelEditFormSubmit"
                data-ng-click="vodGridCtrl.saveVodEdit($event, vodSelectedVideo.id)" class="publish-now">
                {{ __('video::videos.publish_now') }}
            </button>

            <button ng-if="livePage && !editPage" id="videoEditFormSubmit"
                data-ng-click="vodGridCtrl.saveVod($event, vodSelectedVideo.id)" class="publish-now">
                {{ __('video::videos.publish_now') }}
            </button>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div style="max-height: 350px; overflow-y: auto; padding: 5px;">
                        <div id="availableBundles">
                            ...
                            <div class="content-container panel panel-default" draggable="true"
                                data-ng-repeat="orgbundles in VodContentList"
                ...
                <div class="col-md-6">
                    ...
                    <div class="scroll-box">
                        <div class="content-container panel panel-default" draggable="true"
                            data-ng-repeat="orgbundles in vodSelectedVideo.selectedBundles"
                            data-id="@{{ orgbundles.organization_id }}">
                            <div class="content-header">
                                <span class="channel-drag"><i class="glyphicon glyphicon-move"></i></span>
                                @{{ orgbundles.organization_name }}
                    ...
                    <!-- <pre>@{{ vodSelectedVideo.selectedBundles | json }}</pre> -->
                </div>
            </div>

            <div class="assign-btns">
                <button type="button" class="button button-blue" data-dismiss="modal"
                    ng-click="vodGridCtrl.assignSelectedBundles()">
                    Assign
                </button>&nbsp;
