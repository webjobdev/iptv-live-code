...
@section('content')
    ...
    <div data-ng-controller="VodGridController as vodCtrl">

        @include('vod::common.subMenu', ['template' => 'vod'])

        <div class="contentpanel clearfix video_grid">
            @include('base::partials.errors')
            <div class="response-msg"></div>
            <div data-grid-view data-rows-per-page="10" data-template-route="admin/video-on-demand"
                data-route-name="video-on-demand" data-request-grid="video-on-demand" data-count="false">
            </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="clearfix modal-footer video_delete_footer radio-popup">
                            <span data-ng-click="vodCtrl.cancelDeleteVideos()" class="btn btn-danger pull-right"
                                data-dismiss="modal">{{__('base::gridlist.cancel')}}</span>
                            <span data-ng-click="vodCtrl.confirmDeleteVideos('single-video')"
            ...
            <div class="alert-popup modal fade" id="videoBulkDeleteModal" data-role="dialog">
                <div class="alert-popup-content">
                    ...
                    <div class="popup_content" data-ng-show="vodCtrl.isDeleteBulkRecord">
                        <span class="conformation_txt">
                            {{__('base::gridlist.bulk_delete_confirm')}}
                        </span>

                        <div class="popup_btns text-center">
                            <a class="pop_cancel_btn" data-ng-click="vodCtrl.cancelDeleteVideos()"
                                data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                            <a data-ng-click="vodCtrl.confirmDeleteVideos('bulk-video')" class="pop_confirm_btn"
                                data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                        </div>
                    </div>

                    <div class="popup_content" data-ng-show="vodCtrl.isActivateBulkRecord">
                        <span class="conformation_txt">
                        ...
                        <div class="popup_btns text-center">
                            <a class="pop_cancel_btn" data-ng-click="vodCtrl.cancelDeleteVideos()"
                                data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                            <a data-ng-click="vodCtrl.confirmActivateOrDeactivateVideos(1)" class="pop_confirm_btn"
                                data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                        </div>
                    </div>

                    <div class="popup_content" data-ng-show="vodCtrl.isDeactivateBulkRecord">
                        <span class="conformation_txt">
                        ...
                        <div class="popup_btns text-center">
                            <a class="pop_cancel_btn" data-ng-click="vodCtrl.cancelDeleteVideos()"
                                data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                            <a data-ng-click="vodCtrl.confirmActivateOrDeactivateVideos(0)" class="pop_confirm_btn"
                                data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                        </div>
                    </div>
                    <div class="popup_content" data-ng-show="ConfirmationStatusBox">
                        ...
                        <div class="popup_btns text-center">
                            <a class="pop_cancel_btn" data-ng-click="vodCtrl.cancelDeleteVideos()"
                                data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                            <a data-ng-click="vodCtrl.confirmStatus()" class="pop_confirm_btn"
                                data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                        </div>
                    </div>
                    <div class="popup_content" data-ng-show="vodCtrl.isEditBulkRecord">
                        <span class="conformation_txt">
                        ...
                        <div class="popup_btns text-center">
                            <a class="pop_cancel_btn" data-ng-click="vodCtrl.cancelDeleteVideos()"
                                data-dismiss="modal">{{__('base::gridlist.cancel')}}</a>
                            <a data-ng-click="vodCtrl.confirmEditEvents()" class="pop_confirm_btn"
                                data-dismiss="modal">{{__('base::gridlist.confirm')}}</a>
                        </div>
                    </div>
                </div>
...
@endsection
    ...
    @section('scripts')
        ...
        <script src="{{asset('adminview/assets/js/vod/index.js')}}"></script>
