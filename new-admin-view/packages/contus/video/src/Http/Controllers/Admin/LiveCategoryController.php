...
use Contus\Video\Repositories\LiveCategoryRepository;
use Contus\Base\Controller as BaseController;
use Illuminate\Support\Facades\Gate;
use Carbon\Carbon;

class LiveCategoryController extends BaseController {
 /**
  * Construct method
  */
 public function __construct(LiveCategoryRepository $categoryRepository) {
  parent::__construct ();
 ...
 public function getIndex() {
  return view ( 'video::admin.livecategory.index' );
 }
 ...
 public function getGridlist() {
  return view ( 'video::admin.livecategory.gridView' );
 }
 /**
 ...
 */
  public function getVideos($id) {
    return view ( 'video::admin.livecategory.videos', [ 
      'id' => $id 
    ] );
  }
}
