...
class RadioCategoryController extends BaseController {
 /**
  * Construct method
  */
 public function __construct(RadioCategoryRepository $categoryRepository) {
  parent::__construct ();
 ...
 public function getIndex() {
  return view ( 'video::admin.radiocategory.index' );
 }
 ...
 public function getGridlist() {
  return view ( 'video::admin.radiocategory.gridView' );
 }
 /**
 ...
 */
  public function getVideos($id) {
    return view ( 'video::admin.radiocategory.videos', [ 
      'id' => $id 
    ] );
  }
}
