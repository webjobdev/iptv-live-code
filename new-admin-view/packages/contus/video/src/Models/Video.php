...
class Video extends Model implements AttachableModel
{
     ...
     * @var array
     */
    protected $fillable = [ 'category_id','title','description','country_id','is_subscription','is_active','published_on', 'is_notify', 'is_premium','audio_language','video_size' ];
     ...
     * @var array
     */
    protected $url = [ 'thumbnail_image', 'poster_image', 'selected_thumb' ];
