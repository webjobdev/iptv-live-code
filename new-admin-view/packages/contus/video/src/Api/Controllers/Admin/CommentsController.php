...
class CommentsController extends ApiController {
    ...
    public function getVideocomments() {
        ...
        return $this->repository->browseVideoComments($this->request);
    }

    public function getreplyvideoComments() {

        return $this->repository->browsereplyVideoComments($this->request);
    }
    public function getallreplyvideoComments() {

        return $this->repository->browseallreplyVideoComments($this->request);
    }

    public function postDeleteAction() {
        $delete = $this->repository->deleteComment($this->request);
        
        return ($delete) ?  $this->request->session()->flash(StringLiterals::SUCCESS, trans('video::videos.comment_delete_success')) : $this->request->session()->flash(StringLiterals::SUCCESS, trans('video::videos.comment_delete_error'));
