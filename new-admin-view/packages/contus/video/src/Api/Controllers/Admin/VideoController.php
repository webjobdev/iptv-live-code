...
class VideoController extends ApiController
{
    ...
    public function postDeleteAction(){
        ...
        if ($this->request->has(StringLiterals::SELECTED_CHECKBOX) && is_array($this->request->get(StringLiterals::SELECTED_CHECKBOX))) {
            ...
            if ($this->request->get('videoStatus') == 'single-video') {
                ...
                $this->request->session()->flash(StringLiterals::SUCCESS, trans('video::videos.message.delete-success'));
                ...
                $this->request->session()->flash(StringLiterals::SUCCESS, trans('video::videos.message.bulk-delete-success'));
            }
        }
        return $result;
    }
    ...
    /*public function postUpdateStatus($id) {
        $result = $this->repository->videoStatusUpdate($id);
        if(!$result) {
            return $this->getErrorJsonResponse ( [ ], trans ( 'video::videos.message.update-error' ) );
        }
        return $this->getSuccessJsonResponse ( [ 'message' => trans ( 'video::videos.message.update-success' ) ] );
    }*/
