...
@section('content')
    <div data-ng-controller="SeriesCategoryGridController as seriescatgridCtrl">
        <div class="page-heading flexbox align-items-center flex-wrap">

            <h4>Manage Series Categories</h4>
            
            <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('tv_show_categories.create')" data-ng-click="seriescatgridCtrl.addCategory($event)"
        ...
        <div class="contentpanel clearfix category_grid">
            ...
            <div data-grid-view data-rows-per-page="10" data-route-name="series-category/fetch" data-template-route="admin/series-category"
                data-request-grid="series-category/fetch" data-count="false"></div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/categories/SeriescategoryGrid.js') }}"></script>
