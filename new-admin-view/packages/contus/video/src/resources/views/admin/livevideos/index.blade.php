...
@endsection @section('header') @include('base::layouts.headers.dashboard') @endsection @section('content')
    ...
    <div data-ng-controller="VideoGridController as vgridCtrl" >
        @include('video::admin.common.subMenu', ['template' => 'livevideolist'])
        @include('video::admin.common.popup', ['control' => 'vgridCtrl'])
        <div class="contentpanel clearfix video_grid">
            @include('base::partials.errors')
            <div class="response-msg"></div>
            <div data-grid-view data-rows-per-page="10" data-route-name="livevideos" data-template-route="admin/livevideos"
                 data-request-grid="livevideos" data-count="false"></div>
        </div>
