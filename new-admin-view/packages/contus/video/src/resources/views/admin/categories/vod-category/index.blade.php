...
@section('content')
    <div data-ng-controller="VODCategoryGridController as vodcatgridCtrl">
        <div class="page-heading flexbox align-items-center flex-wrap">

            <h4>Manage VOD Categories</h4>

            <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('vod_categories.create')" data-ng-click="vodcatgridCtrl.addCategory($event)"
        ...
        <div class="contentpanel clearfix category_grid">
            ...
            <div data-grid-view data-rows-per-page="10" data-route-name="vod-category/fetch"
                data-template-route="admin/vodcategory" data-request-grid="vod-category/fetch" data-count="false">
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/categories/vodcategoryGrid.js') }}"></script>
