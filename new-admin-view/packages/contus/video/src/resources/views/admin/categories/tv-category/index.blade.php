...
@section('content')
    <div data-ng-controller="TvCategoryGridController as tvcatgridCtrl">
        <div class="page-heading flexbox align-items-center flex-wrap">

            <h4>Manage Tv Categories</h4>
            
            <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('channel_categories.create')" data-ng-click="tvcatgridCtrl.addCategory($event)"
        ...
        <div class="contentpanel clearfix category_grid">
            ...
            <div data-grid-view data-rows-per-page="10" data-route-name="tvcategory/fetch" data-template-route="admin/tvcategory"
                data-request-grid="tvcategory/fetch" data-count="false"></div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('adminview/assets/js/categories/tvcategoryGrid.js') }}"></script>
