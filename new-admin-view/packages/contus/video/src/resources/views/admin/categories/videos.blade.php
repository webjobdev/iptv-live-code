...
@section('content')
    ...
    <div class="product order_list" data-ng-controller="ViewVideoCategoriesController as vVideoCategoriesCtrl"
        data-ng-init=vVideoCategoriesCtrl.fetchData('{{$id}}')>
                ...
                <div class="category-detail video-detail">
                    <h4 class="heading">
                        ...
                        <span class="hightlight">
                            <i data-ng-if="vVideoCategoriesCtrl.parentCategoryTitle"
                                data-ng-repeat="(key, record) in vVideoCategoriesCtrl.parentCategoryTitle">
                                @{{record}} /
                            </i>
                    ...
                    <ul class="category-lists flexbox flex-wrap"
                        data-ng-if="vVideoCategoriesCtrl.videoCategories.videos != ''"
                        data-ng-show="vVideoCategoriesCtrl.videoListView">
                        <li class="flexbox"
                            data-ng-repeat="record in vVideoCategoriesCtrl.videoCategories.videos track by $index">
                            <div class="single-category-list flexbox">
                                <a class="image" href="{{url('admin/videos/view-details-video')}}/@{{record.id}}">
                                    <img class="img-responsive" src="{{url('contus/base/images/no-preview.png')}}"
                                        data-ng-src="@{{ record.thumbnail_image }}" alt="" />
                                </a>

                                <div class="content">
                                    <div class="title-views flexbox">
                                        <a class="title"
                                            href="{{url('admin/videos/view-details-video')}}/@{{record.id}}">@{{record.title}}</a>
                                    ...
                                    <div data-ng-repeat="category in record.videocategory track by $index">
                                        <a href="{{url('admin/categories/videos')}}/@{{category.category_id}}"
                                            class="sub-title">@{{ category.category.title }}</a><span
                                            data-ng-if="record.videocategory.length != $index+1">,</span>
                                    </div>
                    ...
                    <div data-ng-if="totalRecords != 0" class="pagination_div">
                        <ul class="table-pagination" data-ng-if="links.length > 0">
                            <li data-ng-repeat="link in links" data-ng-class="{'active': link.current}">
                                <a ng-if="link.value=='Previous'" href="javascript:void(0)"
                                    data-ng-click="loadRecords(link.pageNumber,false)"
                                    class="page_previous pageLink">@{{link.value}}</a>
                                <a ng-if="link.value!='Previous' && link.value!='Next'" href="javascript:void(0)"
                                    data-ng-click="loadRecords(link.pageNumber,false)" class="pageLink">@{{link.value}}</a>
                                <a ng-if="link.value=='Next'" href="javascript:void(0)"
                                    data-ng-click="loadRecords(link.pageNumber,false)"
                                    class="page_next pageLink">@{{link.value}}</a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="sidepanel">
        ...
        <div class="pop_over_continer form-page">
            <form name="categoriesForm" id="categoriesForm" method="POST" data-base-validator
                data-ng-submit="catgridCtrl.categorySave($event, catgridCtrl.category.id)" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="sidepanel-header flexbox align-items-center">
                    ...
                    <div data-ng-if="catgridCtrl.category.id" class="right-side">
                        <select class="edit-select-lang" data-ng-change="catgridCtrl.languageChange()"
                            data-ng-model="catgridCtrl.categoryTranslation.language">
                            <option data-ng-repeat="language in catgridCtrl.languages track by $index"
                ...
                <div class="sidepanel-scroll mCustomScrollbar" data-mcs-theme="dark">
                    ...
                    <div class="form-group row radio-wrapper" data-ng-hide="true">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <input type="radio" id="series-yes" name="is_web_series"
                                data-ng-click="catgridCtrl.changeWebseries()" value="1"
                                data-ng-model="catgridCtrl.category.is_web_series"
                                class="ng-pristine ng-untouched ng-valid">
                            <label for="series-yes" class="radio-custom-label">Yes</label>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <input type="radio" id="series-no" name="is_web_series"
                                data-ng-click="catgridCtrl.changeWebseries()" value="0"
                                data-ng-model="catgridCtrl.category.is_web_series"
                                class="ng-pristine ng-untouched ng-valid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input">
                                <input type="text" name="category_order" maxlength="10" class="form-control"
                                    data-ng-model="catgridCtrl.category.category_order" placeholder="Add order value"
                            ...
                            <div class="form-input">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <a href="#" class="fileupload-exists category-image-remove" data-dismiss="fileupload"
                                        data-ng-click="catgridCtrl.removeThumbnailProperty()">{{trans('video::videos.remove')}}</a>
                                    <p class="help-block hide"></p>
                                </div>
                            </div>
                            <p class="help-block" data-ng-show="errors.category_image.has">@{{ errors.category_image.message
                                }}</p>
                            <div class="form-group" style="display:none">
                                <div class="clsFileUpload preview-image">
                                    <span id="category-image-delete" data-ng-click="catgridCtrl.deleteCategoryImage()"
                                        data-ng-show="catgridCtrl.category.image_url" data-boot-tooltip="true"
                                        title="{{trans('video::videos.delete_category_image')}}"><i class="fa fa-remove"
            ...
            <form name="categoriesTranslationForm" style="display:none;" id="categoriesTranslationForm" method="POST"
                ...
                <div class="sidepanel-scroll">
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.title1.has}">
                        ...
                        <div class="form-input">
                            <input type="text" name="title" disabled="disabled" maxlength="255" class="form-control"
                                data-unique="@{{catgridCtrl.categoriesUniqueRoute}}"
                                data-ng-model="catgridCtrl.category.title"
                                placeholder="{{trans('video::categories.title')}}" value="{{old('title')}}" />
                        </div>
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.trans_title.has}">
                        ...
                        <div class="form-input">
                            <input type="text" name="trans_title" maxlength="255" class="form-control"
                                data-unique="@{{catgridCtrl.categoriesUniqueRoute}}"
                                data-ng-model="catgridCtrl.categoryTranslation.title"
                                placeholder="{{trans('video::categories.title')}}" value="{{old('title')}}" />
                        </div>
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/categories/videos.js')}}"></script>
