...
@section('content')
    <div data-ng-controller="webseriesAddController as webseriesAddCtrl" class="album-panel">        
        ...
        @include('video::admin.webseries.webseries_form',['form_type' => 'add', 'control' => 'webseriesAddCtrl']) 
...
<script src="{{asset('adminview/assets/js/audioUpload.js')}}"></script>
...
<script src="{{asset('adminview/assets/js/webseries/add.js')}}"></script>
