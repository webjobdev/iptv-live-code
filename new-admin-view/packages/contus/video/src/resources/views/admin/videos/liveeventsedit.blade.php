...
@section('content')
    @include('video::admin.common.subMenu', ['template' => 'edit_event'])

    <div class="form-page" data-base-validator data-ng-controller="VideoUploadController as vgridCtrl"
        id="video-detail-start" data-ng-init="vgridCtrl.fetchData('{{$id}}')">
        ...
        <div id="video_accordion_wrapper">
            <div class="form-page">
                @include('video::admin.videos.liveeventsform')
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/videos/liveeventsvideoUpload.js')}}"></script>
