...
{{-- <link href="{{asset('adminview/assets/player/player.css')}}" rel="stylesheet"> --}}
<link href="{{asset('adminview/assets/player/play-js.css')}}" rel="stylesheet">
        ...
        <div class="tab-content cover_thumbnail">
            <div class="flexbox">
                <div class="video-cover">
                   ...
                   <img ng-if="video.poster_image=='' || video.poster_image==null"src="{{asset('adminview/assets/images/cover.png')}}" alt="Video Cover" />
                </div>
                <div class="video-thumb">
                    ...
                    <img  ng-if="video.thumbnail_image==''" src="{{asset('adminview/assets/images/default_image.png')}}" alt="Video Thumbnail" />
                </div>
            </div>
        </div>
    </div>
...
<script src="{{asset('adminview/assets/player/play.js')}}"></script>
<script src="{{asset('adminview/assets/js/angularjs-datetime-picker.js')}}"></script>
<script src="{{asset('adminview/assets/js/angular/libs/ui-bootstrap/ui-bootstrap-tpls-1.3.3.min.js')}}"></script>
...
<script src="{{asset('adminview/assets/js/videos/viewVideoDetail.js')}}"></script>
