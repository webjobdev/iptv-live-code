...
@section('content')
    ...
    <div data-ng-controller="CategoryGridController as catgridCtrl">
        ...
        <div class="page-heading flexbox align-items-center flex-wrap">
            ...
            <div class="right-side flexbox align-items-center">
                <a data-ng-if="checkAccess('category_all_write')" data-ng-click="catgridCtrl.addCategory($event)"
        ...
        <div class="sidepanel">
            ...
            <div class="pop_over_continer form-page">
                <form name="categoriesForm" id="categoriesForm" method="POST" data-base-validator
                    data-ng-submit="catgridCtrl.categorySave($event, catgridCtrl.category.id)"
                    ...
                    <div class="sidepanel-scroll mCustomScrollbar" data-mcs-theme="dark">
                        ...
                        <div class="form-group">
                            ...
                            <p class="error-msg"
                                ...
                                {{trans('video::categories.inactive_disabled')}}
                            </p>
                        </div>
                                    ...
                                    <div class="right-side flexbox align-items-center">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="is_active"
                                                data-ng-model="catgridCtrl.category.is_active">
                                            <span class="slider round"></span>
                                        </label>
                                        <span class="text">({{ trans('video::videos.message.active') }})</span>
                                    </div>
                        ...
                        <div class="form-group" data-ng-class="{'has-error': errors.category_image.has}">
                            ...
                            <div class="form-input">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <p class="intimation">Allowed file extensions are jpeg, jpg, png and image resolution
                                        should be minimum 1500x730</p>
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div class="input-append">
                                        <button class="subtitle_btn">
                                            ...
                                            <span class="fileupload-new">Upload Image</span>
                                            <span class="fileupload-exists">Change Image</span>
                                            <input type="file" id="mobile-category-image" name="image"
                                                data-action="api/admin/categories/mobile-category-image" />
                                        </button>
                    ...
                    <div class="bottom-button text-right flexbox align-items-center">
                        ...
                        <input type="submit" value="{{trans('base::general.submit')}}" name="submit" class="publish-now"
                            data-ng-click="catgridCtrl.dataSubmit($event,catgridCtrl.category.id)" />
                    </div>
                </form>
                    ...
                    <div class="sidepanel-header flexbox align-items-center">
                        ...
                        <div data-ng-if="catgridCtrl.category.id" class="right-side">
                            <select minimumResults="-1" data-jquery="select2_custom_ddl" name="language"
                                ...
                                myValue="catgridCtrl.categoryTranslation.language"
                                data-ng-model="catgridCtrl.categoryTranslation.language"
                                data-ng-options="a.id as a.title  for a in catgridCtrl.languages "></select>
                        </div>
                    </div>
    ...
    <div id="loaderimg"
        style=" position: fixed;left: 0px;top: 0px;width: 100%;height: 100%;z-index: 9999;background: url('{{asset('adminview/assets/images/admin/pl.gif')}}') 50% 50% no-repeat rgb(0, 0, 0, 0.09); display:none;">
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{asset('adminview/assets/js/categories/categoryGrid.js')}}"></script>
