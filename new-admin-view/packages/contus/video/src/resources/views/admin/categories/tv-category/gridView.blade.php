    ...
    <div class="table_responsive">
        <table class="table subscription-plan-grid" id="fixTable">
            <thead>
                <tr>
                    @include('audio::admin.common.bulkActionLayout', [
                        'access_type' => 'channel_categories',
                    ])
                    <th>S.No</th>
                    <th>Name</th>
                    <th>Categories</th>
            ...
            <tbody>
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" id="category-search-input" ng-model="searchCategory"
                            ng-change="onCategorySearch($event)" placeholder="Enter Category Name" data-boot-tooltip="true"
                            title="{{ trans('video::categories.enter_category_name') }}">
                    </td>
                </tr>

                <tr data-ng-if="noRecords">
                    <td colspan="10" class="no-data center">
                ...
                <tr data-ng-if="showRecords" data-ng-repeat-start="record in records track by $index"
                    ...
                    <td>
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" class="checkbox" id="roles_@{{ record.id }}"
                                ng-click="tvcatgridCtrl.selectRecord($event, record.id)" value="@{{ record.id }}"
                    ...
                    <td>
                        <a data-toggle="collapse" data-parent="#categoryAccordion"
                            href="#tvCategory_@{{ record.id }}" aria-expanded="false"
                            data-ng-click="tvcatgridCtrl.ctgrydropdown(record)">
                            @{{ record.tv_categorie_name }}
                        </a>
                    </td>

                    <td>
                        @{{ record.categorie_id.length }}
                    </td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <!-- edit button -->
                            <div data-ng-if="checkAccess('channel_categories.edit')"
                                class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="tvcatgridCtrl.editCategory(record)">
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('channel_categories.delete')">
                ...
                <tr data-ng-attr-id="tvCategory_@{{ record.id }}" class="collapse" data-ng-repeat-end>
                    <td colspan="8">
                        <!-- add category -->
                        <div class="left-side flexbox align-items-center" style="padding: 13px 0px 13px 0px;">
                            <a data-ng-if="checkAccess('channel_categories.create')" data-toggle="modal" href="#"
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr data-ng-repeat-start="category in record.categorie_id track by category.id">
                                    <td class="center">
                                        <a data-toggle="collapse" href="#channel_@{{ category.id }}"
                                            aria-expanded="false" aria-controls="channel_@{{ category.id }}">
                                    ...
                                    <td class="table-action">
                                        <div class="flexbox align-items-center justify-center">
                                            ...
                                            <div data-ng-if="checkAccess('channel_categories.edit')"
                                                class="column edit_table_icon tooltip-parent"
                                                value="@{{ category.id }}">
                                                <button data-ng-click="tvcatgridCtrl.editSubCategory(category)">
                                            ...
                                            <div class="tooltip-parent"
                                                data-ng-if="checkAccess('channel_categories.delete')">
                                                <span ng-mouseover="getTooltip($event)" class="delete_table_icon"
                                                    data-toggle="modal" data-target="#deleteModal"
                                                    data-ng-click="deleteSingleRecord(record.id)">
                                ...
                                <tr id="channel_@{{ category.id }}" class="collapse" data-ng-repeat-end>
                                    <td colspan="4" class="p-0">
                                        <!-- add sub category -->
                                        <div class="left-side flexbox align-items-center" style="padding: 13px 0px;">
                                            <a data-ng-if="checkAccess('channel_categories.create')" href="#"
                                                class="button button-blue" data-toggle="modal"
                                                data-ng-click="openChannelModel(category)">
                                                <div
                                        ...
                                        <table class="table table-bordered table-striped mb-0">
                                            <thead>
                                                <tr>
                                                    <th class="center">Channel Name</th>
                                                    <th class="center">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr
                                                    data-ng-repeat="chnl in category.get_sub_category track by chnl.id">
                                                    <td class="center">
                                                        @{{ chnl.get_channel.channel_name || '-' }}
                                                    </td>
                                                        ...
                                                        <div class="flexbox align-items-center justify-center">
                                                            ...
                                                            <div class="tooltip-parent"
                                                                ...
                                                                <span ng-mouseover="getTooltip($event)"
                                                                    ...
                                                                    data-ng-click="deleteSingleRecord(chnl)">
...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="categoriesForm" id="categoriesForm" method="POST" data-base-validator
            data-ng-submit="tvcatgridCtrl.tvcategorySave($event, tvcatgridCtrl.category.id)"
            enctype="multipart/form-data">

            {!! csrf_field() !!}

            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!tvcatgridCtrl.category.id">
                    Add New Tv category
                </h5>
                <h5 data-ng-if="tvcatgridCtrl.category.id">
                    Edit Tv Category
            ...
            <div class="sidepanel-scroll">
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                    ...
                    <div class="form-input">
                        <input type="text" name="tv_categorie_name" maxlength="255" class="form-control"
                            data-ng-model="tvcatgridCtrl.category.tv_categorie_name"
                            placeholder="Enter Category Name">
                    </div>
                    <p class="error-msg" data-ng-show="errors.tv_categorie_name.has">
                        @{{ errors.tv_categorie_name.message }}
                    </p>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 30px;">
                    ...
                    <select multiple data-jquery="select2_custom_ddl" myValue="tvcatgridCtrl.category.organization"
                        myPlaceholder="Select organization" ng-init="tvcatgridCtrl.category.organization"
                        name="organization" class="admin_category_sub form-control select2_custom_ddl"
                        data-ng-model="tvcatgridCtrl.category.organization" style="width: 100%;"
                        ng-options="org.id as org.organization_name for org in tvcatgridCtrl.organizationList">
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                <input type="button" value="{{ trans('base::general.cancel') }}"
                    data-ng-click="tvcatgridCtrl.closeCategoryEdit()" name="cancel" class="save">
...
<div class="modal fade" id="categoryModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
                <h4 data-ng-if="!tvcatgridCtrl.category.id" id="exampleModalLabel"
            ...
            <form method="post" data-base-validator
                data-ng-submit="tvcatgridCtrl.Savecategory($event, tvcatgridCtrl.category.id)"
                enctype="multipart/form-data">
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                        ...
                        <div class="form-input">
                            <input type="text" name="category_name" maxlength="255" class="form-control"
                                data-ng-model="tvcatgridCtrl.category.category_name" placeholder="Enter Name">
                        </div>
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                        ...
                        <div class="form-input">
                            <input type="number" name="category_order" maxlength="255" class="form-control" s
                                data-ng-model="tvcatgridCtrl.category.category_order" placeholder="Add Order Value">
                        </div>
                        <p class="error-msg" data-ng-show="errors.title.has">@{{ errors.title.message }}</p>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" style="line-height: 24.5px;"
...
<!-- Sub Category Modal -->
<div class="modal fade" id="ChannelModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">

        <div class="modal-content">
            <form method="post" data-base-validator data-ng-submit="tvcatgridCtrl.Savechannel($event)"
                enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select multiple data-jquery="select2_custom_ddl" myValue="tvcatgridCtrl.category.channel_id"
                            myPlaceholder="Select Channel" ng-init="tvcatgridCtrl.category.channel_id"
                            name="channel_id" class="admin_category_sub form-control select2_custom_ddl"
                            data-ng-model="tvcatgridCtrl.category.channel_id" style="width: 100%;"
                            ng-options="chnl.id as chnl.channel_name for chnl in tvcatgridCtrl.ChannelList">
                            <option value="">-- Select Channel --</option>
                        </select>

                        <p class="error-msg">@{{ errors.organization_id.message }}</p>
                    </div>
                </div>

                <div class="modal-footer">
                    <button type="s" class="button button-gray" data-dismiss="modal"
                        style="line-height: 24.5px;">Close</button>
                    <button type="submit" class="button button-blue">Save changes</button>
                </div>
            </form>
        </div>
