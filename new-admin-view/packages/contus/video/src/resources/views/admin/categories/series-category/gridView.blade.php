            ...
            <thead>
                <tr>
                    @include('audio::admin.common.bulkActionLayout', [
                        'access_type' => 'tv_show_categories',
                    ])
                ...
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" id="category-search-input" ng-model="searchCategory"
                            ng-change="onCategorySearch($event)" placeholder="Search by Name" data-boot-tooltip="true"
                    ...
                    <td></td>
                    <td>
                        <select class="select2_custom_ddl center" minimumresults="-1" data-jquery="select2_custom_ddl"
                            ...
                            <option value='0'>{{ __('video::collection.banner.inactive') }}
                            </option>
                        </select>
                    </td>
                </tr>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat-start="record in records track by $index"
                    ...
                    <td>
                        <div class="ckbox ckbox-default">
                            <input type="checkbox" class="checkbox" id="roles_@{{ record.id }}"
                                ng-click="seriescatgridCtrl.selectRecord($event, record.id)"
                    ...
                    <td>
                        <a data-toggle="collapse" data-parent="#categoryAccordion"
                            ...
                            data-ng-click="seriescatgridCtrl.ctgrydropdown(record)">
                            @{{ record.series_categorie_name }}
                        </a>
                    </td>
                    <td>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            <div data-ng-if="checkAccess('tv_show_categories.edit')"
                                class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="seriescatgridCtrl.editCategory(record)">
                            ...
                            <div class="tooltip-parent" data-ng-if="checkAccess('tv_show_categories.delete')">
                ...
                <tr data-ng-attr-id="vodCategory_@{{ record.id }}" class="collapse" data-ng-repeat-end>
                    <td colspan="8">
                        ...
                        <div class="left-side flexbox align-items-center" style="padding: 13px 0px 13px 0px;">
                            <a data-ng-if="checkAccess('tv_show_categories.create')" data-toggle="modal" href="#"
                                    ...
                                    <td class="table-action">
                                        <div class="flexbox align-items-center justify-center">
                                            ...
                                            <div data-ng-if="checkAccess('tv_show_categories.edit')"
                                                class="column edit_table_icon tooltip-parent"
                                                value="@{{ category.id }}">
                                                <button data-ng-click="seriescatgridCtrl.editSubCategory(category)">
                                            ...
                                            <div class="tooltip-parent"
                                                data-ng-if="checkAccess('tv_show_categories.delete')">
                                ...
                                <tr id="SubCategories_@{{ category.id }}" class="collapse" data-ng-repeat-end>
                                    <td colspan="4" class="p-0">
                                        ...
                                        <div class="left-side flexbox align-items-center" style="padding: 13px 0px;">
                                            <a data-ng-if="checkAccess('tv_show_categories.create')" href="#"
                                        ...
                                        <table class="table table-bordered table-striped mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <!-- loop sub categories -->
                                                <tr ng-repeat="sub in category.get_sub_category track by sub.id">
...
<div class="sidepanel">
    ...
    <div class="pop_over_continer form-page">
        <form name="categoriesForm" id="categoriesForm" method="POST" data-base-validator
            data-ng-submit="seriescatgridCtrl.categorySave($event, seriescatgridCtrl.category.id)"
            enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="sidepanel-header flexbox align-items-center">
                <h5 data-ng-if="!seriescatgridCtrl.category.id">
                    Add New Series Category
                </h5>
                <h5 data-ng-if="seriescatgridCtrl.category.id">
                    Edit Series Category
                </h5>
            </div>
            <div class="sidepanel-scroll mCustomScrollbar" data-mcs-theme="dark">
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                    ...
                    <div class="form-input">
                        <input type="text" name="series_categorie_name" maxlength="255" class="form-control"
                            data-ng-model="seriescatgridCtrl.category.series_categorie_name"
                            placeholder="Enter Category Name" value="{{ old('title') }}" />
                    </div>
                    <p class="error-msg" data-ng-show="errors.series_categorie_name.has">@{{ errors.series_categorie_name.message }}</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <!-- <select class="form-control mb10 select2_custom_ddl" id="org-id"
                        ng-model="seriescatgridCtrl.category.organization" data-jquery="select2_custom_ddl"
                        ng-options="org.id as org.organization_name for org in seriescatgridCtrl.orgList"
                        myPlaceholder="{{ trans('subscribers::index.organization.select_organization') }}">
                        <option value="">-- Select Organization --</option>
                    </select> -->
                    <select multiple data-jquery="select2_custom_ddl" myValue="seriescatgridCtrl.category.organization"
                        myPlaceholder="Select organization" ng-init="seriescatgridCtrl.category.organization"
                        name="organization" class="admin_category_sub form-control select2_custom_ddl"
                        data-ng-model="seriescatgridCtrl.category.organization" style="width: 100%;"
                        ng-options="org.id as org.organization_name for org in seriescatgridCtrl.orgList">
                        <option value="">-- Select Organization --</option>
                    </select>
            ...
            <div class="bottom-button text-right flexbox align-items-center">
                ...
                <a class="save" data-ng-click="seriescatgridCtrl.closeCategoryEdit()">
                    {{ trans('base::general.cancel') }}
                </a>
                <input type="submit" value="{{ trans('base::general.submit') }}" name="submit"
                    class="publish-now"
                    data-ng-click="seriescatgridCtrl.dataSubmit($event,seriescatgridCtrl.category.id)" />
            </div>
        </form>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 data-ng-if="!seriescatgridCtrl.category.id" id="exampleModalLabel"
            ...
            <form method="post" data-base-validator
                data-ng-submit="seriescatgridCtrl.Savecategory($event, seriescatgridCtrl.category.id)"
                enctype="multipart/form-data">
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.category_name.has}">
                        ...
                        <div class="form-input">
                            <input type="text" name="category_name" maxlength="255" class="form-control"
                                data-ng-model="seriescatgridCtrl.category.category_name" placeholder="Enter Name">
                        </div>
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.category_order.has}">
                        ...
                        <div class="form-input">
                            <input type="number" name="category_order" maxlength="255" class="form-control" s
                                data-ng-model="seriescatgridCtrl.category.category_order"
...
<div class="modal fade" id="SubCategoryModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" data-base-validator
                data-ng-submit="seriescatgridCtrl.SaveSubctgry($event, seriescatgridCtrl.category.id)"
                enctype="multipart/form-data">
