...
var CollectionGridController = ['$scope','$rootScope','requestFactory','$window','$sce','$timeout','$compile','$interval',function(scope,rootScope,requestFactory,$window,$sce,$timeout,$compile,$interval){
    var self = this;
    this.info = {};
    this.collection = {};
    ...
    this.fetchInfo = function() {
      requestFactory.get(requestFactory.getUrl('collections/info'),this.defineProperties,function(response){
