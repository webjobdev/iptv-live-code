...
var CommentsGridController = ['$scope','$rootScope','requestFactory','$window','$sce','$timeout','$compile','$interval',function (  scope, rootScope, requestFactory, $window, $sce, $timeout, $compile, $interval ) {
    var self = this;
    this.info = {};
    this.group = {};
    ...
    this.fetchInfo = function () {
        requestFactory.get( requestFactory.getUrl( 'comments/info' ), this.defineProperties, function (response) {
