        ...
        <table class="table subscription-plan-grid" id="fixTable" data-ng-class="{'no-records': noRecords}">
            ...
            <tbody>
                ...
                <tr class="search_text">
                    ...
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.login"
                            placeholder="Enter login" data-boot-tooltip="true" data-toggle="tooltip"
                            data-original-title="Enter login">
                    </td>
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.name"
                            placeholder="Enter name" data-boot-tooltip="true" data-toggle="tooltip"
                            data-original-title="Enter name">
                    </td>
                    <td class="search_product">
                        <input type="text" class="form-control" data-ng-model="searchRecords.organization"
                            placeholder="Enter organization" data-boot-tooltip="true" data-toggle="tooltip"
                            data-original-title="Enter organization">
                    </td>
                    <td></td>
                    {{-- <td>
                ...
                <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" class="list-repeat"
                    ...
                    <td class="">@{{ record.organization.organization_name }}</td>

                    {{-- <td class="">
                        <!-- Show if active -->
                        <div class="tooltip-parent" data-ng-if="checkAccess('api_access.edit')">
                            ...
                            <span class="tooltip_title">{{ trans('customer::subscription.deactivate_subscription')
                                }}</span>
                        </div>
                    ...
                    <td class="table-action">
                        <div class="flexbox align-items-center justify-center">
                            ...
                            <div data-ng-if="checkAccess('api_access.edit')" class="form-group row"
                                style="margin-bottom: 0px; margin-right: 5px;">
                                <label class="switch">
                                    <input type="checkbox" name="status" ng-checked="record.status == 1"
                                        ng-click="apiAccessCtrl.toggleStatus(record)">
                                    <span class="slider round"></span>
                                </label>
                            </div>

                            <!-- edit button -->
                            <div data-ng-if="checkAccess('api_access.edit')"
                                class="column edit_table_icon tooltip-parent">
                                <button data-ng-click="apiAccessCtrl.editApiAccess(record.id)">
                            ...
                            <!-- delete button -->
                            <div class="tooltip-parent" data-ng-if="checkAccess('api_access.delete')">
