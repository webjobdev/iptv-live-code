    ...
    <div data-ng-controller="ApiAccessController as apiAccessCtrl">
        <div class=" " id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap">
                <h4>{{ __('api-access::index.api_access') }}</h4>

                <div class="right-side flexbox align-items-center">
                    <a data-ng-if="checkAccess('api_access.create')" data-ng-click="apiAccessCtrl.addApiAccess($event)"
                        ...
                        <span>{{ trans('api-access::index.create_api_access') }}</span>
                    </a>
            ...
            <form class="form-inline serch-btn" id="searchForm" method="GET" ng-submit="apiAccessCtrl.searchUser($event)">
                {!! csrf_field() !!}
                <input class="form-control mr-2" type="search" ng-model="searchRecords.name" placeholder="Search here..."
                    aria-label="Search" id="searchInput" ng-change="apiAccessCtrl.searchUser()">&nbsp;
            ...
            <div class="contentpanel product order_list">
                ...
                <div data-grid-view data-rows-per-page="10" data-route-name="api-access"
                    data-template-route="admin/api-access" data-count="false"></div>
            </div>
        </div>
    </div>
@endsection
