        ...
        <div class="" id="dashboard-page">
            <div class="page-heading flexbox align-items-center flex-wrap" style="margin-bottom: 20px;">
                <ol class="breadcrumb" style="background: transparent; padding: 0; margin-bottom: 10px;">
                    ...
                    <li class="active">Create API User</li>
                </ol>
            </div>
                ...
                <div
                    ...
                    <div class="form-card">
                        <div class="form-card-header">
                            <h2 class="form-card-title">API User Information</h2>
                            <p class="text-muted" style="margin-top: 5px; font-size: 13px;">Fill in the details below to
                                create a new API user account.</p>
                        </div>
