...
var VideoGridController = ['flowFactory','$scope','$rootScope','requestFactory','$window','$sce','$timeout','$compile','$interval',function (flowFactory,scope, rootScope, requestFactory, $window, $sce, $timeout, $compile, $interval ) {
    var self = this;
    this.info = {};
    this.category = {};
    this.collection = {};
...
/*
   ...
   this.addCategoriesToVideos = function ( id, categoryName ) {
    ...
    this.removeCategoriesFromVideos = function ( index ) {
        ...
        if ( self.editVideo.category_ids.length > 0 ) {
...
function googleDriveUploader () {
    ...
    this.initializeFineUploader = function () {
        window.fineUploaderGoogleDrive = new qq.FineUploaderBasic( {autoUpload : false,debug : true,element : document.getElementById( 'file_drop_area' ),request : {endpoint : window.VPlay.route.apiUrl + 'api/admin/videos/handle-fine-uploader'},
            deleteFile : {enabled : true,endpoint : window.VPlay.route.apiUrl + 'api/admin/videos/handle-fine-uploader'},chunking : {enabled : true,concurrent : {enabled : true},success : {endpoint : window.VPlay.route.apiUrl + 'api/admin/videos/handle-fine-uploader?uploading'}},
...
function videoUploader (scope) {
    ...
    this.initializeFineUploader = function () {
        window.fineUploader = new qq.FineUploaderBasic( {autoUpload : false,debug : true,element : document.getElementById( 'file_drop_area' ),request : {endpoint : window.VPlay.route.apiUrl + 'api/admin/videos/handle-fine-uploader'},
            deleteFile : {enabled : true,endpoint : window.VPlay.route.apiUrl + 'api/admin/videos/handle-fine-uploader'},chunking : {enabled : true,concurrent : {enabled : true},success : {endpoint : window.VPlay.route.apiUrl + 'api/admin/videos/handle-fine-uploader?done'}},
