...
videoCategories.controller('ViewVideoCategoriesController',['$window','$scope','$rootScope','requestFactory','$timeout',function(win,scope,$rootScope,requestFactory,$timeout){
  ...
  this.fetchData = function(id) { 
    requestFactory.get(requestFactory.getUrl('radiocategory/video-categories/'+id,{page : scope.currentPage}),function(response){
  ...
  this.parentCategory = function(id) {
    requestFactory.post(requestFactory.getUrl('radiocategory/parent-category/'+id),id,function(response){
  ...
  this.getChildCategories = function(id) {
    ...
    requestFactory.post(requestFactory.getUrl('radiocategory/child-category/'+id),id,function(response){
...
if(angular.isObject(window.gridControllers)){
  for(var controller in window.gridControllers){
      ...
      if(angular.isArray(window.gridControllers[controller]) || angular.isFunction(window.gridControllers[controller])){
        videoCategories.controller(controller,window.gridControllers[controller]);
      }
  }
}
